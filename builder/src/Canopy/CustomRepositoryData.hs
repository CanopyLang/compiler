...
module Canopy.CustomRepositoryData
  ( CustomSingleRepositoryData (..),
    ...
    defaultCustomRepositoriesDataCanopyPackageRepoOnly,
...
defaultPackageServerString = Json.fromChars "package-server-with-standard-canopy-v0.19-package-server-api"
...
standardCanopyRepository :: CustomSingleRepositoryData
standardCanopyRepository = DefaultPackageServerRepoData standardCanopyRepositoryDefaultPackageServerRepo
...
data SinglePackageLocationData = SinglePackageLocationData
...
singlePackageLocationDataDecoder =
  do
    ...
    packageName <- D.field "package-name" (D.mapError InvalidVersionString Canopy.Package.decoder)
    version <- D.field "version" (D.mapError InvalidPackageName Canopy.Version.decoder)
...
singlePackageLocationDataEncoder (SinglePackageLocationData fileType packageName version url shaHash) =
  E.object
    [ (Utf8.fromChars "file-type", singlePackageFileTypeEncoder fileType),
      (Utf8.fromChars "package-name", Canopy.Package.encode packageName),
      (Utf8.fromChars "version", Canopy.Version.encode version),
...
data CustomRepositoriesData = CustomRepositoriesData
...
defaultCustomRepositoriesDataCanopyPackageRepoOnly :: CustomRepositoriesData
defaultCustomRepositoriesDataCanopyPackageRepoOnly =
  CustomRepositoriesData
    { _customFullRepositories =
        [ standardCanopyRepository
        ],
