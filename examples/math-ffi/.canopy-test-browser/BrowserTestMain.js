...
_Platform_export({'BrowserTestMain':{'init': _VirtualDom_init( $user$project$BrowserTestMain$main)(0)(0)},'UtilsTest':{'init': _VirtualDom_init( $user$project$UtilsTest$main)(0)(0)},'MathTest':{'init': _VirtualDom_init( $user$project$MathTest$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
