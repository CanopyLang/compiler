...
const playwrightPaths = [
  path.join('/home/quinten/fh/canopy/examples/math-ffi', 'node_modules', 'playwright'),
...
(async () => {
  ...
  try {
    ...
    await page.goto('file:///home/quinten/fh/canopy/examples/math-ffi/.canopy-test-browser/test.html');
