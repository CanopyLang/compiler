...
Math = Math || {};
$author$project$Math$factorial = factorial;
Math.factorial = factorial;
$author$project$Math$gcd = F2(gcd);
Math.gcd = F2(gcd);
$author$project$Math$lcm = F2(lcm);
Math.lcm = F2(lcm);
$author$project$Math$isPrime = isPrime;
Math.isPrime = isPrime;
$author$project$Math$fibonacci = fibonacci;
Math.fibonacci = fibonacci;
$author$project$Math$power = F2(power);
Math.power = F2(power);
$author$project$Math$sqrt = sqrt;
Math.sqrt = sqrt;
$author$project$Math$degreesToRadians = degreesToRadians;
Math.degreesToRadians = degreesToRadians;
$author$project$Math$radiansToDegrees = radiansToDegrees;
Math.radiansToDegrees = radiansToDegrees;
$author$project$Math$distance2D = F4(distance2D);
