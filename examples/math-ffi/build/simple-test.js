...
// Bindings for external/math.js
var FFI = FFI || {};
var $author$project$FFI$factorial = function(_0) { return $validate.Int(factorial(_0), 'FFI.factorial'); };
FFI.factorial = $author$project$FFI$factorial;
var $author$project$FFI$gcd = F2(function(_0, _1) { return $validate.Int(gcd(_0, _1), 'FFI.gcd'); });
FFI.gcd = $author$project$FFI$gcd;
var $author$project$FFI$lcm = F2(function(_0, _1) { return $validate.Int(lcm(_0, _1), 'FFI.lcm'); });
FFI.lcm = $author$project$FFI$lcm;
var $author$project$FFI$isPrime = function(_0) { return $validate.Bool(isPrime(_0), 'FFI.isPrime'); };
FFI.isPrime = $author$project$FFI$isPrime;
var $author$project$FFI$fibonacci = function(_0) { return $validate.Int(fibonacci(_0), 'FFI.fibonacci'); };
FFI.fibonacci = $author$project$FFI$fibonacci;
var $author$project$FFI$power = F2(function(_0, _1) { return $validate.Float(power(_0, _1), 'FFI.power'); });
FFI.power = $author$project$FFI$power;
var $author$project$FFI$sqrt = function(_0) { return $validate.Result($validate.Opaque('MathError'), $validate.Float)(sqrt(_0), 'FFI.sqrt'); };
FFI.sqrt = $author$project$FFI$sqrt;
var $author$project$FFI$degreesToRadians = function(_0) { return $validate.Float(degreesToRadians(_0), 'FFI.degreesToRadians'); };
FFI.degreesToRadians = $author$project$FFI$degreesToRadians;
var $author$project$FFI$radiansToDegrees = function(_0) { return $validate.Float(radiansToDegrees(_0), 'FFI.radiansToDegrees'); };
FFI.radiansToDegrees = $author$project$FFI$radiansToDegrees;
var $author$project$FFI$distance2D = F4(function(_0, _1, _2, _3) { return $validate.Float(distance2D(_0, _1, _2, _3), 'FFI.distance2D'); });
FFI.distance2D = $author$project$FFI$distance2D;
...
function _validate_Result_Opaque_MathError_Float(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Float(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_MathError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
}

function _validate_Opaque_MathError(v, ctx) {
  return v; // Opaque type: MathError
}
...
var $user$project$SimpleTest$formatResult = function(result){ return ( result.passed?('[PASS] ' + result.name):'[FAIL] ' +( result.name +(': ' + result.message)));};
...
var $user$project$SimpleTest$factorial = FFI.factorial;
var $user$project$SimpleTest$testFactorial = function(){var result = $user$project$SimpleTest$factorial(5);var expected =120; return ({passed : _Utils_eq( result, expected),name :'factorial(5) = 120',message :'Expected ' +( $elm$core$String$fromInt( expected) +(' but got ' + $elm$core$String$fromInt( result)))});}();
var $user$project$SimpleTest$fibonacci = FFI.fibonacci;
var $user$project$SimpleTest$testFibonacci = function(){var result = $user$project$SimpleTest$fibonacci(10);var expected =55; return ({passed : _Utils_eq( result, expected),name :'fibonacci(10) = 55',message :'Expected ' +( $elm$core$String$fromInt( expected) +(' but got ' + $elm$core$String$fromInt( result)))});}();
var $user$project$SimpleTest$gcd = FFI.gcd;
var $user$project$SimpleTest$testGcd = function(){var result = A2( $user$project$SimpleTest$gcd,48,18);var expected =6; return ({passed : _Utils_eq( result, expected),name :'gcd(48, 18) = 6',message :'Expected ' +( $elm$core$String$fromInt( expected) +(' but got ' + $elm$core$String$fromInt( result)))});}();
var $elm$core$String$fromFloat = _String_fromNumber;
var $user$project$SimpleTest$power = FFI.power;
var $user$project$SimpleTest$testPower = function(){var result = A2( $user$project$SimpleTest$power,2.0,10);var expected =1024.0; return ({passed : _Utils_eq( result, expected),name :'power(2, 10) = 1024',message :'Expected ' +( $elm$core$String$fromFloat( expected) +(' but got ' + $elm$core$String$fromFloat( result)))});}();
var $user$project$SimpleTest$isPrime = FFI.isPrime;
var $user$project$SimpleTest$testPrime = function(){var result = $user$project$SimpleTest$isPrime(17); return ({passed : result,name :'isPrime(17) = True',message :'Expected True but got False'});}();
var $user$project$SimpleTest$runAllTests = function(_v0){var results = _List_fromArray([ $user$project$SimpleTest$testFactorial , $user$project$SimpleTest$testFibonacci , $user$project$SimpleTest$testGcd , $user$project$SimpleTest$testPrime , $user$project$SimpleTest$testPower]);var passCount = $elm$core$List$length( A2( $elm$core$List$filter, function($){ return ( $.passed);}, results));var failCount = $elm$core$List$length( results) - passCount; return ('Math FFI Test Results\n' +('=====================\n' +('Total: ' +( $elm$core$String$fromInt( $elm$core$List$length( results)) +('\n' +('Passed: ' +( $elm$core$String$fromInt( passCount) +('\n' +('Failed: ' +( $elm$core$String$fromInt( failCount) +('\n\n' + A2( $elm$core$String$join,'\n', A2( $elm$core$List$map, $user$project$SimpleTest$formatResult, results)))))))))))));};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $user$project$SimpleTest$main = A2( $elm$html$Html$pre, _List_Nil, _List_fromArray([ $elm$html$Html$text( $user$project$SimpleTest$runAllTests( _List_Nil))]));
...
var $elm$random$Random$Seed = F2( function(a,b){ return ({b : b,a : a,$ :'Seed'});});
var $elm$core$Bitwise$shiftRightZfBy = _Bitwise_shiftRightZfBy;
var $elm$random$Random$next = function(_v0){var state0 = _v0.a;var incr = _v0.b; return ( A2( $elm$random$Random$Seed, state0 *1664525 + incr >>>0, incr));};
var $elm$random$Random$initialSeed = function(x){var _v0 = $elm$random$Random$next( A2( $elm$random$Random$Seed,0,1013904223));var state1 = _v0.a;var incr = _v0.b;var state2 = state1 + x >>>0; return ( $elm$random$Random$next( A2( $elm$random$Random$Seed, state2, incr)));};
...
var $elm$random$Random$init = A2( $elm$core$Task$andThen, function(time){ return ( $elm$core$Task$succeed( $elm$random$Random$initialSeed( $elm$time$Time$posixToMillis( time))));}, $elm$time$Time$now);
var $elm$core$Platform$sendToApp = _Platform_sendToApp;
var $elm$random$Random$step = F2( function(_v0,seed){var generator = _v0.a; return ( generator( seed));});
var $elm$random$Random$onEffects = F3( function(router,commands,seed){if (! commands.b ) return ( $elm$core$Task$succeed( seed)); else{var generator = commands.a.a;var rest = commands.b;var _v1 = A2( $elm$random$Random$step, generator, seed);var value = _v1.a;var newSeed = _v1.b; return ( A2( $elm$core$Task$andThen, function(_v2){ return ( A3( $elm$random$Random$onEffects, router, rest, newSeed));}, A2( $elm$core$Platform$sendToApp, router, value)));}});
var $elm$random$Random$onSelfMsg = F3( function(_v0,_v1,seed){ return ( $elm$core$Task$succeed( seed));});
var $elm$random$Random$Generate = function(a){ return ({a : a,$ :'Generate'});};
var $elm$random$Random$Generator = function(a){ return ({a : a,$ :'Generator'});};
var $elm$random$Random$map = F2( function(func,_v0){var genA = _v0.a; return ( $elm$random$Random$Generator( function(seed0){var _v1 = genA( seed0);var a = _v1.a;var seed1 = _v1.b; return ( _Utils_Tuple2( func( a), seed1));}));});
var $elm$random$Random$cmdMap = F2( function(func,_v0){var generator = _v0.a; return ( $elm$random$Random$Generate( A2( $elm$random$Random$map, func, generator)));});
...
var $user$project$SimpleTest$TestResult = F3( function(name,passed,message){ return ({passed : passed,name : name,message : message});});
...
var $elm$random$Random$listHelp = F4( function(revList,n,gen,seed){listHelp: while (true ){if ( n <1 ){ return ( _Utils_Tuple2( revList, seed));} else{var _v0 = gen( seed);var value = _v0.a;var newSeed = _v0.b;var $temp$seed = newSeed, $temp$gen = gen, $temp$n = n -1, $temp$revList = A2( $elm$core$List$cons, value, revList)
...
var $elm$random$Random$addOne = function(value){ return ( _Utils_Tuple2(1, value));};
...
var $elm$random$Random$andThen = F2( function(callback,_v0){var genA = _v0.a; return ( $elm$random$Random$Generator( function(seed){var _v1 = genA( seed);var result = _v1.a;var newSeed = _v1.b;var _v2 = callback( result);var genB = _v2.a; return ( genB( newSeed));}));});
...
var $elm$random$Random$constant = function(value){ return ( $elm$random$Random$Generator( function(seed){ return ( _Utils_Tuple2( value, seed));}));};
...
var $elm$random$Random$peel = function(_v0){var state = _v0.a;var word = state ^ state >>>( state >>>28 +4) *277803737; return ( word >>>22 ^ word >>>0);};
var $elm$random$Random$float = F2( function(a,b){ return ( $elm$random$Random$Generator( function(seed0){var seed1 = $elm$random$Random$next( seed0);var range = $elm$core$Basics$abs( b - a);var n1 = $elm$random$Random$peel( seed1);var n0 = $elm$random$Random$peel( seed0);var lo =134217727 & n1 *1.0;var hi =67108863 & n0 *1.0;var val = hi *134217728.0 + lo /9007199254740992.0;var scaled = val * range + a; return ( _Utils_Tuple2( scaled, $elm$random$Random$next( seed1)));}));});
...
var $elm$random$Random$generate = F2( function(tagger,generator){ return ( $elm$random$Random$command( $elm$random$Random$Generate( A2( $elm$random$Random$map, tagger, generator))));});
...
var $elm$random$Random$lazy = function(callback){ return ( $elm$random$Random$Generator( function(seed){var _v0 = callback( _Utils_Tuple0);var gen = _v0.a; return ( gen( seed));}));};
...
var $elm$random$Random$list = F2( function(n,_v0){var gen = _v0.a; return ( $elm$random$Random$Generator( function(seed){ return ( A4( $elm$random$Random$listHelp, _List_Nil, n, gen, seed));}));});
...
var $elm$random$Random$map2 = F3( function(func,_v0,_v1){var genA = _v0.a;var genB = _v1.a; return ( $elm$random$Random$Generator( function(seed0){var _v2 = genA( seed0);var a = _v2.a;var seed1 = _v2.b;var _v3 = genB( seed1);var b = _v3.a;var seed2 = _v3.b; return ( _Utils_Tuple2( A2( func, a, b), seed2));}));});
...
var $elm$random$Random$pair = F2( function(genA,genB){ return ( A3( $elm$random$Random$map2, F2( function(a,b){ return ( _Utils_Tuple2( a, b));}), genA, genB));});
...
var $elm$random$Random$weighted = F2( function(first,others){var normalize = function(_v0){var weight = _v0.a; return ( $elm$core$Basics$abs( weight));};var total = normalize( first) + $elm$core$List$sum( A2( $elm$core$List$map, normalize, others)); return ( A2( $elm$random$Random$map, A2( $elm$random$Random$getByWeight, first, others), A2( $elm$random$Random$float,0, total)));});
var $elm$random$Random$uniform = F2( function(value,valueList){ return ( A2( $elm$random$Random$weighted, $elm$random$Random$addOne( value), A2( $elm$core$List$map, $elm$random$Random$addOne, valueList)));});
...
_Platform_export({'SimpleTest':{'init': _VirtualDom_init( $user$project$SimpleTest$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
