...
var Math = Math || {};
var $author$project$Math$factorial = function(_0) { return $validate.Int(factorial(_0), 'Math.factorial'); };
Math.factorial = $author$project$Math$factorial;
var $author$project$Math$gcd = F2(function(_0, _1) { return $validate.Int(gcd(_0, _1), 'Math.gcd'); });
Math.gcd = $author$project$Math$gcd;
var $author$project$Math$lcm = F2(function(_0, _1) { return $validate.Int(lcm(_0, _1), 'Math.lcm'); });
Math.lcm = $author$project$Math$lcm;
var $author$project$Math$isPrime = function(_0) { return $validate.Bool(isPrime(_0), 'Math.isPrime'); };
Math.isPrime = $author$project$Math$isPrime;
var $author$project$Math$fibonacci = function(_0) { return $validate.Int(fibonacci(_0), 'Math.fibonacci'); };
Math.fibonacci = $author$project$Math$fibonacci;
var $author$project$Math$power = F2(function(_0, _1) { return $validate.Float(power(_0, _1), 'Math.power'); });
Math.power = $author$project$Math$power;
var $author$project$Math$sqrt = function(_0) { return $validate.Result($validate.Opaque('MathError'), $validate.Float)(sqrt(_0), 'Math.sqrt'); };
Math.sqrt = $author$project$Math$sqrt;
var $author$project$Math$degreesToRadians = function(_0) { return $validate.Float(degreesToRadians(_0), 'Math.degreesToRadians'); };
Math.degreesToRadians = $author$project$Math$degreesToRadians;
var $author$project$Math$radiansToDegrees = function(_0) { return $validate.Float(radiansToDegrees(_0), 'Math.radiansToDegrees'); };
Math.radiansToDegrees = $author$project$Math$radiansToDegrees;
var $author$project$Math$distance2D = F4(function(_0, _1, _2, _3) { return $validate.Float(distance2D(_0, _1, _2, _3), 'Math.distance2D'); });
Math.distance2D = $author$project$Math$distance2D;
...
var $user$project$Main$RunCalculations ={$ :'RunCalculations'};
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$html$Html$div = _VirtualDom_node('div');
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $user$project$Main$init ='Click the button to run mathematical calculations!';
...
var $user$project$Main$boolToString = function(bool){ return ( bool?'Yes':'No');};
...
var $user$project$Main$runMathExamples = function(){var results = _List_fromArray(['=== FACTORIAL CALCULATIONS ===' ,'5! = ' + $elm$core$String$fromInt( Math.factorial(5)) ,'7! = ' + $elm$core$String$fromInt( Math.factorial(7)) ,'' ,'=== PRIME NUMBERS ===' ,'Is 17 prime? ' + $user$project$Main$boolToString( Math.isPrime(17)) ,'Is 18 prime? ' + $user$project$Main$boolToString( Math.isPrime(18)) ,'' ,'=== FIBONACCI SEQUENCE ===' ,'fib(10) = ' + $elm$core$String$fromInt( Math.fibonacci(10)) ,'fib(15) = ' + $elm$core$String$fromInt( Math.fibonacci(15)) ,'' ,'=== GCD ===' ,'gcd(48, 18) = ' + $elm$core$String$fromInt( A2( Math.gcd,48,18)) ,'' ,'=== POWER CALCULATIONS ===' ,'2^8 = ' + $elm$core$String$fromFloat( A2( Math.power,2,8)) ,'3^4 = ' + $elm$core$String$fromFloat( A2( Math.power,3,4))]); return ( A2( $elm$core$String$join,'\n', results));}();
...
var $user$project$Main$update = F2( function(msg,model){ return ( $user$project$Main$runMathExamples);});
...
_Platform_export({'Main':{'init': _VirtualDom_init( $user$project$Main$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
