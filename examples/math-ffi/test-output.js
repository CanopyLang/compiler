...
var $_FFI_Math = $_FFI_Math || {};
var $author$project$Math$factorial = factorial;
$_FFI_Math.factorial = factorial;
var $author$project$Math$gcd = F2(gcd);
$_FFI_Math.gcd = F2(gcd);
var $author$project$Math$lcm = F2(lcm);
$_FFI_Math.lcm = F2(lcm);
var $author$project$Math$isPrime = isPrime;
$_FFI_Math.isPrime = isPrime;
var $author$project$Math$fibonacci = fibonacci;
$_FFI_Math.fibonacci = fibonacci;
var $author$project$Math$power = F2(power);
$_FFI_Math.power = F2(power);
var $author$project$Math$sqrt = sqrt;
$_FFI_Math.sqrt = sqrt;
var $author$project$Math$degreesToRadians = degreesToRadians;
$_FFI_Math.degreesToRadians = degreesToRadians;
var $author$project$Math$radiansToDegrees = radiansToDegrees;
$_FFI_Math.radiansToDegrees = radiansToDegrees;
var $author$project$Math$distance2D = F4(distance2D);
$_FFI_Math.distance2D = F4(distance2D);
...
var $user$project$Main$runMathExamples = function(){var results = _List_fromArray(['=== FACTORIAL CALCULATIONS ===' ,'5! = ' + $elm$core$String$fromInt( $author$project$Math$factorial(5)) ,'7! = ' + $elm$core$String$fromInt( $author$project$Math$factorial(7)) ,'' ,'=== PRIME NUMBERS ===' ,'Is 17 prime? ' + $user$project$Main$boolToString( $author$project$Math$isPrime(17)) ,'Is 18 prime? ' + $user$project$Main$boolToString( $author$project$Math$isPrime(18)) ,'' ,'=== FIBONACCI SEQUENCE ===' ,'fib(10) = ' + $elm$core$String$fromInt( $author$project$Math$fibonacci(10)) ,'fib(15) = ' + $elm$core$String$fromInt( $author$project$Math$fibonacci(15)) ,'' ,'=== GCD ===' ,'gcd(48, 18) = ' + $elm$core$String$fromInt( A2( $author$project$Math$gcd,48,18)) ,'' ,'=== POWER CALCULATIONS ===' ,'2^8 = ' + $elm$core$String$fromFloat( A2( $author$project$Math$power,2,8)) ,'3^4 = ' + $elm$core$String$fromFloat( A2( $author$project$Math$power,3,4))]); return ( A2( $elm$core$String$join,'\n', results));}();
