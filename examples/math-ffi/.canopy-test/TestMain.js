 ...
 * @returns {Object} Result type - Ok with square root or Err with MathError
 */
function sqrt(x) {
    if (typeof x !== 'number' || x < 0) {
        return {
            $: 'Err',
            a: { $: 'NegativeInput', a: `sqrt: input must be a non-negative number, got ${x}` }
        };
    }

    if (x === 0) return { $: 'Ok', a: 0 };
    if (x === 1) return { $: 'Ok', a: 1 };
...
var $author$project$FFI$factorial = factorial;
$_FFI_FFI.factorial = factorial;
var $author$project$FFI$gcd = F2(gcd);
$_FFI_FFI.gcd = F2(gcd);
var $author$project$FFI$lcm = F2(lcm);
$_FFI_FFI.lcm = F2(lcm);
var $author$project$FFI$isPrime = isPrime;
$_FFI_FFI.isPrime = isPrime;
var $author$project$FFI$fibonacci = fibonacci;
$_FFI_FFI.fibonacci = fibonacci;
var $author$project$FFI$power = F2(power);
$_FFI_FFI.power = F2(power);
var $author$project$FFI$sqrt = sqrt;
$_FFI_FFI.sqrt = sqrt;
var $author$project$FFI$degreesToRadians = degreesToRadians;
$_FFI_FFI.degreesToRadians = degreesToRadians;
var $author$project$FFI$radiansToDegrees = radiansToDegrees;
$_FFI_FFI.radiansToDegrees = radiansToDegrees;
var $author$project$FFI$distance2D = F4(distance2D);
$_FFI_FFI.distance2D = F4(distance2D);


// Bindings for external/utils.js
var $_FFI_FFI = $_FFI_FFI || {};
var $author$project$FFI$randomInt = randomInt;
$_FFI_FFI.randomInt = randomInt;
var $author$project$FFI$getCurrentTimestamp = getCurrentTimestamp;
$_FFI_FFI.getCurrentTimestamp = getCurrentTimestamp;
var $author$project$FFI$consoleLog = consoleLog;
$_FFI_FFI.consoleLog = consoleLog;
...
var $user$project$Utils$consoleLog = $author$project$FFI$consoleLog;
...
var $user$project$UtilsTest$consoleLogTests = A2( $user$project$Test$describe,'consoleLog', _List_fromArray([ A2( $user$project$Test$test,'consoleLog executes without error', function(_v0){var _v1 = $user$project$Utils$consoleLog('Test message'); return ( $user$project$Expect$pass);}) , A2( $user$project$Test$test,'consoleLog with empty string executes', function(_v2){var _v3 = $user$project$Utils$consoleLog(''); return ( $user$project$Expect$pass);}) , A2( $user$project$Test$test,'consoleLog with special characters executes', function(_v4){var _v5 = $user$project$Utils$consoleLog('Test: !@#$%^&*()'); return ( $user$project$Expect$pass);}) , A2( $user$project$Test$test,'consoleLog with unicode executes', function(_v6){var _v7 = $user$project$Utils$consoleLog('Unicode test: \uD83D\uDE00'); return ( $user$project$Expect$pass);}) , A2( $user$project$Test$test,'consoleLog with newlines executes', function(_v8){var _v9 = $user$project$Utils$consoleLog('Line 1\nLine 2\nLine 3'); return ( $user$project$Expect$pass);})]));
...
var $user$project$Utils$randomInt = $author$project$FFI$randomInt;
...
var $user$project$UtilsTest$randomIntTests = A2( $user$project$Test$describe,'randomInt', _List_fromArray([ A2( $user$project$Test$describe,'range validation', _List_fromArray([ A2( $user$project$Test$test,'randomInt 10 returns value less than 10', function(_v0){var result = $user$project$Utils$randomInt(10); return ( A2( $user$project$Expect$true,'should be less than 10', result <10));}) , A2( $user$project$Test$test,'randomInt 10 returns non-negative value', function(_v1){var result = $user$project$Utils$randomInt(10); return ( A2( $user$project$Expect$true,'should be >= 0', result >=0));}) , A2( $user$project$Test$test,'randomInt 100 returns value in range [0, 100)', function(_v2){var result = $user$project$Utils$randomInt(100); return ( A2( $user$project$Expect$true,'should be in range', result >=0 && result <100));}) , A2( $user$project$Test$test,'randomInt 1 returns 0', function(_v3){var result = $user$project$Utils$randomInt(1); return ( A2( $user$project$Expect$equal,0, result));})])) , A2( $user$project$Test$describe,'multiple calls produce valid results', _List_fromArray([ A2( $user$project$Test$test,'five calls to randomInt 50 all produce valid results', function(_v4){var r5 = $user$project$Utils$randomInt(50);var r4 = $user$project$Utils$randomInt(50);var r3 = $user$project$Utils$randomInt(50);var r2 = $user$project$Utils$randomInt(50);var r1 = $user$project$Utils$randomInt(50);var allValid = A2( $elm$core$List$all, function(r){ return ( r >=0 && r <50);}, _List_fromArray([ r1 , r2 , r3 , r4 , r5])); return ( A2( $user$project$Expect$true,'all should be valid', allValid));})]))]));
var $user$project$Utils$getCurrentTimestamp = $author$project$FFI$getCurrentTimestamp;
var $user$project$UtilsTest$timestampTests = A2( $user$project$Test$describe,'getCurrentTimestamp', _List_fromArray([ A2( $user$project$Test$test,'timestamp is a positive number', function(_v0){ return ( A2( $user$project$Expect$true,'should be positive', $user$project$Utils$getCurrentTimestamp >0));}) , A2( $user$project$Test$test,'timestamp is a reasonable Unix timestamp (after year 2000)', function(_v1){ return ( A2( $user$project$Expect$true,'should be after year 2000', $user$project$Utils$getCurrentTimestamp >946684800000));}) , A2( $user$project$Test$test,'timestamp is not in the far future (before year 2100)', function(_v2){ return ( A2( $user$project$Expect$true,'should be before year 2100', $user$project$Utils$getCurrentTimestamp <4102444800000));})]));
var $user$project$UtilsTest$suite = A2( $user$project$Test$describe,'Utils FFI Complete Test Suite', _List_fromArray([ $user$project$UtilsTest$randomIntTests , $user$project$UtilsTest$timestampTests , $user$project$UtilsTest$consoleLogTests]));
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $user$project$UtilsTest$main = function(){var results = $user$project$Test$runTests( _List_fromArray([ $user$project$UtilsTest$suite])); return ( A2( $elm$html$Html$pre, _List_Nil, _List_fromArray([ $elm$html$Html$text( results)])));}();
var $user$project$Expect$Absolute = function(a){ return ({a : a,$ :'Absolute'});};
var $user$project$MathTest$degreesToRadians = $author$project$FFI$degreesToRadians;
var $user$project$MathTest$radiansToDegrees = $author$project$FFI$radiansToDegrees;
...
var $user$project$MathTest$angleConversionTests = A2( $user$project$Test$describe,'angle conversions', _List_fromArray([ A2( $user$project$Test$test,'0 degrees equals 0 radians', function(_v0){ return ( A2( $user$project$Expect$equal,0.0, $user$project$MathTest$degreesToRadians(0.0)));}) , A2( $user$project$Test$test,'90 degrees is approximately pi/2', function(_v1){ return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.0001),1.5708, $user$project$MathTest$degreesToRadians(90.0)));}) , A2( $user$project$Test$test,'180 degrees is approximately pi', function(_v2){ return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.0001),3.1416, $user$project$MathTest$degreesToRadians(180.0)));}) , A2( $user$project$Test$test,'0 radians equals 0 degrees', function(_v3){ return ( A2( $user$project$Expect$equal,0.0, $user$project$MathTest$radiansToDegrees(0.0)));}) , A2( $user$project$Test$test,'roundtrip conversion for 45 degrees', function(_v4){ return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.0001),45.0, $user$project$MathTest$radiansToDegrees( $user$project$MathTest$degreesToRadians(45.0))));})]));
var $user$project$MathTest$distance2D = $author$project$FFI$distance2D;
var $user$project$MathTest$distanceTests = A2( $user$project$Test$describe,'distance2D', _List_fromArray([ A2( $user$project$Test$test,'3-4-5 triangle', function(_v0){ return ( A2( $user$project$Expect$equal,5.0, A4( $user$project$MathTest$distance2D,0.0,0.0,3.0,4.0)));}) , A2( $user$project$Test$test,'5-12-13 triangle', function(_v1){ return ( A2( $user$project$Expect$equal,13.0, A4( $user$project$MathTest$distance2D,0.0,0.0,5.0,12.0)));}) , A2( $user$project$Test$test,'distance from point to itself is 0', function(_v2){ return ( A2( $user$project$Expect$equal,0.0, A4( $user$project$MathTest$distance2D,5.0,5.0,5.0,5.0)));}) , A2( $user$project$Test$test,'distance is symmetric', function(_v3){ return ( A2( $user$project$Expect$equal, A4( $user$project$MathTest$distance2D,0.0,0.0,3.0,4.0), A4( $user$project$MathTest$distance2D,3.0,4.0,0.0,0.0)));})]));
var $user$project$MathTest$factorial = $author$project$FFI$factorial;
var $user$project$MathTest$factorialTests = A2( $user$project$Test$describe,'factorial', _List_fromArray([ A2( $user$project$Test$test,'factorial 0 equals 1', function(_v0){ return ( A2( $user$project$Expect$equal,1, $user$project$MathTest$factorial(0)));}) , A2( $user$project$Test$test,'factorial 1 equals 1', function(_v1){ return ( A2( $user$project$Expect$equal,1, $user$project$MathTest$factorial(1)));}) , A2( $user$project$Test$test,'factorial 5 equals 120', function(_v2){ return ( A2( $user$project$Expect$equal,120, $user$project$MathTest$factorial(5)));}) , A2( $user$project$Test$test,'factorial 10 equals 3628800', function(_v3){ return ( A2( $user$project$Expect$equal,3628800, $user$project$MathTest$factorial(10)));})]));
var $user$project$MathTest$fibonacci = $author$project$FFI$fibonacci;
var $user$project$MathTest$fibonacciTests = A2( $user$project$Test$describe,'fibonacci', _List_fromArray([ A2( $user$project$Test$test,'fibonacci 0 equals 0', function(_v0){ return ( A2( $user$project$Expect$equal,0, $user$project$MathTest$fibonacci(0)));}) , A2( $user$project$Test$test,'fibonacci 1 equals 1', function(_v1){ return ( A2( $user$project$Expect$equal,1, $user$project$MathTest$fibonacci(1)));}) , A2( $user$project$Test$test,'fibonacci 10 equals 55', function(_v2){ return ( A2( $user$project$Expect$equal,55, $user$project$MathTest$fibonacci(10)));}) , A2( $user$project$Test$test,'fibonacci 20 equals 6765', function(_v3){ return ( A2( $user$project$Expect$equal,6765, $user$project$MathTest$fibonacci(20)));})]));
var $user$project$MathTest$gcd = $author$project$FFI$gcd;
var $user$project$MathTest$gcdTests = A2( $user$project$Test$describe,'gcd', _List_fromArray([ A2( $user$project$Test$test,'gcd 48 18 equals 6', function(_v0){ return ( A2( $user$project$Expect$equal,6, A2( $user$project$MathTest$gcd,48,18)));}) , A2( $user$project$Test$test,'gcd 7 13 equals 1 (coprime)', function(_v1){ return ( A2( $user$project$Expect$equal,1, A2( $user$project$MathTest$gcd,7,13)));}) , A2( $user$project$Test$test,'gcd 0 5 equals 5', function(_v2){ return ( A2( $user$project$Expect$equal,5, A2( $user$project$MathTest$gcd,0,5)));}) , A2( $user$project$Test$test,'gcd is commutative', function(_v3){ return ( A2( $user$project$Expect$equal, A2( $user$project$MathTest$gcd,48,18), A2( $user$project$MathTest$gcd,18,48)));})]));
var $user$project$MathTest$lcm = $author$project$FFI$lcm;
var $user$project$MathTest$lcmTests = A2( $user$project$Test$describe,'lcm', _List_fromArray([ A2( $user$project$Test$test,'lcm 4 6 equals 12', function(_v0){ return ( A2( $user$project$Expect$equal,12, A2( $user$project$MathTest$lcm,4,6)));}) , A2( $user$project$Test$test,'lcm 7 13 equals 91', function(_v1){ return ( A2( $user$project$Expect$equal,91, A2( $user$project$MathTest$lcm,7,13)));}) , A2( $user$project$Test$test,'lcm 0 5 equals 0', function(_v2){ return ( A2( $user$project$Expect$equal,0, A2( $user$project$MathTest$lcm,0,5)));}) , A2( $user$project$Test$test,'lcm is commutative', function(_v3){ return ( A2( $user$project$Expect$equal, A2( $user$project$MathTest$lcm,4,6), A2( $user$project$MathTest$lcm,6,4)));})]));
var $user$project$MathTest$power = $author$project$FFI$power;
var $user$project$MathTest$powerTests = A2( $user$project$Test$describe,'power', _List_fromArray([ A2( $user$project$Test$test,'power 2.0 0 equals 1.0', function(_v0){ return ( A2( $user$project$Expect$equal,1.0, A2( $user$project$MathTest$power,2.0,0)));}) , A2( $user$project$Test$test,'power 2.0 8 equals 256.0', function(_v1){ return ( A2( $user$project$Expect$equal,256.0, A2( $user$project$MathTest$power,2.0,8)));}) , A2( $user$project$Test$test,'power 3.0 4 equals 81.0', function(_v2){ return ( A2( $user$project$Expect$equal,81.0, A2( $user$project$MathTest$power,3.0,4)));}) , A2( $user$project$Test$test,'power 10.0 3 equals 1000.0', function(_v3){ return ( A2( $user$project$Expect$equal,1000.0, A2( $user$project$MathTest$power,10.0,3)));})]));
var $user$project$MathTest$isPrime = $author$project$FFI$isPrime;
var $user$project$MathTest$primeTests = A2( $user$project$Test$describe,'isPrime', _List_fromArray([ A2( $user$project$Test$test,'0 is not prime', function(_v0){ return ( A2( $user$project$Expect$equal,false, $user$project$MathTest$isPrime(0)));}) , A2( $user$project$Test$test,'1 is not prime', function(_v1){ return ( A2( $user$project$Expect$equal,false, $user$project$MathTest$isPrime(1)));}) , A2( $user$project$Test$test,'2 is prime', function(_v2){ return ( A2( $user$project$Expect$equal,true, $user$project$MathTest$isPrime(2)));}) , A2( $user$project$Test$test,'17 is prime', function(_v3){ return ( A2( $user$project$Expect$equal,true, $user$project$MathTest$isPrime(17)));}) , A2( $user$project$Test$test,'18 is not prime', function(_v4){ return ( A2( $user$project$Expect$equal,false, $user$project$MathTest$isPrime(18)));}) , A2( $user$project$Test$test,'97 is prime', function(_v5){ return ( A2( $user$project$Expect$equal,true, $user$project$MathTest$isPrime(97)));})]));
var $user$project$Expect$fail = function(message){ return ( $user$project$Expect$Fail( $user$project$Expect$Custom( message)));};
var $user$project$MathTest$sqrt = $author$project$FFI$sqrt;
var $user$project$MathTest$sqrtTests = A2( $user$project$Test$describe,'sqrt', _List_fromArray([ A2( $user$project$Test$test,'sqrt 0.0 equals Ok 0.0', function(_v0){ return ( A2( $user$project$Expect$equal, $elm$core$Result$Ok(0.0), $user$project$MathTest$sqrt(0.0)));}) , A2( $user$project$Test$test,'sqrt 4.0 equals Ok 2.0', function(_v1){ return ( A2( $user$project$Expect$equal, $elm$core$Result$Ok(2.0), $user$project$MathTest$sqrt(4.0)));}) , A2( $user$project$Test$test,'sqrt 9.0 equals Ok 3.0', function(_v2){ return ( A2( $user$project$Expect$equal, $elm$core$Result$Ok(3.0), $user$project$MathTest$sqrt(9.0)));}) , A2( $user$project$Test$test,'sqrt 16.0 equals Ok 4.0', function(_v3){ return ( A2( $user$project$Expect$equal, $elm$core$Result$Ok(4.0), $user$project$MathTest$sqrt(16.0)));}) , A2( $user$project$Test$test,'sqrt of negative returns error', function(_v4){var _v5 = $user$project$MathTest$sqrt(-1.0);if ( _v5.$ ==='Err' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$fail('Expected Err for negative input'));})]));
var $user$project$MathTest$suite = A2( $user$project$Test$describe,'Math FFI Complete Test Suite', _List_fromArray([ $user$project$MathTest$factorialTests , $user$project$MathTest$fibonacciTests , $user$project$MathTest$gcdTests , $user$project$MathTest$lcmTests , $user$project$MathTest$primeTests , $user$project$MathTest$powerTests , $user$project$MathTest$sqrtTests , $user$project$MathTest$angleConversionTests , $user$project$MathTest$distanceTests]));
var $user$project$TestMain$main = function(){var allSuites = _List_fromArray([ $user$project$MathTest$suite , $user$project$UtilsTest$suite]);var report = $user$project$Test$runTests( allSuites); return ( A2( $elm$html$Html$pre, _List_Nil, _List_fromArray([ $elm$html$Html$text( report)])));}();
var $user$project$MathTest$main = function(){var results = $user$project$Test$runTests( _List_fromArray([ $user$project$MathTest$suite])); return ( A2( $elm$html$Html$pre, _List_Nil, _List_fromArray([ $elm$html$Html$text( results)])));}();
...
var $user$project$MathTest$InvalidInput = function(a){ return ({a : a,$ :'InvalidInput'});};
...
var $user$project$MathTest$NegativeInput = function(a){ return ({a : a,$ :'NegativeInput'});};
...
_Platform_export({'MathTest':{'init': _VirtualDom_init( $user$project$MathTest$main)(0)(0)},'UtilsTest':{'init': _VirtualDom_init( $user$project$UtilsTest$main)(0)(0)},'TestMain':{'init': _VirtualDom_init( $user$project$TestMain$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
