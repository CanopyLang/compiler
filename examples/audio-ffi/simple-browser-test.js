...
var $author$project$AudioFFI$detectWebAudioSupport = detectWebAudioSupport;
AudioFFI.detectWebAudioSupport = detectWebAudioSupport;
var $author$project$AudioFFI$isUserActivationAvailable = isUserActivationAvailable;
AudioFFI.isUserActivationAvailable = isUserActivationAvailable;
var $author$project$AudioFFI$isUserActivationActive = isUserActivationActive;
AudioFFI.isUserActivationActive = isUserActivationActive;
var $author$project$AudioFFI$consumeUserActivation = consumeUserActivation;
AudioFFI.consumeUserActivation = consumeUserActivation;
var $author$project$AudioFFI$requestAudioPermission = requestAudioPermission;
...
var $author$project$AudioFFI$getAudioContext = getAudioContext;
AudioFFI.getAudioContext = getAudioContext;
var $author$project$AudioFFI$createOscillator = createOscillator;
AudioFFI.createOscillator = createOscillator;
var $author$project$AudioFFI$getOscillator = getOscillator;
AudioFFI.getOscillator = getOscillator;
var $author$project$AudioFFI$playTone = F3(playTone);
AudioFFI.playTone = F3(playTone);
var $author$project$AudioFFI$stopTone = F2(stopTone);
...
var $author$project$SimpleBrowserTest$init ={logs : _List_fromArray(['ð FFI Browser Test Ready - No Maybe types'])};
var $author$project$SimpleBrowserTest$CheckAudioSupport ={$ :'CheckAudioSupport'};
var $author$project$SimpleBrowserTest$CheckUserActivation ={$ :'CheckUserActivation'};
...
var $author$project$SimpleBrowserTest$testButtonStyle = A2( $elm$html$Html$Attributes$style,'all','padding: 10px 15px; margin: 5px; background-color: #007cba; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 14px;');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$SimpleBrowserTest$view = function(model){return A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'font-family','Arial, sans-serif')]), _List_fromArray([ A2( $elm$html$Html$h1, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð§ª FFI Browser Test - No Maybe Types')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â FFI Module loaded successfully with complex types\\')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ðµ Test Controls')])) , A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $author$project$SimpleBrowserTest$CheckAudioSupport) , $author$project$SimpleBrowserTest$testButtonStyle]), _List_fromArray([ $elm$html$Html$text('ð Test Audio Support')])) , A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $author$project$SimpleBrowserTest$CheckUserActivation) , $author$project$SimpleBrowserTest$testButtonStyle]), _List_fromArray([ $elm$html$Html$text('ð Test User Activation')]))])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Test Logs')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background-color','#f8f9fa') , A2( $elm$html$Html$Attributes$style,'padding','15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px')]), A2( $elm$core$List$map, function(log){return A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text( log)]));}, $elm$core$List$reverse( model.logs)))]))]));};
var $author$project$SimpleBrowserTest$main = $author$project$SimpleBrowserTest$view( $author$project$SimpleBrowserTest$init);
_Platform_export({'SimpleBrowserTest':{'init': _VirtualDom_init( $author$project$SimpleBrowserTest$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));