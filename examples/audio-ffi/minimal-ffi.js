...
Simple = Simple || {};
$author$project$Simple$getActivation = getActivation;
Simple.getActivation = getActivation;
$author$project$Simple$getMessage = getMessage;
...
var $author$project$MinimalFFI$main = A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ $elm$html$Html$text('Minimal FFI test')]));
_Platform_export({'MinimalFFI':{'init': _VirtualDom_init( $author$project$MinimalFFI$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));