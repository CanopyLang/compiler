...
var FFI = FFI || {};
var $author$project$FFI$createAudioContext = function(_0) { return $validate.Any(createAudioContext(_0), 'FFI.createAudioContext'); };
FFI.createAudioContext = $author$project$FFI$createAudioContext;
var $author$project$FFI$getCurrentTime = function(_0) { return $validate.Float(getCurrentTime(_0), 'FFI.getCurrentTime'); };
FFI.getCurrentTime = $author$project$FFI$getCurrentTime;
var $author$project$FFI$resumeAudioContext = function(_0) { return $validate.Any(resumeAudioContext(_0), 'FFI.resumeAudioContext'); };
FFI.resumeAudioContext = $author$project$FFI$resumeAudioContext;
var $author$project$FFI$suspendAudioContext = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioContext'))(suspendAudioContext(_0), 'FFI.suspendAudioContext'); };
FFI.suspendAudioContext = $author$project$FFI$suspendAudioContext;
var $author$project$FFI$closeAudioContext = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(closeAudioContext(_0), 'FFI.closeAudioContext'); };
FFI.closeAudioContext = $author$project$FFI$closeAudioContext;
var $author$project$FFI$getSampleRate = function(_0) { return $validate.Float(getSampleRate(_0), 'FFI.getSampleRate'); };
FFI.getSampleRate = $author$project$FFI$getSampleRate;
var $author$project$FFI$getContextState = function(_0) { return $validate.String(getContextState(_0), 'FFI.getContextState'); };
FFI.getContextState = $author$project$FFI$getContextState;
var $author$project$FFI$decodeAudioData = F2(function(_0, _1) { return $validate.Task($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(decodeAudioData(_0, _1), 'FFI.decodeAudioData'); });
FFI.decodeAudioData = $author$project$FFI$decodeAudioData;
var $author$project$FFI$createOscillator = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('OscillatorNode'))(createOscillator(_0, _1, _2), 'FFI.createOscillator'); });
FFI.createOscillator = $author$project$FFI$createOscillator;
var $author$project$FFI$startOscillator = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(startOscillator(_0, _1), 'FFI.startOscillator'); });
FFI.startOscillator = $author$project$FFI$startOscillator;
var $author$project$FFI$stopOscillator = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(stopOscillator(_0, _1), 'FFI.stopOscillator'); });
FFI.stopOscillator = $author$project$FFI$stopOscillator;
var $author$project$FFI$setOscillatorFrequency = F3(function(_0, _1, _2) { return $validate.Unit(setOscillatorFrequency(_0, _1, _2), 'FFI.setOscillatorFrequency'); });
FFI.setOscillatorFrequency = $author$project$FFI$setOscillatorFrequency;
var $author$project$FFI$setOscillatorDetune = F3(function(_0, _1, _2) { return $validate.Unit(setOscillatorDetune(_0, _1, _2), 'FFI.setOscillatorDetune'); });
FFI.setOscillatorDetune = $author$project$FFI$setOscillatorDetune;
var $author$project$FFI$createBufferSource = function(_0) { return $validate.Opaque('AudioBufferSourceNode')(createBufferSource(_0), 'FFI.createBufferSource'); };
FFI.createBufferSource = $author$project$FFI$createBufferSource;
var $author$project$FFI$createMediaStreamSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('MediaStreamAudioSourceNode'))(createMediaStreamSource(_0, _1), 'FFI.createMediaStreamSource'); });
FFI.createMediaStreamSource = $author$project$FFI$createMediaStreamSource;
var $author$project$FFI$createMediaStreamDestination = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('MediaStreamAudioDestinationNode'))(createMediaStreamDestination(_0), 'FFI.createMediaStreamDestination'); };
FFI.createMediaStreamDestination = $author$project$FFI$createMediaStreamDestination;
var $author$project$FFI$getMediaStream = function(_0) { return $validate.Opaque('MediaStream')(getMediaStream(_0), 'FFI.getMediaStream'); };
FFI.getMediaStream = $author$project$FFI$getMediaStream;
var $author$project$FFI$startBufferSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(startBufferSource(_0, _1), 'FFI.startBufferSource'); });
FFI.startBufferSource = $author$project$FFI$startBufferSource;
var $author$project$FFI$stopBufferSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(stopBufferSource(_0, _1), 'FFI.stopBufferSource'); });
FFI.stopBufferSource = $author$project$FFI$stopBufferSource;
var $author$project$FFI$createGainNode = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('GainNode'))(createGainNode(_0, _1), 'FFI.createGainNode'); });
FFI.createGainNode = $author$project$FFI$createGainNode;
var $author$project$FFI$setGain = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(setGain(_0, _1, _2), 'FFI.setGain'); });
FFI.setGain = $author$project$FFI$setGain;
var $author$project$FFI$rampGainLinear = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(rampGainLinear(_0, _1, _2), 'FFI.rampGainLinear'); });
FFI.rampGainLinear = $author$project$FFI$rampGainLinear;
var $author$project$FFI$rampGainExponential = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(rampGainExponential(_0, _1, _2), 'FFI.rampGainExponential'); });
FFI.rampGainExponential = $author$project$FFI$rampGainExponential;
var $author$project$FFI$createBiquadFilter = F2(function(_0, _1) { return $validate.Opaque('BiquadFilterNode')(createBiquadFilter(_0, _1), 'FFI.createBiquadFilter'); });
FFI.createBiquadFilter = $author$project$FFI$createBiquadFilter;
var $author$project$FFI$setFilterFrequency = F3(function(_0, _1, _2) { return $validate.Unit(setFilterFrequency(_0, _1, _2), 'FFI.setFilterFrequency'); });
FFI.setFilterFrequency = $author$project$FFI$setFilterFrequency;
var $author$project$FFI$setFilterQ = F3(function(_0, _1, _2) { return $validate.Unit(setFilterQ(_0, _1, _2), 'FFI.setFilterQ'); });
FFI.setFilterQ = $author$project$FFI$setFilterQ;
var $author$project$FFI$setFilterGain = F3(function(_0, _1, _2) { return $validate.Unit(setFilterGain(_0, _1, _2), 'FFI.setFilterGain'); });
FFI.setFilterGain = $author$project$FFI$setFilterGain;
var $author$project$FFI$createDelay = F2(function(_0, _1) { return $validate.Opaque('DelayNode')(createDelay(_0, _1), 'FFI.createDelay'); });
FFI.createDelay = $author$project$FFI$createDelay;
var $author$project$FFI$setDelayTime = F3(function(_0, _1, _2) { return $validate.Unit(setDelayTime(_0, _1, _2), 'FFI.setDelayTime'); });
FFI.setDelayTime = $author$project$FFI$setDelayTime;
var $author$project$FFI$createConvolver = function(_0) { return $validate.Opaque('ConvolverNode')(createConvolver(_0), 'FFI.createConvolver'); };
FFI.createConvolver = $author$project$FFI$createConvolver;
var $author$project$FFI$setConvolverBuffer = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setConvolverBuffer(_0, _1), 'FFI.setConvolverBuffer'); });
FFI.setConvolverBuffer = $author$project$FFI$setConvolverBuffer;
var $author$project$FFI$setConvolverNormalize = F2(function(_0, _1) { return $validate.Unit(setConvolverNormalize(_0, _1), 'FFI.setConvolverNormalize'); });
FFI.setConvolverNormalize = $author$project$FFI$setConvolverNormalize;
var $author$project$FFI$getConvolverBuffer = function(_0) { return $validate.Maybe($validate.Opaque('AudioBuffer'))(getConvolverBuffer(_0), 'FFI.getConvolverBuffer'); };
FFI.getConvolverBuffer = $author$project$FFI$getConvolverBuffer;
var $author$project$FFI$createDynamicsCompressor = function(_0) { return $validate.Opaque('DynamicsCompressorNode')(createDynamicsCompressor(_0), 'FFI.createDynamicsCompressor'); };
FFI.createDynamicsCompressor = $author$project$FFI$createDynamicsCompressor;
var $author$project$FFI$setCompressorThreshold = F3(function(_0, _1, _2) { return $validate.Unit(setCompressorThreshold(_0, _1, _2), 'FFI.setCompressorThreshold'); });
FFI.setCompressorThreshold = $author$project$FFI$setCompressorThreshold;
var $author$project$FFI$setCompressorKnee = F3(function(_0, _1, _2) { return $validate.Unit(setCompressorKnee(_0, _1, _2), 'FFI.setCompressorKnee'); });
FFI.setCompressorKnee = $author$project$FFI$setCompressorKnee;
var $author$project$FFI$setCompressorRatio = F3(function(_0, _1, _2) { return $validate.Unit(setCompressorRatio(_0, _1, _2), 'FFI.setCompressorRatio'); });
FFI.setCompressorRatio = $author$project$FFI$setCompressorRatio;
var $author$project$FFI$setCompressorAttack = F3(function(_0, _1, _2) { return $validate.Unit(setCompressorAttack(_0, _1, _2), 'FFI.setCompressorAttack'); });
FFI.setCompressorAttack = $author$project$FFI$setCompressorAttack;
var $author$project$FFI$setCompressorRelease = F3(function(_0, _1, _2) { return $validate.Unit(setCompressorRelease(_0, _1, _2), 'FFI.setCompressorRelease'); });
FFI.setCompressorRelease = $author$project$FFI$setCompressorRelease;
var $author$project$FFI$createWaveShaper = function(_0) { return $validate.Opaque('WaveShaperNode')(createWaveShaper(_0), 'FFI.createWaveShaper'); };
FFI.createWaveShaper = $author$project$FFI$createWaveShaper;
var $author$project$FFI$setWaveShaperCurve = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setWaveShaperCurve(_0, _1), 'FFI.setWaveShaperCurve'); });
FFI.setWaveShaperCurve = $author$project$FFI$setWaveShaperCurve;
var $author$project$FFI$setWaveShaperOversample = F2(function(_0, _1) { return $validate.Unit(setWaveShaperOversample(_0, _1), 'FFI.setWaveShaperOversample'); });
FFI.setWaveShaperOversample = $author$project$FFI$setWaveShaperOversample;
var $author$project$FFI$getWaveShaperCurve = function(_0) { return $validate.Maybe($validate.List($validate.Float))(getWaveShaperCurve(_0), 'FFI.getWaveShaperCurve'); };
FFI.getWaveShaperCurve = $author$project$FFI$getWaveShaperCurve;
var $author$project$FFI$makeDistortionCurve = F2(function(_0, _1) { return $validate.List($validate.Float)(makeDistortionCurve(_0, _1), 'FFI.makeDistortionCurve'); });
FFI.makeDistortionCurve = $author$project$FFI$makeDistortionCurve;
var $author$project$FFI$createStereoPanner = function(_0) { return $validate.Opaque('StereoPannerNode')(createStereoPanner(_0), 'FFI.createStereoPanner'); };
FFI.createStereoPanner = $author$project$FFI$createStereoPanner;
var $author$project$FFI$setPan = F3(function(_0, _1, _2) { return $validate.Unit(setPan(_0, _1, _2), 'FFI.setPan'); });
FFI.setPan = $author$project$FFI$setPan;
var $author$project$FFI$createAnalyser = function(_0) { return $validate.Opaque('AnalyserNode')(createAnalyser(_0), 'FFI.createAnalyser'); };
FFI.createAnalyser = $author$project$FFI$createAnalyser;
var $author$project$FFI$setAnalyserFFTSize = F2(function(_0, _1) { return $validate.Unit(setAnalyserFFTSize(_0, _1), 'FFI.setAnalyserFFTSize'); });
FFI.setAnalyserFFTSize = $author$project$FFI$setAnalyserFFTSize;
var $author$project$FFI$setAnalyserSmoothing = F2(function(_0, _1) { return $validate.Unit(setAnalyserSmoothing(_0, _1), 'FFI.setAnalyserSmoothing'); });
FFI.setAnalyserSmoothing = $author$project$FFI$setAnalyserSmoothing;
var $author$project$FFI$getFrequencyBinCount = function(_0) { return $validate.Int(getFrequencyBinCount(_0), 'FFI.getFrequencyBinCount'); };
FFI.getFrequencyBinCount = $author$project$FFI$getFrequencyBinCount;
var $author$project$FFI$connectNodes = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(connectNodes(_0, _1), 'FFI.connectNodes'); });
FFI.connectNodes = $author$project$FFI$connectNodes;
var $author$project$FFI$connectToDestination = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Int)(connectToDestination(_0, _1), 'FFI.connectToDestination'); });
FFI.connectToDestination = $author$project$FFI$connectToDestination;
var $author$project$FFI$disconnectNode = function(_0) { return $validate.Unit(disconnectNode(_0), 'FFI.disconnectNode'); };
FFI.disconnectNode = $author$project$FFI$disconnectNode;
var $author$project$FFI$checkWebAudioSupport = function(_0) { return $validate.String(checkWebAudioSupport(_0), 'FFI.checkWebAudioSupport'); };
FFI.checkWebAudioSupport = $author$project$FFI$checkWebAudioSupport;
var $author$project$FFI$simpleTest = function(_0) { return $validate.Int(simpleTest(_0), 'FFI.simpleTest'); };
FFI.simpleTest = $author$project$FFI$simpleTest;
var $author$project$FFI$createPanner = function(_0) { return $validate.Opaque('PannerNode')(createPanner(_0), 'FFI.createPanner'); };
FFI.createPanner = $author$project$FFI$createPanner;
var $author$project$FFI$setPannerPosition = F4(function(_0, _1, _2, _3) { return $validate.Unit(setPannerPosition(_0, _1, _2, _3), 'FFI.setPannerPosition'); });
FFI.setPannerPosition = $author$project$FFI$setPannerPosition;
var $author$project$FFI$setPannerOrientation = F4(function(_0, _1, _2, _3) { return $validate.Unit(setPannerOrientation(_0, _1, _2, _3), 'FFI.setPannerOrientation'); });
FFI.setPannerOrientation = $author$project$FFI$setPannerOrientation;
var $author$project$FFI$setPanningModel = F2(function(_0, _1) { return $validate.Unit(setPanningModel(_0, _1), 'FFI.setPanningModel'); });
FFI.setPanningModel = $author$project$FFI$setPanningModel;
var $author$project$FFI$setDistanceModel = F2(function(_0, _1) { return $validate.Unit(setDistanceModel(_0, _1), 'FFI.setDistanceModel'); });
FFI.setDistanceModel = $author$project$FFI$setDistanceModel;
var $author$project$FFI$setRefDistance = F2(function(_0, _1) { return $validate.Unit(setRefDistance(_0, _1), 'FFI.setRefDistance'); });
FFI.setRefDistance = $author$project$FFI$setRefDistance;
var $author$project$FFI$setMaxDistance = F2(function(_0, _1) { return $validate.Unit(setMaxDistance(_0, _1), 'FFI.setMaxDistance'); });
FFI.setMaxDistance = $author$project$FFI$setMaxDistance;
var $author$project$FFI$setRolloffFactor = F2(function(_0, _1) { return $validate.Unit(setRolloffFactor(_0, _1), 'FFI.setRolloffFactor'); });
FFI.setRolloffFactor = $author$project$FFI$setRolloffFactor;
var $author$project$FFI$setConeInnerAngle = F2(function(_0, _1) { return $validate.Unit(setConeInnerAngle(_0, _1), 'FFI.setConeInnerAngle'); });
FFI.setConeInnerAngle = $author$project$FFI$setConeInnerAngle;
var $author$project$FFI$setConeOuterAngle = F2(function(_0, _1) { return $validate.Unit(setConeOuterAngle(_0, _1), 'FFI.setConeOuterAngle'); });
FFI.setConeOuterAngle = $author$project$FFI$setConeOuterAngle;
var $author$project$FFI$setConeOuterGain = F2(function(_0, _1) { return $validate.Unit(setConeOuterGain(_0, _1), 'FFI.setConeOuterGain'); });
FFI.setConeOuterGain = $author$project$FFI$setConeOuterGain;
var $author$project$FFI$getAudioListener = function(_0) { return $validate.Opaque('AudioListener')(getAudioListener(_0), 'FFI.getAudioListener'); };
FFI.getAudioListener = $author$project$FFI$getAudioListener;
var $author$project$FFI$setListenerPosition = F4(function(_0, _1, _2, _3) { return $validate.Unit(setListenerPosition(_0, _1, _2, _3), 'FFI.setListenerPosition'); });
FFI.setListenerPosition = $author$project$FFI$setListenerPosition;
var $author$project$FFI$setListenerForward = F4(function(_0, _1, _2, _3) { return $validate.Unit(setListenerForward(_0, _1, _2, _3), 'FFI.setListenerForward'); });
FFI.setListenerForward = $author$project$FFI$setListenerForward;
var $author$project$FFI$setListenerUp = F4(function(_0, _1, _2, _3) { return $validate.Unit(setListenerUp(_0, _1, _2, _3), 'FFI.setListenerUp'); });
FFI.setListenerUp = $author$project$FFI$setListenerUp;
var $author$project$FFI$createChannelSplitter = F2(function(_0, _1) { return $validate.Opaque('ChannelSplitterNode')(createChannelSplitter(_0, _1), 'FFI.createChannelSplitter'); });
FFI.createChannelSplitter = $author$project$FFI$createChannelSplitter;
var $author$project$FFI$createChannelMerger = F2(function(_0, _1) { return $validate.Opaque('ChannelMergerNode')(createChannelMerger(_0, _1), 'FFI.createChannelMerger'); });
FFI.createChannelMerger = $author$project$FFI$createChannelMerger;
var $author$project$FFI$createAudioBuffer = F4(function(_0, _1, _2, _3) { return $validate.Opaque('AudioBuffer')(createAudioBuffer(_0, _1, _2, _3), 'FFI.createAudioBuffer'); });
FFI.createAudioBuffer = $author$project$FFI$createAudioBuffer;
var $author$project$FFI$getBufferLength = function(_0) { return $validate.Int(getBufferLength(_0), 'FFI.getBufferLength'); };
FFI.getBufferLength = $author$project$FFI$getBufferLength;
var $author$project$FFI$getBufferDuration = function(_0) { return $validate.Float(getBufferDuration(_0), 'FFI.getBufferDuration'); };
FFI.getBufferDuration = $author$project$FFI$getBufferDuration;
var $author$project$FFI$getBufferSampleRate = function(_0) { return $validate.Float(getBufferSampleRate(_0), 'FFI.getBufferSampleRate'); };
FFI.getBufferSampleRate = $author$project$FFI$getBufferSampleRate;
var $author$project$FFI$getBufferChannels = function(_0) { return $validate.Int(getBufferChannels(_0), 'FFI.getBufferChannels'); };
FFI.getBufferChannels = $author$project$FFI$getBufferChannels;
var $author$project$FFI$getChannelData = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.List($validate.Float))(getChannelData(_0, _1), 'FFI.getChannelData'); });
FFI.getChannelData = $author$project$FFI$getChannelData;
var $author$project$FFI$copyToChannel = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(copyToChannel(_0, _1, _2, _3), 'FFI.copyToChannel'); });
FFI.copyToChannel = $author$project$FFI$copyToChannel;
var $author$project$FFI$copyFromChannel = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.List($validate.Float))(copyFromChannel(_0, _1, _2, _3), 'FFI.copyFromChannel'); });
FFI.copyFromChannel = $author$project$FFI$copyFromChannel;
var $author$project$FFI$createSilentBuffer = F4(function(_0, _1, _2, _3) { return $validate.Opaque('AudioBuffer')(createSilentBuffer(_0, _1, _2, _3), 'FFI.createSilentBuffer'); });
FFI.createSilentBuffer = $author$project$FFI$createSilentBuffer;
var $author$project$FFI$cloneAudioBuffer = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(cloneAudioBuffer(_0), 'FFI.cloneAudioBuffer'); };
FFI.cloneAudioBuffer = $author$project$FFI$cloneAudioBuffer;
var $author$project$FFI$createMediaElementSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('MediaElementAudioSourceNode'))(createMediaElementSource(_0, _1), 'FFI.createMediaElementSource'); });
FFI.createMediaElementSource = $author$project$FFI$createMediaElementSource;
var $author$project$FFI$createPeriodicWave = function(_0) { return $validate.Opaque('PeriodicWave')(createPeriodicWave(_0), 'FFI.createPeriodicWave'); };
FFI.createPeriodicWave = $author$project$FFI$createPeriodicWave;
var $author$project$FFI$createOfflineAudioContext = F3(function(_0, _1, _2) { return $validate.Opaque('OfflineAudioContext')(createOfflineAudioContext(_0, _1, _2), 'FFI.createOfflineAudioContext'); });
FFI.createOfflineAudioContext = $author$project$FFI$createOfflineAudioContext;
var $author$project$FFI$startOfflineRendering = function(_0) { return $validate.Opaque('OfflineAudioContext')(startOfflineRendering(_0), 'FFI.startOfflineRendering'); };
FFI.startOfflineRendering = $author$project$FFI$startOfflineRendering;
var $author$project$FFI$startOfflineRenderingAsync = function(_0) { return $validate.Task($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(startOfflineRenderingAsync(_0), 'FFI.startOfflineRenderingAsync'); };
FFI.startOfflineRenderingAsync = $author$project$FFI$startOfflineRenderingAsync;
var $author$project$FFI$suspendOfflineContext = F2(function(_0, _1) { return $validate.Task($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(suspendOfflineContext(_0, _1), 'FFI.suspendOfflineContext'); });
FFI.suspendOfflineContext = $author$project$FFI$suspendOfflineContext;
var $author$project$FFI$resumeOfflineContext = function(_0) { return $validate.Task($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(resumeOfflineContext(_0), 'FFI.resumeOfflineContext'); };
FFI.resumeOfflineContext = $author$project$FFI$resumeOfflineContext;
var $author$project$FFI$getOfflineContextLength = function(_0) { return $validate.Int(getOfflineContextLength(_0), 'FFI.getOfflineContextLength'); };
FFI.getOfflineContextLength = $author$project$FFI$getOfflineContextLength;
var $author$project$FFI$getOfflineContextSampleRate = function(_0) { return $validate.Float(getOfflineContextSampleRate(_0), 'FFI.getOfflineContextSampleRate'); };
FFI.getOfflineContextSampleRate = $author$project$FFI$getOfflineContextSampleRate;
var $author$project$FFI$getGainParam = function(_0) { return $validate.Opaque('AudioParam')(getGainParam(_0), 'FFI.getGainParam'); };
FFI.getGainParam = $author$project$FFI$getGainParam;
var $author$project$FFI$getFrequencyParam = function(_0) { return $validate.Opaque('AudioParam')(getFrequencyParam(_0), 'FFI.getFrequencyParam'); };
FFI.getFrequencyParam = $author$project$FFI$getFrequencyParam;
var $author$project$FFI$getDetuneParam = function(_0) { return $validate.Opaque('AudioParam')(getDetuneParam(_0), 'FFI.getDetuneParam'); };
FFI.getDetuneParam = $author$project$FFI$getDetuneParam;
var $author$project$FFI$setParamValueAtTime = F3(function(_0, _1, _2) { return $validate.Unit(setParamValueAtTime(_0, _1, _2), 'FFI.setParamValueAtTime'); });
FFI.setParamValueAtTime = $author$project$FFI$setParamValueAtTime;
var $author$project$FFI$linearRampToValue = F3(function(_0, _1, _2) { return $validate.Unit(linearRampToValue(_0, _1, _2), 'FFI.linearRampToValue'); });
FFI.linearRampToValue = $author$project$FFI$linearRampToValue;
var $author$project$FFI$exponentialRampToValue = F3(function(_0, _1, _2) { return $validate.Unit(exponentialRampToValue(_0, _1, _2), 'FFI.exponentialRampToValue'); });
FFI.exponentialRampToValue = $author$project$FFI$exponentialRampToValue;
var $author$project$FFI$setTargetAtTime = F4(function(_0, _1, _2, _3) { return $validate.Unit(setTargetAtTime(_0, _1, _2, _3), 'FFI.setTargetAtTime'); });
FFI.setTargetAtTime = $author$project$FFI$setTargetAtTime;
var $author$project$FFI$cancelScheduledValues = F2(function(_0, _1) { return $validate.Unit(cancelScheduledValues(_0, _1), 'FFI.cancelScheduledValues'); });
FFI.cancelScheduledValues = $author$project$FFI$cancelScheduledValues;
var $author$project$FFI$cancelAndHoldAtTime = F2(function(_0, _1) { return $validate.Unit(cancelAndHoldAtTime(_0, _1), 'FFI.cancelAndHoldAtTime'); });
FFI.cancelAndHoldAtTime = $author$project$FFI$cancelAndHoldAtTime;
var $author$project$FFI$setValueAtTime = F3(function(_0, _1, _2) { return $validate.Unit(setValueAtTime(_0, _1, _2), 'FFI.setValueAtTime'); });
FFI.setValueAtTime = $author$project$FFI$setValueAtTime;
var $author$project$FFI$linearRampToValueAtTime = F3(function(_0, _1, _2) { return $validate.Unit(linearRampToValueAtTime(_0, _1, _2), 'FFI.linearRampToValueAtTime'); });
FFI.linearRampToValueAtTime = $author$project$FFI$linearRampToValueAtTime;
var $author$project$FFI$exponentialRampToValueAtTime = F3(function(_0, _1, _2) { return $validate.Unit(exponentialRampToValueAtTime(_0, _1, _2), 'FFI.exponentialRampToValueAtTime'); });
FFI.exponentialRampToValueAtTime = $author$project$FFI$exponentialRampToValueAtTime;
var $author$project$FFI$getByteTimeDomainData = function(_0) { return $validate.List($validate.Int)(getByteTimeDomainData(_0), 'FFI.getByteTimeDomainData'); };
FFI.getByteTimeDomainData = $author$project$FFI$getByteTimeDomainData;
var $author$project$FFI$getByteFrequencyData = function(_0) { return $validate.List($validate.Int)(getByteFrequencyData(_0), 'FFI.getByteFrequencyData'); };
FFI.getByteFrequencyData = $author$project$FFI$getByteFrequencyData;
var $author$project$FFI$getFloatTimeDomainData = function(_0) { return $validate.List($validate.Float)(getFloatTimeDomainData(_0), 'FFI.getFloatTimeDomainData'); };
FFI.getFloatTimeDomainData = $author$project$FFI$getFloatTimeDomainData;
var $author$project$FFI$getFloatFrequencyData = function(_0) { return $validate.List($validate.Float)(getFloatFrequencyData(_0), 'FFI.getFloatFrequencyData'); };
FFI.getFloatFrequencyData = $author$project$FFI$getFloatFrequencyData;
var $author$project$FFI$setBufferSourceBuffer = F2(function(_0, _1) { return $validate.Unit(setBufferSourceBuffer(_0, _1), 'FFI.setBufferSourceBuffer'); });
FFI.setBufferSourceBuffer = $author$project$FFI$setBufferSourceBuffer;
var $author$project$FFI$setBufferSourceLoop = F2(function(_0, _1) { return $validate.Unit(setBufferSourceLoop(_0, _1), 'FFI.setBufferSourceLoop'); });
FFI.setBufferSourceLoop = $author$project$FFI$setBufferSourceLoop;
var $author$project$FFI$setBufferSourceLoopStart = F2(function(_0, _1) { return $validate.Unit(setBufferSourceLoopStart(_0, _1), 'FFI.setBufferSourceLoopStart'); });
FFI.setBufferSourceLoopStart = $author$project$FFI$setBufferSourceLoopStart;
var $author$project$FFI$setBufferSourceLoopEnd = F2(function(_0, _1) { return $validate.Unit(setBufferSourceLoopEnd(_0, _1), 'FFI.setBufferSourceLoopEnd'); });
FFI.setBufferSourceLoopEnd = $author$project$FFI$setBufferSourceLoopEnd;
var $author$project$FFI$setBufferSourcePlaybackRate = F3(function(_0, _1, _2) { return $validate.Unit(setBufferSourcePlaybackRate(_0, _1, _2), 'FFI.setBufferSourcePlaybackRate'); });
FFI.setBufferSourcePlaybackRate = $author$project$FFI$setBufferSourcePlaybackRate;
var $author$project$FFI$setBufferSourceDetune = F3(function(_0, _1, _2) { return $validate.Unit(setBufferSourceDetune(_0, _1, _2), 'FFI.setBufferSourceDetune'); });
FFI.setBufferSourceDetune = $author$project$FFI$setBufferSourceDetune;
var $author$project$FFI$createAudioContextSimplified = function(_0) { return $validate.String(createAudioContextSimplified(_0), 'FFI.createAudioContextSimplified'); };
FFI.createAudioContextSimplified = $author$project$FFI$createAudioContextSimplified;
var $author$project$FFI$playToneSimplified = F2(function(_0, _1) { return $validate.String(playToneSimplified(_0, _1), 'FFI.playToneSimplified'); });
FFI.playToneSimplified = $author$project$FFI$playToneSimplified;
var $author$project$FFI$stopAudioSimplified = function(_0) { return $validate.String(stopAudioSimplified(_0), 'FFI.stopAudioSimplified'); };
FFI.stopAudioSimplified = $author$project$FFI$stopAudioSimplified;
var $author$project$FFI$updateFrequency = function(_0) { return $validate.String(updateFrequency(_0), 'FFI.updateFrequency'); };
FFI.updateFrequency = $author$project$FFI$updateFrequency;
var $author$project$FFI$updateVolume = function(_0) { return $validate.String(updateVolume(_0), 'FFI.updateVolume'); };
FFI.updateVolume = $author$project$FFI$updateVolume;
var $author$project$FFI$updateWaveform = function(_0) { return $validate.String(updateWaveform(_0), 'FFI.updateWaveform'); };
FFI.updateWaveform = $author$project$FFI$updateWaveform;
var $author$project$FFI$addAudioWorkletModule = F2(function(_0, _1) { return $validate.Task($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(addAudioWorkletModule(_0, _1), 'FFI.addAudioWorkletModule'); });
FFI.addAudioWorkletModule = $author$project$FFI$addAudioWorkletModule;
var $author$project$FFI$createAudioWorkletNode = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioWorkletNode'))(createAudioWorkletNode(_0, _1), 'FFI.createAudioWorkletNode'); });
FFI.createAudioWorkletNode = $author$project$FFI$createAudioWorkletNode;
var $author$project$FFI$getWorkletPort = function(_0) { return $validate.Opaque('MessagePort')(getWorkletPort(_0), 'FFI.getWorkletPort'); };
FFI.getWorkletPort = $author$project$FFI$getWorkletPort;
var $author$project$FFI$getWorkletParameters = function(_0) { return $validate.Opaque('AudioParamMap')(getWorkletParameters(_0), 'FFI.getWorkletParameters'); };
FFI.getWorkletParameters = $author$project$FFI$getWorkletParameters;
var $author$project$FFI$postMessageToWorklet = F2(function(_0, _1) { return $validate.Unit(postMessageToWorklet(_0, _1), 'FFI.postMessageToWorklet'); });
FFI.postMessageToWorklet = $author$project$FFI$postMessageToWorklet;
var $author$project$FFI$createIIRFilter = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('IIRFilterNode'))(createIIRFilter(_0, _1, _2), 'FFI.createIIRFilter'); });
FFI.createIIRFilter = $author$project$FFI$createIIRFilter;
var $author$project$FFI$getIIRFilterResponse = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Tuple($validate.List($validate.Float), $validate.List($validate.Float)))(getIIRFilterResponse(_0, _1), 'FFI.getIIRFilterResponse'); });
FFI.getIIRFilterResponse = $author$project$FFI$getIIRFilterResponse;
var $author$project$FFI$createConstantSource = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('ConstantSourceNode'))(createConstantSource(_0), 'FFI.createConstantSource'); };
FFI.createConstantSource = $author$project$FFI$createConstantSource;
var $author$project$FFI$getConstantSourceOffset = function(_0) { return $validate.Opaque('AudioParam')(getConstantSourceOffset(_0), 'FFI.getConstantSourceOffset'); };
FFI.getConstantSourceOffset = $author$project$FFI$getConstantSourceOffset;
var $author$project$FFI$startConstantSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(startConstantSource(_0, _1), 'FFI.startConstantSource'); });
FFI.startConstantSource = $author$project$FFI$startConstantSource;
var $author$project$FFI$stopConstantSource = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(stopConstantSource(_0, _1), 'FFI.stopConstantSource'); });
FFI.stopConstantSource = $author$project$FFI$stopConstantSource;
var $author$project$FFI$createPeriodicWaveWithCoefficients = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('PeriodicWave'))(createPeriodicWaveWithCoefficients(_0, _1, _2), 'FFI.createPeriodicWaveWithCoefficients'); });
FFI.createPeriodicWaveWithCoefficients = $author$project$FFI$createPeriodicWaveWithCoefficients;
var $author$project$FFI$createPeriodicWaveWithOptions = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('PeriodicWave'))(createPeriodicWaveWithOptions(_0, _1, _2, _3), 'FFI.createPeriodicWaveWithOptions'); });
FFI.createPeriodicWaveWithOptions = $author$project$FFI$createPeriodicWaveWithOptions;
var $author$project$FFI$setOscillatorPeriodicWave = F2(function(_0, _1) { return $validate.Unit(setOscillatorPeriodicWave(_0, _1), 'FFI.setOscillatorPeriodicWave'); });
FFI.setOscillatorPeriodicWave = $author$project$FFI$setOscillatorPeriodicWave;
var $author$project$FFI$getNodeChannelCount = function(_0) { return $validate.Int(getNodeChannelCount(_0), 'FFI.getNodeChannelCount'); };
FFI.getNodeChannelCount = $author$project$FFI$getNodeChannelCount;
var $author$project$FFI$setNodeChannelCount = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setNodeChannelCount(_0, _1), 'FFI.setNodeChannelCount'); });
FFI.setNodeChannelCount = $author$project$FFI$setNodeChannelCount;
var $author$project$FFI$getNodeChannelCountMode = function(_0) { return $validate.String(getNodeChannelCountMode(_0), 'FFI.getNodeChannelCountMode'); };
FFI.getNodeChannelCountMode = $author$project$FFI$getNodeChannelCountMode;
var $author$project$FFI$setNodeChannelCountMode = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setNodeChannelCountMode(_0, _1), 'FFI.setNodeChannelCountMode'); });
FFI.setNodeChannelCountMode = $author$project$FFI$setNodeChannelCountMode;
var $author$project$FFI$getNodeChannelInterpretation = function(_0) { return $validate.String(getNodeChannelInterpretation(_0), 'FFI.getNodeChannelInterpretation'); };
FFI.getNodeChannelInterpretation = $author$project$FFI$getNodeChannelInterpretation;
var $author$project$FFI$setNodeChannelInterpretation = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setNodeChannelInterpretation(_0, _1), 'FFI.setNodeChannelInterpretation'); });
FFI.setNodeChannelInterpretation = $author$project$FFI$setNodeChannelInterpretation;
var $author$project$FFI$getNodeNumberOfInputs = function(_0) { return $validate.Int(getNodeNumberOfInputs(_0), 'FFI.getNodeNumberOfInputs'); };
FFI.getNodeNumberOfInputs = $author$project$FFI$getNodeNumberOfInputs;
var $author$project$FFI$getNodeNumberOfOutputs = function(_0) { return $validate.Int(getNodeNumberOfOutputs(_0), 'FFI.getNodeNumberOfOutputs'); };
FFI.getNodeNumberOfOutputs = $author$project$FFI$getNodeNumberOfOutputs;
var $author$project$FFI$getNodeContext = function(_0) { return $validate.Opaque('AudioContext')(getNodeContext(_0), 'FFI.getNodeContext'); };
FFI.getNodeContext = $author$project$FFI$getNodeContext;
var $author$project$FFI$getOscillatorType = function(_0) { return $validate.String(getOscillatorType(_0), 'FFI.getOscillatorType'); };
FFI.getOscillatorType = $author$project$FFI$getOscillatorType;
var $author$project$FFI$getOscillatorFrequencyParam = function(_0) { return $validate.Opaque('AudioParam')(getOscillatorFrequencyParam(_0), 'FFI.getOscillatorFrequencyParam'); };
FFI.getOscillatorFrequencyParam = $author$project$FFI$getOscillatorFrequencyParam;
var $author$project$FFI$getOscillatorDetuneParam = function(_0) { return $validate.Opaque('AudioParam')(getOscillatorDetuneParam(_0), 'FFI.getOscillatorDetuneParam'); };
FFI.getOscillatorDetuneParam = $author$project$FFI$getOscillatorDetuneParam;
var $author$project$FFI$getDelayDelayTimeParam = function(_0) { return $validate.Opaque('AudioParam')(getDelayDelayTimeParam(_0), 'FFI.getDelayDelayTimeParam'); };
FFI.getDelayDelayTimeParam = $author$project$FFI$getDelayDelayTimeParam;
var $author$project$FFI$getCompressorThresholdParam = function(_0) { return $validate.Opaque('AudioParam')(getCompressorThresholdParam(_0), 'FFI.getCompressorThresholdParam'); };
FFI.getCompressorThresholdParam = $author$project$FFI$getCompressorThresholdParam;
var $author$project$FFI$getCompressorKneeParam = function(_0) { return $validate.Opaque('AudioParam')(getCompressorKneeParam(_0), 'FFI.getCompressorKneeParam'); };
FFI.getCompressorKneeParam = $author$project$FFI$getCompressorKneeParam;
var $author$project$FFI$getCompressorRatioParam = function(_0) { return $validate.Opaque('AudioParam')(getCompressorRatioParam(_0), 'FFI.getCompressorRatioParam'); };
FFI.getCompressorRatioParam = $author$project$FFI$getCompressorRatioParam;
var $author$project$FFI$setValueCurveAtTime = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setValueCurveAtTime(_0, _1, _2, _3), 'FFI.setValueCurveAtTime'); });
FFI.setValueCurveAtTime = $author$project$FFI$setValueCurveAtTime;
var $author$project$FFI$getAudioParamValue = function(_0) { return $validate.Float(getAudioParamValue(_0), 'FFI.getAudioParamValue'); };
FFI.getAudioParamValue = $author$project$FFI$getAudioParamValue;
var $author$project$FFI$getAudioParamDefaultValue = function(_0) { return $validate.Float(getAudioParamDefaultValue(_0), 'FFI.getAudioParamDefaultValue'); };
FFI.getAudioParamDefaultValue = $author$project$FFI$getAudioParamDefaultValue;
var $author$project$FFI$getAudioParamMinValue = function(_0) { return $validate.Float(getAudioParamMinValue(_0), 'FFI.getAudioParamMinValue'); };
FFI.getAudioParamMinValue = $author$project$FFI$getAudioParamMinValue;
var $author$project$FFI$getAudioParamMaxValue = function(_0) { return $validate.Float(getAudioParamMaxValue(_0), 'FFI.getAudioParamMaxValue'); };
FFI.getAudioParamMaxValue = $author$project$FFI$getAudioParamMaxValue;
var $author$project$FFI$setAudioParamValue = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setAudioParamValue(_0, _1), 'FFI.setAudioParamValue'); });
FFI.setAudioParamValue = $author$project$FFI$setAudioParamValue;
var $author$project$FFI$getAudioParamAutomationRate = function(_0) { return $validate.String(getAudioParamAutomationRate(_0), 'FFI.getAudioParamAutomationRate'); };
FFI.getAudioParamAutomationRate = $author$project$FFI$getAudioParamAutomationRate;
var $author$project$FFI$setAudioParamAutomationRate = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setAudioParamAutomationRate(_0, _1), 'FFI.setAudioParamAutomationRate'); });
FFI.setAudioParamAutomationRate = $author$project$FFI$setAudioParamAutomationRate;
var $author$project$FFI$connectNodesWithChannels = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(connectNodesWithChannels(_0, _1, _2, _3), 'FFI.connectNodesWithChannels'); });
FFI.connectNodesWithChannels = $author$project$FFI$connectNodesWithChannels;
var $author$project$FFI$disconnectNodeFromDestination = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(disconnectNodeFromDestination(_0, _1), 'FFI.disconnectNodeFromDestination'); });
FFI.disconnectNodeFromDestination = $author$project$FFI$disconnectNodeFromDestination;
var $author$project$FFI$disconnectNodeOutput = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(disconnectNodeOutput(_0, _1), 'FFI.disconnectNodeOutput'); });
FFI.disconnectNodeOutput = $author$project$FFI$disconnectNodeOutput;
var $author$project$FFI$disconnectNodeFromNodeChannel = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(disconnectNodeFromNodeChannel(_0, _1, _2, _3), 'FFI.disconnectNodeFromNodeChannel'); });
FFI.disconnectNodeFromNodeChannel = $author$project$FFI$disconnectNodeFromNodeChannel;
var $author$project$FFI$getContextBaseLatency = function(_0) { return $validate.Float(getContextBaseLatency(_0), 'FFI.getContextBaseLatency'); };
FFI.getContextBaseLatency = $author$project$FFI$getContextBaseLatency;
var $author$project$FFI$getContextOutputLatency = function(_0) { return $validate.Float(getContextOutputLatency(_0), 'FFI.getContextOutputLatency'); };
FFI.getContextOutputLatency = $author$project$FFI$getContextOutputLatency;
var $author$project$FFI$getContextDestination = function(_0) { return $validate.Opaque('AudioDestinationNode')(getContextDestination(_0), 'FFI.getContextDestination'); };
FFI.getContextDestination = $author$project$FFI$getContextDestination;
var $author$project$FFI$getContextAudioListener = function(_0) { return $validate.Opaque('AudioListener')(getContextAudioListener(_0), 'FFI.getContextAudioListener'); };
FFI.getContextAudioListener = $author$project$FFI$getContextAudioListener;
var $author$project$FFI$setAnalyserMinDecibels = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setAnalyserMinDecibels(_0, _1), 'FFI.setAnalyserMinDecibels'); });
FFI.setAnalyserMinDecibels = $author$project$FFI$setAnalyserMinDecibels;
var $author$project$FFI$setAnalyserMaxDecibels = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setAnalyserMaxDecibels(_0, _1), 'FFI.setAnalyserMaxDecibels'); });
FFI.setAnalyserMaxDecibels = $author$project$FFI$setAnalyserMaxDecibels;
var $author$project$FFI$getAnalyserMinDecibels = function(_0) { return $validate.Float(getAnalyserMinDecibels(_0), 'FFI.getAnalyserMinDecibels'); };
FFI.getAnalyserMinDecibels = $author$project$FFI$getAnalyserMinDecibels;
var $author$project$FFI$getAnalyserMaxDecibels = function(_0) { return $validate.Float(getAnalyserMaxDecibels(_0), 'FFI.getAnalyserMaxDecibels'); };
FFI.getAnalyserMaxDecibels = $author$project$FFI$getAnalyserMaxDecibels;
var $author$project$FFI$setAnalyserSmoothingTimeConstant = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setAnalyserSmoothingTimeConstant(_0, _1), 'FFI.setAnalyserSmoothingTimeConstant'); });
FFI.setAnalyserSmoothingTimeConstant = $author$project$FFI$setAnalyserSmoothingTimeConstant;
var $author$project$FFI$getAnalyserSmoothingTimeConstant = function(_0) { return $validate.Float(getAnalyserSmoothingTimeConstant(_0), 'FFI.getAnalyserSmoothingTimeConstant'); };
FFI.getAnalyserSmoothingTimeConstant = $author$project$FFI$getAnalyserSmoothingTimeConstant;
var $author$project$FFI$getCompressorReduction = function(_0) { return $validate.Float(getCompressorReduction(_0), 'FFI.getCompressorReduction'); };
FFI.getCompressorReduction = $author$project$FFI$getCompressorReduction;
var $author$project$FFI$getCompressorAttackParam = function(_0) { return $validate.Opaque('AudioParam')(getCompressorAttackParam(_0), 'FFI.getCompressorAttackParam'); };
FFI.getCompressorAttackParam = $author$project$FFI$getCompressorAttackParam;
var $author$project$FFI$getCompressorReleaseParam = function(_0) { return $validate.Opaque('AudioParam')(getCompressorReleaseParam(_0), 'FFI.getCompressorReleaseParam'); };
FFI.getCompressorReleaseParam = $author$project$FFI$getCompressorReleaseParam;
var $author$project$FFI$setCompressorAttackDirect = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setCompressorAttackDirect(_0, _1), 'FFI.setCompressorAttackDirect'); });
FFI.setCompressorAttackDirect = $author$project$FFI$setCompressorAttackDirect;
var $author$project$FFI$setCompressorReleaseDirect = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setCompressorReleaseDirect(_0, _1), 'FFI.setCompressorReleaseDirect'); });
FFI.setCompressorReleaseDirect = $author$project$FFI$setCompressorReleaseDirect;
var $author$project$FFI$getBufferSourceBuffer = function(_0) { return $validate.Opaque('AudioBuffer')(getBufferSourceBuffer(_0), 'FFI.getBufferSourceBuffer'); };
FFI.getBufferSourceBuffer = $author$project$FFI$getBufferSourceBuffer;
var $author$project$FFI$getBufferSourceLoop = function(_0) { return $validate.Bool(getBufferSourceLoop(_0), 'FFI.getBufferSourceLoop'); };
FFI.getBufferSourceLoop = $author$project$FFI$getBufferSourceLoop;
var $author$project$FFI$getBufferSourceLoopStart = function(_0) { return $validate.Float(getBufferSourceLoopStart(_0), 'FFI.getBufferSourceLoopStart'); };
FFI.getBufferSourceLoopStart = $author$project$FFI$getBufferSourceLoopStart;
var $author$project$FFI$getBufferSourceLoopEnd = function(_0) { return $validate.Float(getBufferSourceLoopEnd(_0), 'FFI.getBufferSourceLoopEnd'); };
FFI.getBufferSourceLoopEnd = $author$project$FFI$getBufferSourceLoopEnd;
var $author$project$FFI$setBufferSourceLoopDirect = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setBufferSourceLoopDirect(_0, _1), 'FFI.setBufferSourceLoopDirect'); });
FFI.setBufferSourceLoopDirect = $author$project$FFI$setBufferSourceLoopDirect;
var $author$project$FFI$getPannerPositionX = function(_0) { return $validate.Opaque('AudioParam')(getPannerPositionX(_0), 'FFI.getPannerPositionX'); };
FFI.getPannerPositionX = $author$project$FFI$getPannerPositionX;
var $author$project$FFI$getPannerPositionY = function(_0) { return $validate.Opaque('AudioParam')(getPannerPositionY(_0), 'FFI.getPannerPositionY'); };
FFI.getPannerPositionY = $author$project$FFI$getPannerPositionY;
var $author$project$FFI$getPannerPositionZ = function(_0) { return $validate.Opaque('AudioParam')(getPannerPositionZ(_0), 'FFI.getPannerPositionZ'); };
FFI.getPannerPositionZ = $author$project$FFI$getPannerPositionZ;
var $author$project$FFI$getPannerOrientationX = function(_0) { return $validate.Opaque('AudioParam')(getPannerOrientationX(_0), 'FFI.getPannerOrientationX'); };
FFI.getPannerOrientationX = $author$project$FFI$getPannerOrientationX;
var $author$project$FFI$setPannerOrientationDirect = F4(function(_0, _1, _2, _3) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setPannerOrientationDirect(_0, _1, _2, _3), 'FFI.setPannerOrientationDirect'); });
FFI.setPannerOrientationDirect = $author$project$FFI$setPannerOrientationDirect;
var $author$project$FFI$getBiquadFilterType = function(_0) { return $validate.String(getBiquadFilterType(_0), 'FFI.getBiquadFilterType'); };
FFI.getBiquadFilterType = $author$project$FFI$getBiquadFilterType;
var $author$project$FFI$setBiquadFilterTypeDirect = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setBiquadFilterTypeDirect(_0, _1), 'FFI.setBiquadFilterTypeDirect'); });
FFI.setBiquadFilterTypeDirect = $author$project$FFI$setBiquadFilterTypeDirect;
var $author$project$FFI$getBiquadFilterFrequencyParam = function(_0) { return $validate.Opaque('AudioParam')(getBiquadFilterFrequencyParam(_0), 'FFI.getBiquadFilterFrequencyParam'); };
FFI.getBiquadFilterFrequencyParam = $author$project$FFI$getBiquadFilterFrequencyParam;
var $author$project$FFI$getBiquadFilterQParam = function(_0) { return $validate.Opaque('AudioParam')(getBiquadFilterQParam(_0), 'FFI.getBiquadFilterQParam'); };
FFI.getBiquadFilterQParam = $author$project$FFI$getBiquadFilterQParam;
var $author$project$FFI$reverseAudioBuffer = function(_0) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(reverseAudioBuffer(_0), 'FFI.reverseAudioBuffer'); };
FFI.reverseAudioBuffer = $author$project$FFI$reverseAudioBuffer;
var $author$project$FFI$normalizeAudioBuffer = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(normalizeAudioBuffer(_0, _1), 'FFI.normalizeAudioBuffer'); });
FFI.normalizeAudioBuffer = $author$project$FFI$normalizeAudioBuffer;
var $author$project$FFI$mixAudioBuffers = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(mixAudioBuffers(_0, _1, _2), 'FFI.mixAudioBuffers'); });
FFI.mixAudioBuffers = $author$project$FFI$mixAudioBuffers;
var $author$project$FFI$trimSilence = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(trimSilence(_0, _1), 'FFI.trimSilence'); });
FFI.trimSilence = $author$project$FFI$trimSilence;
var $author$project$FFI$getBufferPeak = function(_0) { return $validate.Float(getBufferPeak(_0), 'FFI.getBufferPeak'); };
FFI.getBufferPeak = $author$project$FFI$getBufferPeak;
var $author$project$FFI$getBufferRMS = function(_0) { return $validate.Float(getBufferRMS(_0), 'FFI.getBufferRMS'); };
FFI.getBufferRMS = $author$project$FFI$getBufferRMS;
var $author$project$FFI$createBufferFromSamples = F3(function(_0, _1, _2) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(createBufferFromSamples(_0, _1, _2), 'FFI.createBufferFromSamples'); });
FFI.createBufferFromSamples = $author$project$FFI$createBufferFromSamples;
var $author$project$FFI$concatenateBuffers = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Opaque('AudioBuffer'))(concatenateBuffers(_0, _1), 'FFI.concatenateBuffers'); });
FFI.concatenateBuffers = $author$project$FFI$concatenateBuffers;
var $author$project$FFI$getStereoPannerPan = function(_0) { return $validate.Opaque('AudioParam')(getStereoPannerPan(_0), 'FFI.getStereoPannerPan'); };
FFI.getStereoPannerPan = $author$project$FFI$getStereoPannerPan;
var $author$project$FFI$getGainNodeGainParam = function(_0) { return $validate.Opaque('AudioParam')(getGainNodeGainParam(_0), 'FFI.getGainNodeGainParam'); };
FFI.getGainNodeGainParam = $author$project$FFI$getGainNodeGainParam;
var $author$project$FFI$getConvolverNormalize = function(_0) { return $validate.Bool(getConvolverNormalize(_0), 'FFI.getConvolverNormalize'); };
FFI.getConvolverNormalize = $author$project$FFI$getConvolverNormalize;
var $author$project$FFI$getWaveShaperOversample = function(_0) { return $validate.String(getWaveShaperOversample(_0), 'FFI.getWaveShaperOversample'); };
FFI.getWaveShaperOversample = $author$project$FFI$getWaveShaperOversample;
var $author$project$FFI$getAnalyserFFTSize = function(_0) { return $validate.Int(getAnalyserFFTSize(_0), 'FFI.getAnalyserFFTSize'); };
FFI.getAnalyserFFTSize = $author$project$FFI$getAnalyserFFTSize;
var $author$project$FFI$getAnalyserFrequencyBinCount = function(_0) { return $validate.Int(getAnalyserFrequencyBinCount(_0), 'FFI.getAnalyserFrequencyBinCount'); };
FFI.getAnalyserFrequencyBinCount = $author$project$FFI$getAnalyserFrequencyBinCount;
var $author$project$FFI$getDelayMaxDelayTime = function(_0) { return $validate.Float(getDelayMaxDelayTime(_0), 'FFI.getDelayMaxDelayTime'); };
FFI.getDelayMaxDelayTime = $author$project$FFI$getDelayMaxDelayTime;
var $author$project$FFI$getBufferSourcePlaybackRate = function(_0) { return $validate.Opaque('AudioParam')(getBufferSourcePlaybackRate(_0), 'FFI.getBufferSourcePlaybackRate'); };
FFI.getBufferSourcePlaybackRate = $author$project$FFI$getBufferSourcePlaybackRate;
var $author$project$FFI$getBufferSourceDetune = function(_0) { return $validate.Opaque('AudioParam')(getBufferSourceDetune(_0), 'FFI.getBufferSourceDetune'); };
FFI.getBufferSourceDetune = $author$project$FFI$getBufferSourceDetune;
var $author$project$FFI$getPannerDistanceModel = function(_0) { return $validate.String(getPannerDistanceModel(_0), 'FFI.getPannerDistanceModel'); };
FFI.getPannerDistanceModel = $author$project$FFI$getPannerDistanceModel;
var $author$project$FFI$getPannerPanningModel = function(_0) { return $validate.String(getPannerPanningModel(_0), 'FFI.getPannerPanningModel'); };
FFI.getPannerPanningModel = $author$project$FFI$getPannerPanningModel;
var $author$project$FFI$getPannerRefDistance = function(_0) { return $validate.Float(getPannerRefDistance(_0), 'FFI.getPannerRefDistance'); };
FFI.getPannerRefDistance = $author$project$FFI$getPannerRefDistance;
var $author$project$FFI$getPannerMaxDistance = function(_0) { return $validate.Float(getPannerMaxDistance(_0), 'FFI.getPannerMaxDistance'); };
FFI.getPannerMaxDistance = $author$project$FFI$getPannerMaxDistance;
var $author$project$FFI$getPannerRolloffFactor = function(_0) { return $validate.Float(getPannerRolloffFactor(_0), 'FFI.getPannerRolloffFactor'); };
FFI.getPannerRolloffFactor = $author$project$FFI$getPannerRolloffFactor;
var $author$project$FFI$getPannerConeInnerAngle = function(_0) { return $validate.Float(getPannerConeInnerAngle(_0), 'FFI.getPannerConeInnerAngle'); };
FFI.getPannerConeInnerAngle = $author$project$FFI$getPannerConeInnerAngle;
var $author$project$FFI$getPannerConeOuterAngle = function(_0) { return $validate.Float(getPannerConeOuterAngle(_0), 'FFI.getPannerConeOuterAngle'); };
FFI.getPannerConeOuterAngle = $author$project$FFI$getPannerConeOuterAngle;
var $author$project$FFI$getPannerConeOuterGain = function(_0) { return $validate.Float(getPannerConeOuterGain(_0), 'FFI.getPannerConeOuterGain'); };
FFI.getPannerConeOuterGain = $author$project$FFI$getPannerConeOuterGain;
var $author$project$FFI$getMediaElementSourceElement = function(_0) { return $validate.Opaque('HTMLMediaElement')(getMediaElementSourceElement(_0), 'FFI.getMediaElementSourceElement'); };
FFI.getMediaElementSourceElement = $author$project$FFI$getMediaElementSourceElement;
var $author$project$FFI$getMediaStreamTracks = function(_0) { return $validate.List($validate.Opaque('MediaStreamTrack'))(getMediaStreamTracks(_0), 'FFI.getMediaStreamTracks'); };
FFI.getMediaStreamTracks = $author$project$FFI$getMediaStreamTracks;
var $author$project$FFI$getMediaStreamActive = function(_0) { return $validate.Bool(getMediaStreamActive(_0), 'FFI.getMediaStreamActive'); };
FFI.getMediaStreamActive = $author$project$FFI$getMediaStreamActive;
var $author$project$FFI$getMediaStreamId = function(_0) { return $validate.String(getMediaStreamId(_0), 'FFI.getMediaStreamId'); };
FFI.getMediaStreamId = $author$project$FFI$getMediaStreamId;
var $author$project$FFI$getBiquadFilterGainParam = function(_0) { return $validate.Opaque('AudioParam')(getBiquadFilterGainParam(_0), 'FFI.getBiquadFilterGainParam'); };
FFI.getBiquadFilterGainParam = $author$project$FFI$getBiquadFilterGainParam;
var $author$project$FFI$getBiquadFilterDetuneParam = function(_0) { return $validate.Opaque('AudioParam')(getBiquadFilterDetuneParam(_0), 'FFI.getBiquadFilterDetuneParam'); };
FFI.getBiquadFilterDetuneParam = $author$project$FFI$getBiquadFilterDetuneParam;
var $author$project$FFI$getPannerOrientationY = function(_0) { return $validate.Opaque('AudioParam')(getPannerOrientationY(_0), 'FFI.getPannerOrientationY'); };
FFI.getPannerOrientationY = $author$project$FFI$getPannerOrientationY;
var $author$project$FFI$getPannerOrientationZ = function(_0) { return $validate.Opaque('AudioParam')(getPannerOrientationZ(_0), 'FFI.getPannerOrientationZ'); };
FFI.getPannerOrientationZ = $author$project$FFI$getPannerOrientationZ;
var $author$project$FFI$getConstantSourceOffsetValue = function(_0) { return $validate.Float(getConstantSourceOffsetValue(_0), 'FFI.getConstantSourceOffsetValue'); };
FFI.getConstantSourceOffsetValue = $author$project$FFI$getConstantSourceOffsetValue;
var $author$project$FFI$createEmptyBuffer = F4(function(_0, _1, _2, _3) { return $validate.Opaque('AudioBuffer')(createEmptyBuffer(_0, _1, _2, _3), 'FFI.createEmptyBuffer'); });
FFI.createEmptyBuffer = $author$project$FFI$createEmptyBuffer;
var $author$project$FFI$getBufferAsArray = F2(function(_0, _1) { return $validate.List($validate.Float)(getBufferAsArray(_0, _1), 'FFI.getBufferAsArray'); });
FFI.getBufferAsArray = $author$project$FFI$getBufferAsArray;
var $author$project$FFI$setOscillatorType = F2(function(_0, _1) { return $validate.Result($validate.Opaque('Capability.CapabilityError'), $validate.Unit)(setOscillatorType(_0, _1), 'FFI.setOscillatorType'); });
FFI.setOscillatorType = $author$project$FFI$setOscillatorType;
var $author$project$FFI$getIIRFilterResponseAtFrequency = F2(function(_0, _1) { return $validate.Tuple($validate.Float, $validate.Float)(getIIRFilterResponseAtFrequency(_0, _1), 'FFI.getIIRFilterResponseAtFrequency'); });
FFI.getIIRFilterResponseAtFrequency = $author$project$FFI$getIIRFilterResponseAtFrequency;


// Bindings for external/capability.js
var CapabilityFFI = CapabilityFFI || {};
var $author$project$CapabilityFFI$isUserActivationAvailable = function() { return $validate.Bool(isUserActivationAvailable(), 'CapabilityFFI.isUserActivationAvailable'); };
CapabilityFFI.isUserActivationAvailable = $author$project$CapabilityFFI$isUserActivationAvailable;
var $author$project$CapabilityFFI$isUserActivationActive = function() { return $validate.Bool(isUserActivationActive(), 'CapabilityFFI.isUserActivationActive'); };
CapabilityFFI.isUserActivationActive = $author$project$CapabilityFFI$isUserActivationActive;
var $author$project$CapabilityFFI$consumeUserActivation = function() { return $validate.Opaque('Capability.UserActivated')(consumeUserActivation(), 'CapabilityFFI.consumeUserActivation'); };
CapabilityFFI.consumeUserActivation = $author$project$CapabilityFFI$consumeUserActivation;
var $author$project$CapabilityFFI$consumeUserActivationInt = function() { return $validate.Int(consumeUserActivationInt(), 'CapabilityFFI.consumeUserActivationInt'); };
CapabilityFFI.consumeUserActivationInt = $author$project$CapabilityFFI$consumeUserActivationInt;
var $author$project$CapabilityFFI$consumeUserActivationString = function() { return $validate.String(consumeUserActivationString(), 'CapabilityFFI.consumeUserActivationString'); };
CapabilityFFI.consumeUserActivationString = $author$project$CapabilityFFI$consumeUserActivationString;
var $author$project$CapabilityFFI$detectAPISupport = function(_0) { return $validate.Any(detectAPISupport(_0), 'CapabilityFFI.detectAPISupport'); };
CapabilityFFI.detectAPISupport = $author$project$CapabilityFFI$detectAPISupport;
var $author$project$CapabilityFFI$hasFeature = function(_0) { return $validate.Bool(hasFeature(_0), 'CapabilityFFI.hasFeature'); };
CapabilityFFI.hasFeature = $author$project$CapabilityFFI$hasFeature;
var $author$project$CapabilityFFI$checkGenericPermission = function(_0) { return $validate.Any(checkGenericPermission(_0), 'CapabilityFFI.checkGenericPermission'); };
CapabilityFFI.checkGenericPermission = $author$project$CapabilityFFI$checkGenericPermission;
var $author$project$CapabilityFFI$requestGenericPermission = function(_0) { return $validate.Any(requestGenericPermission(_0), 'CapabilityFFI.requestGenericPermission'); };
CapabilityFFI.requestGenericPermission = $author$project$CapabilityFFI$requestGenericPermission;
var $author$project$CapabilityFFI$createGenericInitializer = F3(function(_0, _1, _2) { return $validate.Any(createGenericInitializer(_0, _1, _2), 'CapabilityFFI.createGenericInitializer'); });
CapabilityFFI.createGenericInitializer = $author$project$CapabilityFFI$createGenericInitializer;
var $author$project$CapabilityFFI$createInitializationChecker = F2(function(_0, _1) { return $validate.Any(createInitializationChecker(_0, _1), 'CapabilityFFI.createInitializationChecker'); });
CapabilityFFI.createInitializationChecker = $author$project$CapabilityFFI$createInitializationChecker;
var $author$project$CapabilityFFI$validateCapability = F2(function(_0, _1) { return $validate.Task($validate.Opaque('CapabilityError'), $validate.Opaque('a'))(validateCapability(_0, _1), 'CapabilityFFI.validateCapability'); });
CapabilityFFI.validateCapability = $author$project$CapabilityFFI$validateCapability;
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_AudioContext(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_AudioContext(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
}

function _validate_Opaque_CapabilityCapabilityError(v, ctx) {
  return v; // Opaque type: Capability.CapabilityError
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Int(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
...
function _validate_Task_Opaque_CapabilityCapabilityError_Opaque_AudioBuffer(v, ctx) {
  ...
  return v.then(
    function(ok) { return { $: 'Ok', a: _validate_Opaque_AudioBuffer(ok, ctx + '.then') }; },
    function(err) { return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(err, ctx + '.catch') }; }
  );
}
...
function _validate_Opaque_AudioBuffer(v, ctx) {
  return v; // Opaque type: AudioBuffer
}

function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_OscillatorNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_OscillatorNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_OscillatorNode(v, ctx) {
  return v; // Opaque type: OscillatorNode
}
...
function _validate_Opaque_AudioBufferSourceNode(v, ctx) {
  return v; // Opaque type: AudioBufferSourceNode
}

function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_MediaStreamAudioSourceNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_MediaStreamAudioSourceNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_MediaStreamAudioSourceNode(v, ctx) {
  return v; // Opaque type: MediaStreamAudioSourceNode
}

function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_MediaStreamAudioDestinationNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_MediaStreamAudioDestinationNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_MediaStreamAudioDestinationNode(v, ctx) {
  return v; // Opaque type: MediaStreamAudioDestinationNode
}

function _validate_Opaque_MediaStream(v, ctx) {
  return v; // Opaque type: MediaStream
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_GainNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_GainNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_GainNode(v, ctx) {
  return v; // Opaque type: GainNode
}
...
function _validate_Opaque_BiquadFilterNode(v, ctx) {
  return v; // Opaque type: BiquadFilterNode
}
...
function _validate_Opaque_DelayNode(v, ctx) {
  return v; // Opaque type: DelayNode
}
...
function _validate_Opaque_ConvolverNode(v, ctx) {
  return v; // Opaque type: ConvolverNode
}

function _validate_Result_Opaque_CapabilityCapabilityError_Unit(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Unit(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Maybe_Opaque_AudioBuffer(v, ctx) {
  if (v == null) { return { $: 'Nothing' }; }
  return { $: 'Just', a: _validate_Opaque_AudioBuffer(v, ctx) };
}
...
function _validate_Opaque_DynamicsCompressorNode(v, ctx) {
  return v; // Opaque type: DynamicsCompressorNode
}
...
function _validate_Opaque_WaveShaperNode(v, ctx) {
  return v; // Opaque type: WaveShaperNode
}
...
function _validate_Maybe_List_Float(v, ctx) {
  if (v == null) { return { $: 'Nothing' }; }
  return { $: 'Just', a: _validate_List_Float(v, ctx) };
}

function _validate_List_Float(v, ctx) {
  if (!Array.isArray(v)) {
    throw new Error('FFI type error at ' + ctx + ': expected List, got ' + typeof v);
  }
  return v.map(function(el, i) { return _validate_Float(el, ctx + '[' + i + ']'); });
}
...
function _validate_Opaque_StereoPannerNode(v, ctx) {
  return v; // Opaque type: StereoPannerNode
}
...
function _validate_Opaque_AnalyserNode(v, ctx) {
  return v; // Opaque type: AnalyserNode
}
...
function _validate_Opaque_PannerNode(v, ctx) {
  return v; // Opaque type: PannerNode
}
...
function _validate_Opaque_AudioListener(v, ctx) {
  return v; // Opaque type: AudioListener
}
...
function _validate_Opaque_ChannelSplitterNode(v, ctx) {
  return v; // Opaque type: ChannelSplitterNode
}

function _validate_Opaque_ChannelMergerNode(v, ctx) {
  return v; // Opaque type: ChannelMergerNode
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_List_Float(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_List_Float(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_AudioBuffer(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_AudioBuffer(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_MediaElementAudioSourceNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_MediaElementAudioSourceNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_MediaElementAudioSourceNode(v, ctx) {
  return v; // Opaque type: MediaElementAudioSourceNode
}

function _validate_Opaque_PeriodicWave(v, ctx) {
  return v; // Opaque type: PeriodicWave
}

function _validate_Opaque_OfflineAudioContext(v, ctx) {
  return v; // Opaque type: OfflineAudioContext
}
...
function _validate_Task_Opaque_CapabilityCapabilityError_Unit(v, ctx) {
  if (typeof v !== 'object' || v === null || typeof v.then !== 'function') {
    throw new Error('FFI type error at ' + ctx + ': expected Task (expected Promise), got ' + typeof v);
  }
  return v.then(
    function(ok) { return { $: 'Ok', a: _validate_Unit(ok, ctx + '.then') }; },
    function(err) { return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(err, ctx + '.catch') }; }
  );
}
...
function _validate_Opaque_AudioParam(v, ctx) {
  return v; // Opaque type: AudioParam
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_AudioWorkletNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_AudioWorkletNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_AudioWorkletNode(v, ctx) {
  return v; // Opaque type: AudioWorkletNode
}

function _validate_Opaque_MessagePort(v, ctx) {
  return v; // Opaque type: MessagePort
}

function _validate_Opaque_AudioParamMap(v, ctx) {
  return v; // Opaque type: AudioParamMap
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_IIRFilterNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_IIRFilterNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_IIRFilterNode(v, ctx) {
  return v; // Opaque type: IIRFilterNode
}

function _validate_Result_Opaque_CapabilityCapabilityError_Tuple_List_Float_List_Float(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Tuple_List_Float_List_Float(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Tuple_List_Float_List_Float(v, ctx) {
  if (!Array.isArray(v) || v.length !== 2) {
    throw new Error('FFI type error at ' + ctx + ': expected Tuple2, got ' + typeof v);
  }
  return [_validate_List_Float(v[0], ctx + '[0]'), _validate_List_Float(v[1], ctx + '[1]')];
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_ConstantSourceNode(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_ConstantSourceNode(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_ConstantSourceNode(v, ctx) {
  return v; // Opaque type: ConstantSourceNode
}
...
function _validate_Result_Opaque_CapabilityCapabilityError_Opaque_PeriodicWave(v, ctx) {
  if (typeof v !== 'object' || v === null || !('$' in v)) {
    throw new Error('FFI type error at ' + ctx + ': expected Result, got ' + typeof v);
  }
  if (v.$ === 'Ok') {
    return { $: 'Ok', a: _validate_Opaque_PeriodicWave(v.a, ctx + '.Ok') };
  } else if (v.$ === 'Err') {
    return { $: 'Err', a: _validate_Opaque_CapabilityCapabilityError(v.a, ctx + '.Err') };
  }
  throw new Error('FFI type error at ' + ctx + ': expected Result (invalid $), got ' + typeof v);
...
function _validate_Opaque_AudioDestinationNode(v, ctx) {
  return v; // Opaque type: AudioDestinationNode
}
...
function _validate_Opaque_HTMLMediaElement(v, ctx) {
  return v; // Opaque type: HTMLMediaElement
}

function _validate_List_Opaque_MediaStreamTrack(v, ctx) {
  if (!Array.isArray(v)) {
    throw new Error('FFI type error at ' + ctx + ': expected List, got ' + typeof v);
  }
  return v.map(function(el, i) { return _validate_Opaque_MediaStreamTrack(el, ctx + '[' + i + ']'); });
}

function _validate_Opaque_MediaStreamTrack(v, ctx) {
  return v; // Opaque type: MediaStreamTrack
}
...
function _validate_Tuple_Float_Float(v, ctx) {
  if (!Array.isArray(v) || v.length !== 2) {
    throw new Error('FFI type error at ' + ctx + ': expected Tuple2, got ' + typeof v);
  }
  return [_validate_Float(v[0], ctx + '[0]'), _validate_Float(v[1], ctx + '[1]')];
}
...
function _validate_Opaque_CapabilityUserActivated(v, ctx) {
  return v; // Opaque type: Capability.UserActivated
}
...
function _validate_Task_Opaque_CapabilityError_Opaque_a(v, ctx) {
  if (typeof v !== 'object' || v === null || typeof v.then !== 'function') {
    throw new Error('FFI type error at ' + ctx + ': expected Task (expected Promise), got ' + typeof v);
  }
  return v.then(
    function(ok) { return { $: 'Ok', a: _validate_Opaque_a(ok, ctx + '.then') }; },
    function(err) { return { $: 'Err', a: _validate_Opaque_CapabilityError(err, ctx + '.catch') }; }
  );
}

function _validate_Opaque_CapabilityError(v, ctx) {
  return v; // Opaque type: CapabilityError
}

function _validate_Opaque_a(v, ctx) {
  return v; // Opaque type: a
}
...
var $elm$browser$Browser$External = function(a){ return ({a : a,$ :'External'});};
var $elm$browser$Browser$Internal = function(a){ return ({a : a,$ :'Internal'});};
var $elm$core$Basics$identity = function(x){ return ( x);};
var $elm$browser$Browser$Dom$NotFound = function(a){ return ({a : a,$ :'NotFound'});};
var $elm$url$Url$Http ={$ :'Http'};
var $elm$url$Url$Https ={$ :'Https'};
var $elm$url$Url$Url = F6( function(protocol,host,port_,path,query,fragment){ return ({query : query,protocol : protocol,port_ : port_,path : path,host : host,fragment : fragment});});
...
var $user$project$Main$SimplifiedInterface ={$ :'SimplifiedInterface'};
var $user$project$Main$initialModel ={waveform :'sine',volume :30.0,status :'Ready - Click \'Initialize Audio\' to begin',showAdvanced :false,operationLog : _List_Nil,lastError : $elm$core$Maybe$Nothing,isPlaying :false,frequency :440.0,demoMode : $user$project$Main$SimplifiedInterface,currentOscillator : $elm$core$Maybe$Nothing,currentGainNode : $elm$core$Maybe$Nothing,audioContext : $elm$core$Maybe$Nothing};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch( _List_Nil);
var $user$project$Main$init = function(_v0){ return ( _Utils_Tuple2( $user$project$Main$initialModel, $elm$core$Platform$Cmd$none));};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch( _List_Nil);
var $user$project$Main$subscriptions = function(_v0){ return ( $elm$core$Platform$Sub$none);};
var $user$project$Capability$Click ={$ :'Click'};
var $user$project$Main$capabilityErrorString = function(error){ switch( error.$){ case 'UserActivationRequired' :var msg = error.a; return ('User activation required: ' + msg); case 'PermissionRequired' :var msg = error.a; return ('Permission required: ' + msg); case 'InitializationRequired' :var msg = error.a; return ('Initialization required: ' + msg); case 'FeatureNotAvailable' :var msg = error.a; return ('Feature not available: ' + msg); default :var msg = error.a; return ('Capability revoked: ' + msg);}};
var $user$project$AudioFFI$connectNodes = FFI.connectNodes;
var $user$project$AudioFFI$connectToDestination = FFI.connectToDestination;
var $user$project$AudioFFI$createAudioContext = FFI.createAudioContext;
var $user$project$AudioFFI$createAudioContextSimplified = FFI.createAudioContextSimplified;
var $user$project$AudioFFI$createGainNode = FFI.createGainNode;
var $user$project$AudioFFI$createOscillator = FFI.createOscillator;
var $user$project$Main$demoModeString = function(mode){ switch( mode.$){ case 'SimplifiedInterface' : return 'Simplified Interface'; case 'TypeSafeInterface' : return 'Type-Safe Interface'; default : return 'Comparison Mode';}};
var $elm$core$String$fromFloat = _String_fromNumber;
var $user$project$AudioFFI$getCurrentTime = FFI.getCurrentTime;
var $elm$core$Basics$not = _Basics_not;
var $user$project$AudioFFI$playToneSimplified = FFI.playToneSimplified;
var $user$project$AudioFFI$startOscillator = FFI.startOscillator;
var $user$project$AudioFFI$stopAudioSimplified = FFI.stopAudioSimplified;
var $user$project$AudioFFI$stopOscillator = FFI.stopOscillator;
var $elm$core$String$toFloat = _String_toFloat;
var $user$project$AudioFFI$updateFrequency = FFI.updateFrequency;
var $user$project$AudioFFI$updateVolume = FFI.updateVolume;
var $user$project$AudioFFI$updateWaveform = FFI.updateWaveform;
var $user$project$Main$update = F2( function(msg,model){ switch( msg.$){ case 'SetDemoMode' :var mode = msg.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'Demo mode changed to ' + $user$project$Main$demoModeString( mode),demoMode : mode}), $elm$core$Platform$Cmd$none)); case 'ToggleAdvancedMode' : return ( _Utils_Tuple2( _Utils_update( model,{showAdvanced :! model.showAdvanced}), $elm$core$Platform$Cmd$none)); case 'ClearLog' : return ( _Utils_Tuple2( _Utils_update( model,{operationLog : _List_Nil,lastError : $elm$core$Maybe$Nothing}), $elm$core$Platform$Cmd$none)); case 'InitializeAudioSimple' :var result = $user$project$AudioFFI$createAudioContextSimplified( _Utils_Tuple0); return ( _Utils_Tuple2( _Utils_update( model,{status : result,operationLog : A2( $elm$core$List$cons, result, model.operationLog)}), $elm$core$Platform$Cmd$none)); case 'PlayAudioSimple' :var result = A2( $user$project$AudioFFI$playToneSimplified, model.frequency, model.waveform); return ( _Utils_Tuple2( _Utils_update( model,{status : result,operationLog : A2( $elm$core$List$cons, result, model.operationLog),isPlaying :true}), $elm$core$Platform$Cmd$none)); case 'StopAudioSimple' :var result = $user$project$AudioFFI$stopAudioSimplified( _Utils_Tuple0); return ( _Utils_Tuple2( _Utils_update( model,{status : result,operationLog : A2( $elm$core$List$cons, result, model.operationLog),isPlaying :false}), $elm$core$Platform$Cmd$none)); case 'SetFrequency' :var freqString = msg.a;var _v1 = $elm$core$String$toFloat( freqString);if ( _v1.$ ==='Just' ){var freq = _v1.a;var updateResult = model.isPlaying? $user$project$AudioFFI$updateFrequency( freq):'Frequency set to ' +( $elm$core$String$fromFloat( freq) +' Hz'); return ( _Utils_Tuple2( _Utils_update( model,{status : updateResult,operationLog : A2( $elm$core$List$cons, updateResult, model.operationLog),frequency : freq}), $elm$core$Platform$Cmd$none));} else return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none)); case 'SetVolume' :var volString = msg.a;var _v2 = $elm$core$String$toFloat( volString);if ( _v2.$ ==='Just' ){var vol = _v2.a;var updateResult = model.isPlaying? $user$project$AudioFFI$updateVolume( vol):'Volume set to ' +( $elm$core$String$fromFloat( vol) +'%'); return ( _Utils_Tuple2( _Utils_update( model,{volume : vol,status : updateResult,operationLog : A2( $elm$core$List$cons, updateResult, model.operationLog)}), $elm$core$Platform$Cmd$none));} else return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none)); case 'SetWaveform' :var waveform = msg.a;var updateResult = model.isPlaying? $user$project$AudioFFI$updateWaveform( waveform):'Waveform set to ' + waveform; return ( _Utils_Tuple2( _Utils_update( model,{waveform : waveform,status : updateResult,operationLog : A2( $elm$core$List$cons, updateResult, model.operationLog)}), $elm$core$Platform$Cmd$none)); case 'InitializeAudioTypeSafe' :var _v3 = $user$project$AudioFFI$createAudioContext( $user$project$Capability$Click);if ( _v3.$ ==='Ok' ){var initializedContext = _v3.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â AudioContext created successfully',operationLog : A2( $elm$core$List$cons,'AudioContext initialized', model.operationLog),lastError : $elm$core$Maybe$Nothing,audioContext : $elm$core$Maybe$Just( initializedContext)}), $elm$core$Platform$Cmd$none));} else{var error = _v3.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â AudioContext creation failed: ' + $user$project$Main$capabilityErrorString( error),operationLog : A2( $elm$core$List$cons,'AudioContext error: ' + $user$project$Main$capabilityErrorString( error), model.operationLog),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));} case 'CreateAudioNodesTypeSafe' :var _v4 = model.audioContext;if ( _v4.$ ==='Just' ){var initializedContext = _v4.a;var _v5 = _Utils_Tuple2( A3( $user$project$AudioFFI$createOscillator, initializedContext, model.frequency, model.waveform), A2( $user$project$AudioFFI$createGainNode, initializedContext, model.volume /100.0));if ( _v5.a.$ ==='Ok' )if ( _v5.b.$ ==='Ok' ){var oscillator = _v5.a.a;var gainNode = _v5.b.a;var _v6 = _Utils_Tuple2( A2( $user$project$AudioFFI$connectNodes, oscillator, gainNode), A2( $user$project$AudioFFI$connectToDestination, gainNode, initializedContext));if ( _v6.a.$ ==='Ok' )if ( _v6.b.$ ==='Ok' ) return ( _Utils_Tuple2( _Utils_update( model,{status :'â Audio nodes created and connected - ready to play',operationLog : A2( $elm$core$List$cons,'Audio graph connected', A2( $elm$core$List$cons,'GainNode created', A2( $elm$core$List$cons,'OscillatorNode created', model.operationLog))),lastError : $elm$core$Maybe$Nothing,currentOscillator : $elm$core$Maybe$Just( oscillator),currentGainNode : $elm$core$Maybe$Just( gainNode)}), $elm$core$Platform$Cmd$none)); else{var error = _v6.b.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Destination connection failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));} else{var error = _v6.a.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Node connection failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));}} else{var error = _v5.b.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Gain node creation failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));} else{var error = _v5.a.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Oscillator creation failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));}} else return ( _Utils_Tuple2( _Utils_update( model,{status :'Error: No AudioContext available',lastError : $elm$core$Maybe$Just('AudioContext must be created first')}), $elm$core$Platform$Cmd$none)); case 'PlayAudioTypeSafe' :var _v7 = _Utils_Tuple2( model.currentOscillator, model.audioContext);if ( _v7.a.$ ==='Just' && _v7.b.$ ==='Just' ){var oscillator = _v7.a.a;var audioContext = _v7.b.a;var currentTime = $user$project$AudioFFI$getCurrentTime( audioContext);var _v8 = A2( $user$project$AudioFFI$startOscillator, oscillator, currentTime);if ( _v8.$ ==='Ok' ) return ( _Utils_Tuple2( _Utils_update( model,{status :'ð Audio playing with type-safe interface!',operationLog : A2( $elm$core$List$cons,'Audio playback started', model.operationLog),lastError : $elm$core$Maybe$Nothing,isPlaying :true}), $elm$core$Platform$Cmd$none)); else{var error = _v8.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Audio start failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));}} else return ( _Utils_Tuple2( _Utils_update( model,{status :'Error: Audio nodes not ready',lastError : $elm$core$Maybe$Just('Create audio nodes first')}), $elm$core$Platform$Cmd$none)); default :var _v9 = _Utils_Tuple2( model.currentOscillator, model.audioContext);if ( _v9.a.$ ==='Just' && _v9.b.$ ==='Just' ){var oscillator = _v9.a.a;var audioContext = _v9.b.a;var currentTime = $user$project$AudioFFI$getCurrentTime( audioContext);var _v10 = A2( $user$project$AudioFFI$stopOscillator, oscillator, currentTime);if ( _v10.$ ==='Ok' ) return ( _Utils_Tuple2( _Utils_update( model,{status :'â¹ï¸ Audio stopped',operationLog : A2( $elm$core$List$cons,'Audio playback stopped', model.operationLog),lastError : $elm$core$Maybe$Nothing,isPlaying :false,currentOscillator : $elm$core$Maybe$Nothing}), $elm$core$Platform$Cmd$none)); else{var error = _v10.a; return ( _Utils_Tuple2( _Utils_update( model,{status :'â Audio stop failed: ' + $user$project$Main$capabilityErrorString( error),lastError : $elm$core$Maybe$Just( $user$project$Main$capabilityErrorString( error))}), $elm$core$Platform$Cmd$none));}} else return ( _Utils_Tuple2( _Utils_update( model,{status :'No audio to stop'}), $elm$core$Platform$Cmd$none));}});
...
var $user$project$Main$advancedInfoSection = function(model){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(0,0,0,0.3)') , A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð¬ Advanced Information')])) , A2( $elm$html$Html$h4, _List_Nil, _List_fromArray([ $elm$html$Html$text('Type Signatures Used:')])) , A2( $elm$html$Html$pre, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(0,0,0,0.4)') , A2( $elm$html$Html$Attributes$style,'padding','10px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'font-size','11px') , A2( $elm$html$Html$Attributes$style,'overflow-x','auto')]), _List_fromArray([ $elm$html$Html$text('createAudioContext : UserActivated -> Result CapabilityError (Initialized AudioContext)\ncreateOscillator : Initialized AudioContext -> Float -> String -> Result CapabilityError OscillatorNode\nconnectNodes : a -> b -> Result CapabilityError Int\nstartOscillator : OscillatorNode -> Float -> Result CapabilityError Int')])) , A2( $elm$html$Html$h4, _List_Nil, _List_fromArray([ $elm$html$Html$text('Current State:')])) , A2( $elm$html$Html$ul, _List_Nil, _List_fromArray([ A2( $elm$html$Html$li, _List_Nil, _List_fromArray([ $elm$html$Html$text('AudioContext: ' +(! _Utils_eq( model.audioContext, $elm$core$Maybe$Nothing))?'Initialized':'Not created')])) , A2( $elm$html$Html$li, _List_Nil, _List_fromArray([ $elm$html$Html$text('OscillatorNode: ' +(! _Utils_eq( model.currentOscillator, $elm$core$Maybe$Nothing))?'Created':'Not created')])) , A2( $elm$html$Html$li, _List_Nil, _List_fromArray([ $elm$html$Html$text('GainNode: ' +(! _Utils_eq( model.currentGainNode, $elm$core$Maybe$Nothing))?'Created':'Not created')])) , A2( $elm$html$Html$li, _List_Nil, _List_fromArray([ $elm$html$Html$text('Audio Playing: ' + model.isPlaying?'Yes':'No')]))]))])));};
var $user$project$Main$InitializeAudioTypeSafe ={$ :'InitializeAudioTypeSafe'};
var $user$project$Main$PlayAudioSimple ={$ :'PlayAudioSimple'};
...
var $user$project$Main$controlButton = F3( function(label,msg,disabled){ return ( A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( msg) , $elm$html$Html$Attributes$disabled( disabled) , A2( $elm$html$Html$Attributes$style,'background', disabled?'rgba(100,100,100,0.5)':'rgba(40,167,69,0.8)') , A2( $elm$html$Html$Attributes$style,'color','white') , A2( $elm$html$Html$Attributes$style,'border','none') , A2( $elm$html$Html$Attributes$style,'padding','10px 15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'cursor', disabled?'not-allowed':'pointer') , A2( $elm$html$Html$Attributes$style,'font-weight','bold')]), _List_fromArray([ $elm$html$Html$text( label)])));});
var $elm$html$Html$p = _VirtualDom_node('p');
var $user$project$Main$comparisonModeDemo = function(model){ return ( A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','grid') , A2( $elm$html$Html$Attributes$style,'grid-template-columns','1fr 1fr') , A2( $elm$html$Html$Attributes$style,'gap','20px')]), _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(255,255,255,0.1)') , A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Simplified Interface')])) , A2( $elm$html$Html$p, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'font-size','14px') , A2( $elm$html$Html$Attributes$style,'opacity','0.8')]), _List_fromArray([ $elm$html$Html$text('String-based, easy to use')])) , A3( $user$project$Main$controlButton,'Play (Simple)', $user$project$Main$PlayAudioSimple,false)])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(255,255,255,0.1)') , A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð¡ï¸ Type-Safe Interface')])) , A2( $elm$html$Html$p, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'font-size','14px') , A2( $elm$html$Html$Attributes$style,'opacity','0.8')]), _List_fromArray([ $elm$html$Html$text('Result-based, production-ready')])) , A3( $user$project$Main$controlButton,'Initialize & Play (Safe)', $user$project$Main$InitializeAudioTypeSafe,false)]))]))])));};
var $user$project$Main$ComparisonMode ={$ :'ComparisonMode'};
var $user$project$Main$TypeSafeInterface ={$ :'TypeSafeInterface'};
var $user$project$Main$SetDemoMode = function(a){ return ({a : a,$ :'SetDemoMode'});};
var $user$project$Main$modeButton = F3( function(label,mode,currentMode){ return ( A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $user$project$Main$SetDemoMode( mode)) , A2( $elm$html$Html$Attributes$style,'background', _Utils_eq( mode, currentMode)?'#ffd700':'rgba(255,255,255,0.2)') , A2( $elm$html$Html$Attributes$style,'color', _Utils_eq( mode, currentMode)?'#000':'#fff') , A2( $elm$html$Html$Attributes$style,'border','2px solid #ffd700') , A2( $elm$html$Html$Attributes$style,'padding','10px 15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'cursor','pointer') , A2( $elm$html$Html$Attributes$style,'font-weight','bold')]), _List_fromArray([ $elm$html$Html$text( label)])));});
var $user$project$Main$demoModeSelector = function(model){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(255,255,255,0.1)') , A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','20px') , A2( $elm$html$Html$Attributes$style,'text-align','center')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ðï¸ Demo Mode Selection')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'justify-content','center') , A2( $elm$html$Html$Attributes$style,'gap','10px') , A2( $elm$html$Html$Attributes$style,'flex-wrap','wrap')]), _List_fromArray([ A3( $user$project$Main$modeButton,'Simplified Interface', $user$project$Main$SimplifiedInterface, model.demoMode) , A3( $user$project$Main$modeButton,'Type-Safe Interface', $user$project$Main$TypeSafeInterface, model.demoMode) , A3( $user$project$Main$modeButton,'Comparison Mode', $user$project$Main$ComparisonMode, model.demoMode)]))])));};
var $user$project$AudioFFI$checkWebAudioSupport = FFI.checkWebAudioSupport;
var $user$project$AudioFFI$simpleTest = FFI.simpleTest;
...
var $user$project$Main$StopAudioSimple ={$ :'StopAudioSimple'};
var $user$project$Main$SetFrequency = function(a){ return ({a : a,$ :'SetFrequency'});};
var $user$project$Main$SetVolume = function(a){ return ({a : a,$ :'SetVolume'});};
var $elm$html$Html$h5 = _VirtualDom_node('h5');
var $user$project$Main$controlGroup = F2( function(title,content){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin-bottom','15px')]), A2( $elm$core$List$cons, A2( $elm$html$Html$h5, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','0 0 10px 0') , A2( $elm$html$Html$Attributes$style,'color','#ffd700')]), _List_fromArray([ $elm$html$Html$text( title)])), content)));});
...
var $user$project$Main$sliderStyle = A2( $elm$html$Html$Attributes$style,'flex','1');
...
var $user$project$Main$SetWaveform = function(a){ return ({a : a,$ :'SetWaveform'});};
var $user$project$Main$waveformButton = F3( function(label,waveType,currentWave){ return ( A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $user$project$Main$SetWaveform( waveType)) , A2( $elm$html$Html$Attributes$style,'background', _Utils_eq( currentWave, waveType)?'#ffd700':'rgba(255,255,255,0.2)') , A2( $elm$html$Html$Attributes$style,'color', _Utils_eq( currentWave, waveType)?'#000':'#fff') , A2( $elm$html$Html$Attributes$style,'border','2px solid #ffd700') , A2( $elm$html$Html$Attributes$style,'padding','8px 12px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'cursor','pointer') , A2( $elm$html$Html$Attributes$style,'font-size','12px') , A2( $elm$html$Html$Attributes$style,'font-weight','bold')]), _List_fromArray([ $elm$html$Html$text( label)])));});
var $user$project$Main$audioControlsSection = function(model){ return ( A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ A2( $elm$html$Html$h4, _List_Nil, _List_fromArray([ $elm$html$Html$text('ðï¸ Real-Time Audio Controls')])) , A2( $user$project$Main$controlGroup,'ð Frequency', _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'align-items','center') , A2( $elm$html$Html$Attributes$style,'gap','10px')]), _List_fromArray([ A2( $elm$html$Html$input, _List_fromArray([ $elm$html$Html$Attributes$type_('range') , $elm$html$Html$Attributes$min('20') , $elm$html$Html$Attributes$max('2000') , $elm$html$Html$Attributes$step('10') , $elm$html$Html$Attributes$value( $elm$core$String$fromFloat( model.frequency)) , $elm$html$Html$Events$onInput( $user$project$Main$SetFrequency) , $user$project$Main$sliderStyle]), _List_Nil) , A2( $elm$html$Html$span, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'min-width','80px') , A2( $elm$html$Html$Attributes$style,'font-weight','bold') , A2( $elm$html$Html$Attributes$style,'color','#ffd700')]), _List_fromArray([ $elm$html$Html$text( $elm$core$String$fromFloat( model.frequency) +' Hz')]))]))])) , A2( $user$project$Main$controlGroup,'ð Volume', _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'align-items','center') , A2( $elm$html$Html$Attributes$style,'gap','10px')]), _List_fromArray([ A2( $elm$html$Html$input, _List_fromArray([ $elm$html$Html$Attributes$type_('range') , $elm$html$Html$Attributes$min('0') , $elm$html$Html$Attributes$max('100') , $elm$html$Html$Attributes$step('5') , $elm$html$Html$Attributes$value( $elm$core$String$fromFloat( model.volume)) , $elm$html$Html$Events$onInput( $user$project$Main$SetVolume) , $user$project$Main$sliderStyle]), _List_Nil) , A2( $elm$html$Html$span, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'min-width','50px') , A2( $elm$html$Html$Attributes$style,'font-weight','bold') , A2( $elm$html$Html$Attributes$style,'color','#ffd700')]), _List_fromArray([ $elm$html$Html$text( $elm$core$String$fromFloat( model.volume) +'%')]))]))])) , A2( $user$project$Main$controlGroup,'â¡ Waveform', _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'gap','10px')]), _List_fromArray([ A3( $user$project$Main$waveformButton,'ð Sine','sine', model.waveform) , A3( $user$project$Main$waveformButton,'â¬ Square','square', model.waveform) , A3( $user$project$Main$waveformButton,'ðª Sawtooth','sawtooth', model.waveform) , A3( $user$project$Main$waveformButton,'ðº Triangle','triangle', model.waveform)]))]))])));};
var $user$project$Main$simplifiedInterfaceDemo = function(model){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(255,255,255,0.1)') , A2( $elm$html$Html$Attributes$style,'padding','25px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','20px')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Simplified String-Based Interface')])) , A2( $elm$html$Html$p, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin-bottom','20px') , A2( $elm$html$Html$Attributes$style,'opacity','0.9')]), _List_fromArray([ $elm$html$Html$text('Easy-to-use functions that return status strings but still generate real audio.')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'justify-content','center') , A2( $elm$html$Html$Attributes$style,'gap','10px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','20px')]), _List_fromArray([ A3( $user$project$Main$controlButton,'ðï¸ Initialize Audio', $user$project$Main$InitializeAudioSimple,false) , A3( $user$project$Main$controlButton,'â¶ï¸ Play Audio', $user$project$Main$PlayAudioSimple,false) , A3( $user$project$Main$controlButton,'â¹ï¸ Stop Audio', $user$project$Main$StopAudioSimple,false)])) , $user$project$Main$audioControlsSection( model)])));};
var $user$project$Main$ClearLog ={$ :'ClearLog'};
var $user$project$Main$ToggleAdvancedMode ={$ :'ToggleAdvancedMode'};
...
var $user$project$Main$statusSection = function(model){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(0,0,0,0.3)') , A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'border-radius','10px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','20px')]), _List_fromArray([ A2( $elm$html$Html$h3, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð System Status')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(0,0,0,0.2)') , A2( $elm$html$Html$Attributes$style,'padding','15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','15px') , A2( $elm$html$Html$Attributes$style,'font-family','monospace')]), _List_fromArray([ $elm$html$Html$text( model.status)])) , function(){var _v0 = model.lastError;if ( _v0.$ ==='Just' ){var error = _v0.a; return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(220,53,69,0.2)') , A2( $elm$html$Html$Attributes$style,'border','1px solid rgba(220,53,69,0.5)') , A2( $elm$html$Html$Attributes$style,'padding','10px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'margin-bottom','15px')]), _List_fromArray([ A2( $elm$html$Html$strong, _List_Nil, _List_fromArray([ $elm$html$Html$text('â Last Error: ')])) , $elm$html$Html$text( error)])));} else return ( $elm$html$Html$text(''));}() , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','flex') , A2( $elm$html$Html$Attributes$style,'justify-content','space-between') , A2( $elm$html$Html$Attributes$style,'align-items','center') , A2( $elm$html$Html$Attributes$style,'margin-bottom','15px')]), _List_fromArray([ A2( $elm$html$Html$h4, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Operation Log')])) , A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ A3( $user$project$Main$controlButton,'ð§¹ Clear Log', $user$project$Main$ClearLog,false) , A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $user$project$Main$ToggleAdvancedMode) , A2( $elm$html$Html$Attributes$style,'background','rgba(255,255,255,0.2)') , A2( $elm$html$Html$Attributes$style,'color','white') , A2( $elm$html$Html$Attributes$style,'border','1px solid rgba(255,255,255,0.3)') , A2( $elm$html$Html$Attributes$style,'padding','5px 10px') , A2( $elm$html$Html$Attributes$style,'border-radius','3px') , A2( $elm$html$Html$Attributes$style,'cursor','pointer') , A2( $elm$html$Html$Attributes$style,'margin-left','10px')]), _List_fromArray([ $elm$html$Html$text( model.showAdvanced?'Hide Advanced':'Show Advanced')]))]))])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background','rgba(0,0,0,0.2)') , A2( $elm$html$Html$Attributes$style,'padding','10px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'max-height','200px') , A2( $elm$html$Html$Attributes$style,'overflow-y','auto') , A2( $elm$html$Html$Attributes$style,'font-family','monospace') , A2( $elm$html$Html$Attributes$style,'font-size','12px')]), A2( $elm$core$List$map, function(log){ return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'padding','2px 0') , A2( $elm$html$Html$Attributes$style,'border-bottom','1px solid rgba(255,255,255,0.1)')]), _List_fromArray([ $elm$html$Html$text( log)])));}, A2( $elm$core$List$take,50, model.operationLog)))])));};
...
var $elm$time$Time$Offset = function(a){ return ({a : a,$ :'Offset'});};
var $elm$time$Time$Zone = F2( function(a,b){ return ({b : b,a : a,$ :'Zone'});});
var $elm$time$Time$customZone = $elm$time$Time$Zone;
var $elm$browser$Browser$AnimationManager$State = F3( function(subs,request,oldTime){ return ({subs : subs,request : request,oldTime : oldTime});});
...
var $elm$browser$Browser$AnimationManager$onEffects = F3( function(router,subs,_v0){var request = _v0.request;var oldTime = _v0.oldTime;var _v1 = _Utils_Tuple2( request, subs);if ( _v1.a.$ ==='Nothing' )if (! _v1.b.b ){var _v2 = _v1.a; return ( $elm$browser$Browser$AnimationManager$init);} else{var _v4 = _v1.a; return ( A2( $elm$core$Task$andThen, function(pid){ return ( A2( $elm$core$Task$andThen, function(time){ return ( $elm$core$Task$succeed( A3( $elm$browser$Browser$AnimationManager$State, subs, $elm$core$Maybe$Just( pid), time)));}, $elm$browser$Browser$AnimationManager$now));}, $elm$core$Process$spawn( A2( $elm$core$Task$andThen, $elm$core$Platform$sendToSelf( router), $elm$browser$Browser$AnimationManager$rAF))));} else if (! _v1.b.b ){var pid = _v1.a.a; return ( A2( $elm$core$Task$andThen, function(_v3){ return ( $elm$browser$Browser$AnimationManager$init);}, $elm$core$Process$kill( pid)));} else return ( $elm$core$Task$succeed( A3( $elm$browser$Browser$AnimationManager$State, subs, request, oldTime)));});
var $elm$time$Time$Posix = function(a){ return ({a : a,$ :'Posix'});};
var $elm$time$Time$millisToPosix = $elm$time$Time$Posix;
var $elm$browser$Browser$AnimationManager$onSelfMsg = F3( function(router,newTime,_v0){var subs = _v0.subs;var oldTime = _v0.oldTime;var send = function(sub){if ( sub.$ ==='Time' ){var tagger = sub.a; return ( A2( $elm$core$Platform$sendToApp, router, tagger( $elm$time$Time$millisToPosix( newTime))));} else{var tagger = sub.a; return ( A2( $elm$core$Platform$sendToApp, router, tagger( newTime - oldTime)));}}; return ( A2( $elm$core$Task$andThen, function(pid){ return ( A2( $elm$core$Task$andThen, function(_v1){ return ( $elm$core$Task$succeed( A3( $elm$browser$Browser$AnimationManager$State, subs, $elm$core$Maybe$Just( pid), newTime)));}, $elm$core$Task$sequence( A2( $elm$core$List$map, send, subs))));}, $elm$core$Process$spawn( A2( $elm$core$Task$andThen, $elm$core$Platform$sendToSelf( router), $elm$browser$Browser$AnimationManager$rAF))));});
var $elm$browser$Browser$AnimationManager$Delta = function(a){ return ({a : a,$ :'Delta'});};
var $elm$browser$Browser$AnimationManager$Time = function(a){ return ({a : a,$ :'Time'});};
var $elm$core$Basics$composeL = F3( function(g,f,x){ return ( g( f( x)));});
var $elm$browser$Browser$AnimationManager$subMap = F2( function(func,sub){if ( sub.$ ==='Time' ){var tagger = sub.a; return ( $elm$browser$Browser$AnimationManager$Time( A2( $elm$core$Basics$composeL, func, tagger)));} else{var tagger = sub.a; return ( $elm$browser$Browser$AnimationManager$Delta( A2( $elm$core$Basics$composeL, func, tagger)));}});
 _Platform_effectManagers['Browser.AnimationManager'] = _Platform_createManager( $elm$browser$Browser$AnimationManager$init, $elm$browser$Browser$AnimationManager$onEffects, $elm$browser$Browser$AnimationManager$onSelfMsg,0, $elm$browser$Browser$AnimationManager$subMap)
var $elm$browser$Browser$AnimationManager$subscription = _Platform_leaf('Browser.AnimationManager');
var $elm$browser$Browser$Events$State = F2( function(subs,pids){ return ({subs : subs,pids : pids});});
...
var $elm$browser$Browser$Events$nodeToKey = function(node){if ( node.$ ==='Document' ) return 'd_'; else return 'w_';};
var $elm$browser$Browser$Events$addKey = function(sub){var node = sub.a;var name = sub.b; return ( _Utils_Tuple2( _Utils_ap( $elm$browser$Browser$Events$nodeToKey( node), name), sub));};
...
var $elm$browser$Browser$Events$Event = F2( function(key,event){ return ({key : key,event : event});});
var $elm$browser$Browser$Events$spawn = F3( function(router,key,_v0){var node = _v0.a;var name = _v0.b;var actualNode = function(){if ( node.$ ==='Document' ) return ( _Browser_doc); else return ( _Browser_window);}(); return ( A2( $elm$core$Task$map, function(value){ return ( _Utils_Tuple2( key, value));}, A3( _Browser_on, actualNode, name, function(event){ return ( A2( $elm$core$Platform$sendToSelf, router, A2( $elm$browser$Browser$Events$Event, key, event)));})));});
var $elm$core$Dict$union = F2( function(t1,t2){ return ( A3( $elm$core$Dict$foldl, $elm$core$Dict$insert, t2, t1));});
var $elm$browser$Browser$Events$onEffects = F3( function(router,subs,state){var stepRight = F3( function(key,sub,_v6){var deads = _v6.a;var lives = _v6.b;var news = _v6.c; return ( _Utils_Tuple3( deads, lives, A2( $elm$core$List$cons, A3( $elm$browser$Browser$Events$spawn, router, key, sub), news)));});var stepLeft = F3( function(_v4,pid,_v5){var deads = _v5.a;var lives = _v5.b;var news = _v5.c; return ( _Utils_Tuple3( A2( $elm$core$List$cons, pid, deads), lives, news));});var stepBoth = F4( function(key,pid,_v2,_v3){var deads = _v3.a;var lives = _v3.b;var news = _v3.c; return ( _Utils_Tuple3( deads, A3( $elm$core$Dict$insert, key, pid, lives), news));});var newSubs = A2( $elm$core$List$map, $elm$browser$Browser$Events$addKey, subs);var _v0 = A6( $elm$core$Dict$merge, stepLeft, stepBoth, stepRight, state.pids, $elm$core$Dict$fromList( newSubs), _Utils_Tuple3( _List_Nil, $elm$core$Dict$empty, _List_Nil));var deadPids = _v0.a;var livePids = _v0.b;var makeNewPids = _v0.c; return ( A2( $elm$core$Task$andThen, function(pids){ return ( $elm$core$Task$succeed( A2( $elm$browser$Browser$Events$State, newSubs, A2( $elm$core$Dict$union, livePids, $elm$core$Dict$fromList( pids)))));}, A2( $elm$core$Task$andThen, function(_v1){ return ( $elm$core$Task$sequence( makeNewPids));}, $elm$core$Task$sequence( A2( $elm$core$List$map, $elm$core$Process$kill, deadPids)))));});
...
var $elm$browser$Browser$Events$onSelfMsg = F3( function(router,_v0,state){var key = _v0.key;var event = _v0.event;var toMessage = function(_v2){var subKey = _v2.a;var _v3 = _v2.b;var node = _v3.a;var name = _v3.b;var decoder = _v3.c; return ( _Utils_eq( subKey, key)? A2( _Browser_decodeEvent, decoder, event): $elm$core$Maybe$Nothing);};var messages = A2( $elm$core$List$filterMap, toMessage, state.subs); return ( A2( $elm$core$Task$andThen, function(_v1){ return ( $elm$core$Task$succeed( state));}, $elm$core$Task$sequence( A2( $elm$core$List$map, $elm$core$Platform$sendToApp( router), messages))));});
var $elm$browser$Browser$Events$MySub = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'MySub'});});
var $elm$browser$Browser$Events$subMap = F2( function(func,_v0){var node = _v0.a;var name = _v0.b;var decoder = _v0.c; return ( A3( $elm$browser$Browser$Events$MySub, node, name, A2( $elm$json$Json$Decode$map, func, decoder)));});
 _Platform_effectManagers['Browser.Events'] = _Platform_createManager( $elm$browser$Browser$Events$init, $elm$browser$Browser$Events$onEffects, $elm$browser$Browser$Events$onSelfMsg,0, $elm$browser$Browser$Events$subMap)
var $elm$browser$Browser$Events$subscription = _Platform_leaf('Browser.Events');
var $elm$time$Time$State = F2( function(taggers,processes){ return ({taggers : taggers,processes : processes});});
...
var $elm$browser$Debugger$Overlay$BadImport = function(a){ return ({a : a,$ :'BadImport'});};
var $elm$browser$Debugger$Overlay$BadMetadata = function(a){ return ({a : a,$ :'BadMetadata'});};
...
var $elm$browser$Debugger$Overlay$Choose = F2( function(a,b){ return ({b : b,a : a,$ :'Choose'});});
var $user$project$Capability$Closing = function(a){ return ({a : a,$ :'Closing'});};
var $elm$core$Platform$Cmd$Cmd ={$ :'Cmd'};
var $elm$browser$Debugger$Overlay$Config = F5( function(resume,open,importHistory,exportHistory,wrap){ return ({wrap : wrap,resume : resume,open : open,importHistory : importHistory,exportHistory : exportHistory});});
var $user$project$AudioFFI$ConstantSourceNode ={$ :'ConstantSourceNode'};
var $elm$browser$Debugger$Expando$Constructor = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'Constructor'});});
var $user$project$AudioFFI$ConvolverNode ={$ :'ConvolverNode'};
var $elm$browser$Debugger$Report$CorruptHistory ={$ :'CorruptHistory'};
var $elm$url$Url$Builder$CrossOrigin = function(a){ return ({a : a,$ :'CrossOrigin'});};
...
var $elm$browser$Debugger$Expando$Dictionary = F2( function(a,b){ return ({b : b,a : a,$ :'Dictionary'});});
var $elm$browser$Browser$Document = F2( function(title,body){ return ({title : title,body : body});});
var $elm$browser$Browser$Events$Document ={$ :'Document'};
var $elm$browser$Debugger$History$Done = F2( function(a,b){ return ({b : b,a : a,$ :'Done'});});
var $elm$browser$Debugger$Main$Down ={$ :'Down'};
var $user$project$Capability$Drag ={$ :'Drag'};
var $elm$browser$Debugger$Main$Drag = function(a){ return ({a : a,$ :'Drag'});};
var $elm$browser$Debugger$Main$DragEnd ={$ :'DragEnd'};
var $elm$browser$Debugger$Main$DragInfo = F5( function(x,y,down,width,height){ return ({y : y,x : x,width : width,height : height,down : down});});
...
var $elm$browser$Debugger$Expando$Field = F2( function(a,b){ return ({b : b,a : a,$ :'Field'});});
...
var $elm$browser$Debugger$History$History = F3( function(snapshots,recent,numMessages){ return ({snapshots : snapshots,recent : recent,numMessages : numMessages});});
var $elm$browser$Debugger$Main$Horizontal = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'Horizontal'});});
var $user$project$AudioFFI$IIRFilterNode ={$ :'IIRFilterNode'};
var $elm$browser$Debugger$Main$Import ={$ :'Import'};
var $elm$browser$Debugger$Report$Impossible ={$ :'Impossible'};
var $elm$browser$Debugger$Expando$Index = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'Index'});});
...
var $elm$browser$Debugger$Main$Jump = function(a){ return ({a : a,$ :'Jump'});};
var $elm$time$Time$Jun ={$ :'Jun'};
var $elm$core$Basics$JustOneMore = function(a){ return ({a : a,$ :'JustOneMore'});};
var $elm$browser$Browser$Navigation$Key ={$ :'Key'};
...
var $elm$browser$Debugger$Report$MessageChanged = F2( function(a,b){ return ({b : b,a : a,$ :'MessageChanged'});});
var $user$project$AudioFFI$MessagePort ={$ :'MessagePort'};
var $elm$browser$Debugger$Metadata$Metadata = F2( function(versions,types){ return ({versions : versions,types : types});});
var $elm$browser$Debugger$Main$Model = F8( function(history,state,expandoModel,expandoMsg,metadata,overlay,popout,layout){ return ({state : state,popout : popout,overlay : overlay,metadata : metadata,layout : layout,history : history,expandoMsg : expandoMsg,expandoModel : expandoModel});});
var $user$project$Main$Model = function(audioContext){ return ( function(currentOscillator){ return ( function(currentGainNode){ return ( function(isPlaying){ return ( function(frequency){ return ( function(volume){ return ( function(waveform){ return ( function(status){ return ( function(lastError){ return ( function(operationLog){ return ( function(demoMode){ return ( function(showAdvanced){ return ({waveform : waveform,volume : volume,status : status,showAdvanced : showAdvanced,operationLog : operationLog,lastError : lastError,isPlaying : isPlaying,frequency : frequency,demoMode : demoMode,currentOscillator : currentOscillator,currentGainNode : currentGainNode,audioContext : audioContext});});});});});});});});});});});});};
...
var $elm$url$Url$Parser$Parser = function(a){ return ({a : a,$ :'Parser'});};
var $elm$url$Url$Parser$Internal$Parser = function(a){ return ({a : a,$ :'Parser'});};
var $user$project$Capability$PartialSupport = function(a){ return ({a : a,$ :'PartialSupport'});};
var $elm$browser$Debugger$Main$Paused = F5( function(a,b,c,d,e){ return ({e : e,d : d,c : c,b : b,a : a,$ :'Paused'});});
...
var $elm$browser$Debugger$Main$Popout = function(a){ return ({a : a,$ :'Popout'});};
var $user$project$Capability$Prefixed = F2( function(a,b){ return ({b : b,a : a,$ :'Prefixed'});});
var $elm$browser$Debugger$Expando$Primitive = function(a){ return ({a : a,$ :'Primitive'});};
var $elm$browser$Debugger$Metadata$ProblemType = F2( function(name,problems){ return ({problems : problems,name : name});});
...
var $elm$url$Url$Builder$QueryParameter = F2( function(a,b){ return ({b : b,a : a,$ :'QueryParameter'});});
...
var $elm$browser$Debugger$History$RecentHistory = F3( function(model,messages,numMessages){ return ({numMessages : numMessages,model : model,messages : messages});});
var $elm$browser$Debugger$Expando$Record = F2( function(a,b){ return ({b : b,a : a,$ :'Record'});});
...
var $elm$browser$Debugger$Overlay$RiskyImport = F2( function(a,b){ return ({b : b,a : a,$ :'RiskyImport'});});
var $elm$core$Platform$Router ={$ :'Router'};
var $user$project$Capability$Running = function(a){ return ({a : a,$ :'Running'});};
var $elm$browser$Debugger$Main$Running = function(a){ return ({a : a,$ :'Running'});};
var $elm$browser$Debugger$Expando$S = function(a){ return ({a : a,$ :'S'});};
var $elm$time$Time$Sat ={$ :'Sat'};
var $user$project$Capability$SecurityError = function(a){ return ({a : a,$ :'SecurityError'});};
var $elm$time$Time$Sep ={$ :'Sep'};
var $elm$browser$Debugger$Expando$Sequence = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'Sequence'});});
var $elm$browser$Debugger$Expando$SetSeq ={$ :'SetSeq'};
var $elm$core$Set$Set_elm_builtin = function(a){ return ({a : a,$ :'Set_elm_builtin'});};
var $elm$browser$Debugger$Main$SliderJump = function(a){ return ({a : a,$ :'SliderJump'});};
var $elm$browser$Debugger$History$Snapshot = F2( function(model,messages){ return ({model : model,messages : messages});});
var $elm$browser$Debugger$Metadata$Socket ={$ :'Socket'};
var $elm$browser$Debugger$Report$SomethingChanged = function(a){ return ({a : a,$ :'SomethingChanged'});};
var $elm$url$Url$Parser$State = F5( function(visited,unvisited,params,frag,value){ return ({visited : visited,value : value,unvisited : unvisited,params : params,frag : frag});});
var $elm$browser$Debugger$Main$Static ={$ :'Static'};
var $elm$browser$Debugger$History$Stepping = F2( function(a,b){ return ({b : b,a : a,$ :'Stepping'});});
...
var $elm$browser$Debugger$Report$TagChanges = F4( function(removed,changed,added,argsMatch){ return ({removed : removed,changed : changed,argsMatch : argsMatch,added : added});});
...
var $elm$browser$Debugger$Main$TweakExpandoModel = function(a){ return ({a : a,$ :'TweakExpandoModel'});};
var $elm$browser$Debugger$Main$TweakExpandoMsg = function(a){ return ({a : a,$ :'TweakExpandoMsg'});};
var $elm$browser$Debugger$Metadata$Types = F3( function(message,aliases,unions){ return ({unions : unions,message : message,aliases : aliases});});
var $elm$browser$Debugger$Metadata$Union = F2( function(args,tags){ return ({tags : tags,args : args});});
var $elm$browser$Debugger$Report$UnionChange = F2( function(a,b){ return ({b : b,a : a,$ :'UnionChange'});});
var $user$project$Capability$Unknown = function(a){ return ({a : a,$ :'Unknown'});};
var $elm$browser$Debugger$Main$Up ={$ :'Up'};
var $elm$browser$Debugger$Main$Upload = function(a){ return ({a : a,$ :'Upload'});};
var $user$project$Capability$UserActivationRequired = function(a){ return ({a : a,$ :'UserActivationRequired'});};
var $elm$browser$Debugger$Main$UserMsg = function(a){ return ({a : a,$ :'UserMsg'});};
var $elm$browser$Debugger$Expando$Value ={$ :'Value'};
var $elm$json$Json$Encode$Value ={$ :'Value'};
var $elm$browser$Debugger$Report$VersionChanged = F2( function(a,b){ return ({b : b,a : a,$ :'VersionChanged'});});
var $elm$browser$Debugger$Metadata$Versions = function(elm){ return ({elm : elm});};
var $elm$browser$Debugger$Main$Vertical = F3( function(a,b,c){ return ({c : c,b : b,a : a,$ :'Vertical'});});
var $elm$browser$Browser$Dom$Viewport = F2( function(scene,viewport){ return ({viewport : viewport,scene : scene});});
...
var $elm$browser$Debugger$History$getHelp = F3( function(update,msg,getResult){if ( getResult.$ ==='Done' ) return ( getResult); else{var n = getResult.a;var model = getResult.b; return ((! n)? A2( $elm$browser$Debugger$History$Done, msg, A2( update, msg, model).a): A2( $elm$browser$Debugger$History$Stepping, n -1, A2( update, msg, model).a));}});
var $elm$browser$Debugger$History$maxSnapshotSize =31;
var $elm$browser$Debugger$History$undone = function(getResult){undone: while (true ){if ( getResult.$ ==='Done' ){var msg = getResult.a;var model = getResult.b; return ( _Utils_Tuple2( model, msg));} else{var $temp$getResult = getResult
;getResult = $temp$getResult; continue undone;};}};
var $elm$browser$Debugger$History$get = F3( function(update,index,history){get: while (true ){var recent = history.recent;var snapshotMax = history.numMessages - recent.numMessages;if ( _Utils_cmp( index, snapshotMax) >-1 ){ return ( $elm$browser$Debugger$History$undone( A3( $elm$core$List$foldr, $elm$browser$Debugger$History$getHelp( update), A2( $elm$browser$Debugger$History$Stepping, index - snapshotMax, recent.model), recent.messages)));} else{var _v0 = A2( $elm$core$Array$get, index / $elm$browser$Debugger$History$maxSnapshotSize |0, history.snapshots);if ( _v0.$ ==='Nothing' ){var $temp$history = history, $temp$index = index, $temp$update = update
;update = $temp$update;index = $temp$index;history = $temp$history; continue get;} else{var model = _v0.a.model;var messages = _v0.a.messages; return ( $elm$browser$Debugger$History$undone( A3( $elm$core$Array$foldr, $elm$browser$Debugger$History$getHelp( update), A2( $elm$browser$Debugger$History$Stepping, index % $elm$browser$Debugger$History$maxSnapshotSize, model), messages)));}}}});
var $elm$url$Url$Parser$getFirstMatch = function(states){getFirstMatch: while (true ){if (! states.b ) return ( $elm$core$Maybe$Nothing); else{var state = states.a;var rest = states.b;var _v1 = state.unvisited;if (! _v1.b ) return ( $elm$core$Maybe$Just( state.value)); else if ( _v1.a ==='' &&! _v1.b.b ) return ( $elm$core$Maybe$Just( state.value)); else{var $temp$states = rest
...
var $elm$browser$Debugger$History$getRecentMsg = function(history){getRecentMsg: while (true ){var _v0 = history.recent.messages;if (! _v0.b ){var $temp$history = history
;history = $temp$history; continue getRecentMsg;} else{var first = _v0.a; return ( first);}}};
...
var $elm$browser$Debugger$Expando$mergeDictHelp = F3( function(oldDict,key,value){var _v12 = A2( $elm$core$Dict$get, key, oldDict);if ( _v12.$ ==='Nothing' ) return ( value); else{var oldValue = _v12.a; return ( A2( $elm$browser$Debugger$Expando$mergeHelp, oldValue, value));}});
var $elm$browser$Debugger$Expando$mergeHelp = F2( function(old,_new){var _v3 = _Utils_Tuple2( old, _new);_v3$6: while (true ) switch( _v3.b.$){ case 'S' : return ( _new); case 'Primitive' : return ( _new); case 'Sequence' :if ( _v3.a.$ ==='Sequence' ){var _v4 = _v3.a;var isClosed = _v4.b;var oldValues = _v4.c;var _v5 = _v3.b;var seqType = _v5.a;var newValues = _v5.c; return ( A3( $elm$browser$Debugger$Expando$Sequence, seqType, isClosed, A2( $elm$browser$Debugger$Expando$mergeListHelp, oldValues, newValues)));} else break _v3$6; case 'Dictionary' :if ( _v3.a.$ ==='Dictionary' ){var _v6 = _v3.a;var isClosed = _v6.a;var _v7 = _v3.b;var keyValuePairs = _v7.b; return ( A2( $elm$browser$Debugger$Expando$Dictionary, isClosed, keyValuePairs));} else break _v3$6; case 'Record' :if ( _v3.a.$ ==='Record' ){var _v8 = _v3.a;var isClosed = _v8.a;var oldDict = _v8.b;var _v9 = _v3.b;var newDict = _v9.b; return ( A2( $elm$browser$Debugger$Expando$Record, isClosed, A2( $elm$core$Dict$map, $elm$browser$Debugger$Expando$mergeDictHelp( oldDict), newDict)));} else break _v3$6; default :if ( _v3.a.$ ==='Constructor' ){var _v10 = _v3.a;var isClosed = _v10.b;var oldValues = _v10.c;var _v11 = _v3.b;var maybeName = _v11.a;var newValues = _v11.c; return ( A3( $elm$browser$Debugger$Expando$Constructor, maybeName, isClosed, A2( $elm$browser$Debugger$Expando$mergeListHelp, oldValues, newValues)));} else break _v3$6;} return ( _new);});
var $elm$browser$Debugger$Expando$mergeListHelp = F2( function(olds,news){var _v0 = _Utils_Tuple2( olds, news);if (! _v0.a.b ) return ( news); else if (! _v0.b.b ) return ( news); else{var _v1 = _v0.a;var x = _v1.a;var xs = _v1.b;var _v2 = _v0.b;var y = _v2.a;var ys = _v2.b; return ( A2( $elm$core$List$cons, A2( $elm$browser$Debugger$Expando$mergeHelp, x, y), A2( $elm$browser$Debugger$Expando$mergeListHelp, xs, ys)));}});
var $elm$url$Url$Parser$removeFinalEmpty = function(segments){if (! segments.b ) return ( _List_Nil); else if ( segments.a ==='' &&! segments.b.b ) return ( _List_Nil); else{var segment = segments.a;var rest = segments.b; return ( A2( $elm$core$List$cons, segment, $elm$url$Url$Parser$removeFinalEmpty( rest)));}};
...
var $elm$time$Time$toAdjustedMinutesHelp = F3( function(defaultOffset,posixMinutes,eras){toAdjustedMinutesHelp: while (true ){if (! eras.b ) return ( posixMinutes + defaultOffset); else{var era = eras.a;var olderEras = eras.b;if ( _Utils_cmp( era.start, posixMinutes) <0 ){ return ( posixMinutes + era.offset);} else{var $temp$eras = olderEras, $temp$posixMinutes = posixMinutes, $temp$defaultOffset = defaultOffset
...
var $elm$browser$Debugger$Expando$elideMiddle = function(str){ return (( $elm$core$String$length( str) <=18)? str: A2( $elm$core$String$left,8, str) +('...' + A2( $elm$core$String$right,8, str)));};
var $elm$core$Dict$isEmpty = function(dict){if ( dict.$ ==='RBEmpty_elm_builtin' ) return true; else return false;};
var $elm$browser$Debugger$Expando$viewExtraTinyRecord = F3( function(length,starter,entries){if (! entries.b ) return ( _Utils_Tuple2( length +1, _List_fromArray([ $elm$html$Html$text('}')]))); else{var field = entries.a;var rest = entries.b;var nextLength = length + $elm$core$String$length( field) +1;if ( nextLength >18 ){ return ( _Utils_Tuple2( length +2, _List_fromArray([ $elm$html$Html$text('â¦}')])));} else{var _v1 = A3( $elm$browser$Debugger$Expando$viewExtraTinyRecord, nextLength,',', rest);var finalLength = _v1.a;var otherHtmls = _v1.b; return ( _Utils_Tuple2( finalLength, A2( $elm$core$List$cons, $elm$html$Html$text( starter), A2( $elm$core$List$cons, A2( $elm$html$Html$span, _List_fromArray([ $elm$browser$Debugger$Expando$purple]), _List_fromArray([ $elm$html$Html$text( field)])), otherHtmls))));}}});
var $elm$browser$Debugger$Expando$viewTinyHelp = function(str){ return ( _Utils_Tuple2( $elm$core$String$length( str), _List_fromArray([ $elm$html$Html$text( str)])));};
...
var $elm$browser$Debugger$History$add = F3( function(msg,model,_v0){var snapshots = _v0.snapshots;var recent = _v0.recent;var numMessages = _v0.numMessages;var _v1 = A3( $elm$browser$Debugger$History$addRecent, msg, model, recent);if ( _v1.a.$ ==='Just' ){var snapshot = _v1.a.a;var newRecent = _v1.b; return ( A3( $elm$browser$Debugger$History$History, A2( $elm$core$Array$push, snapshot, snapshots), newRecent, numMessages +1));} else{var _v2 = _v1.a;var newRecent = _v1.b; return ( A3( $elm$browser$Debugger$History$History, snapshots, newRecent, numMessages +1));}});
var $elm$core$Basics$always = F2( function(a,_v0){ return ( a);});
var $elm$browser$Debugger$Metadata$checkAlias = F4( function(name,old,_new,changes){ return (( _Utils_eq( old.tipe, _new.tipe) && _Utils_eq( old.args, _new.args))? changes: A2( $elm$core$List$cons, $elm$browser$Debugger$Report$AliasChange( name), changes));});
var $elm$browser$Debugger$Metadata$addTag = F3( function(tag,_v0,changes){ return ( _Utils_update( changes,{added : A2( $elm$core$List$cons, tag, changes.added)}));});
var $elm$browser$Debugger$Metadata$checkTag = F4( function(tag,old,_new,changes){ return ( _Utils_eq( old, _new)? changes: _Utils_update( changes,{changed : A2( $elm$core$List$cons, tag, changes.changed)}));});
var $elm$browser$Debugger$Report$emptyTagChanges = function(argsMatch){ return ( A4( $elm$browser$Debugger$Report$TagChanges, _List_Nil, _List_Nil, _List_Nil, argsMatch));};
var $elm$browser$Debugger$Report$hasTagChanges = function(tagChanges){ return ( _Utils_eq( tagChanges, A4( $elm$browser$Debugger$Report$TagChanges, _List_Nil, _List_Nil, _List_Nil,true)));};
var $elm$browser$Debugger$Metadata$removeTag = F3( function(tag,_v0,changes){ return ( _Utils_update( changes,{removed : A2( $elm$core$List$cons, tag, changes.removed)}));});
var $elm$browser$Debugger$Metadata$checkUnion = F4( function(name,old,_new,changes){var tagChanges = A6( $elm$core$Dict$merge, $elm$browser$Debugger$Metadata$removeTag, $elm$browser$Debugger$Metadata$checkTag, $elm$browser$Debugger$Metadata$addTag, old.tags, _new.tags, $elm$browser$Debugger$Report$emptyTagChanges( _Utils_eq( old.args, _new.args))); return ( $elm$browser$Debugger$Report$hasTagChanges( tagChanges)? changes: A2( $elm$core$List$cons, A2( $elm$browser$Debugger$Report$UnionChange, name, tagChanges), changes));});
var $elm$browser$Debugger$Metadata$ignore = F3( function(key,value,report){ return ( report);});
var $elm$browser$Debugger$Metadata$checkTypes = F2( function(old,_new){ return ((! _Utils_eq( old.message, _new.message))? A2( $elm$browser$Debugger$Report$MessageChanged, old.message, _new.message): $elm$browser$Debugger$Report$SomethingChanged( A6( $elm$core$Dict$merge, $elm$browser$Debugger$Metadata$ignore, $elm$browser$Debugger$Metadata$checkUnion, $elm$browser$Debugger$Metadata$ignore, old.unions, _new.unions, A6( $elm$core$Dict$merge, $elm$browser$Debugger$Metadata$ignore, $elm$browser$Debugger$Metadata$checkAlias, $elm$browser$Debugger$Metadata$ignore, old.aliases, _new.aliases, _List_Nil))));});
var $elm$browser$Debugger$Metadata$check = F2( function(old,_new){ return ((! _Utils_eq( old.versions.elm, _new.versions.elm))? A2( $elm$browser$Debugger$Report$VersionChanged, old.versions.elm, _new.versions.elm): A2( $elm$browser$Debugger$Metadata$checkTypes, old.types, _new.types));});
var $elm$browser$Debugger$Overlay$corruptImport = $elm$browser$Debugger$Overlay$BadImport( $elm$browser$Debugger$Report$CorruptHistory);
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $elm$core$List$isEmpty = function(xs){if (! xs.b ) return true; else return false;};
var $elm$browser$Debugger$Report$some = function(list){ return (! $elm$core$List$isEmpty( list));};
var $elm$browser$Debugger$Report$evaluateChange = function(change){if ( change.$ ==='AliasChange' ) return ( $elm$browser$Debugger$Report$Impossible); else{var removed = change.b.removed;var changed = change.b.changed;var added = change.b.added;var argsMatch = change.b.argsMatch; return ((! argsMatch || $elm$browser$Debugger$Report$some( changed) || $elm$browser$Debugger$Report$some( removed))? $elm$browser$Debugger$Report$Impossible: $elm$browser$Debugger$Report$some( added)? $elm$browser$Debugger$Report$Risky: $elm$browser$Debugger$Report$Fine);}};
var $elm$browser$Debugger$Report$evaluate = function(report){ switch( report.$){ case 'CorruptHistory' : return ( $elm$browser$Debugger$Report$Impossible); case 'VersionChanged' : return ( $elm$browser$Debugger$Report$Impossible); case 'MessageChanged' : return ( $elm$browser$Debugger$Report$Impossible); default :var changes = report.a; return ( A2( $elm$browser$Debugger$Report$worstCase, $elm$browser$Debugger$Report$Fine, A2( $elm$core$List$map, $elm$browser$Debugger$Report$evaluateChange, changes)));}};
...
var $elm$browser$Debugger$Overlay$uploadDecoder = A3( $elm$json$Json$Decode$map2, F2( function(x,y){ return ( _Utils_Tuple2( x, y));}), A2( $elm$json$Json$Decode$field,'metadata', $elm$browser$Debugger$Metadata$decoder), A2( $elm$json$Json$Decode$field,'history', $elm$json$Json$Decode$value));
var $elm$browser$Debugger$Overlay$assessImport = F2( function(metadata,jsonString){var _v0 = A2( $elm$json$Json$Decode$decodeString, $elm$browser$Debugger$Overlay$uploadDecoder, jsonString);if ( _v0.$ ==='Err' ) return ( $elm$core$Result$Err( $elm$browser$Debugger$Overlay$corruptImport)); else{var _v1 = _v0.a;var foreignMetadata = _v1.a;var rawHistory = _v1.b;var report = A2( $elm$browser$Debugger$Metadata$check, foreignMetadata, metadata);var _v2 = $elm$browser$Debugger$Report$evaluate( report); switch( _v2.$){ case 'Impossible' : return ( $elm$core$Result$Err( $elm$browser$Debugger$Overlay$BadImport( report))); case 'Risky' : return ( $elm$core$Result$Err( A2( $elm$browser$Debugger$Overlay$RiskyImport, report, rawHistory))); default : return ( $elm$core$Result$Ok( rawHistory));}}});
var $elm$browser$Debugger$Overlay$close = F2( function(msg,state){ switch( state.$){ case 'None' : return ( $elm$core$Maybe$Nothing); case 'BadMetadata' : return ( $elm$core$Maybe$Nothing); case 'BadImport' : return ( $elm$core$Maybe$Nothing); default :var rawHistory = state.b;if ( msg.$ ==='Cancel' ) return ( $elm$core$Maybe$Nothing); else return ( $elm$core$Maybe$Just( rawHistory));}});
...
var $elm$browser$Debugger$History$encodeHelp = F2( function(snapshot,allMessages){ return ( A3( $elm$core$Array$foldl, $elm$core$List$cons, allMessages, snapshot.messages));});
...
var $elm$browser$Debugger$History$encode = function(_v0){var snapshots = _v0.snapshots;var recent = _v0.recent; return ( A2( $elm$json$Json$Encode$list, $elm$browser$Debugger$History$elmToJs, A3( $elm$core$Array$foldr, $elm$browser$Debugger$History$encodeHelp, $elm$core$List$reverse( recent.messages), snapshots)));};
...
var $elm$browser$Debugger$Metadata$encodeAlias = function(_v0){var args = _v0.args;var tipe = _v0.tipe; return ( $elm$json$Json$Encode$object( _List_fromArray([ _Utils_Tuple2('args', A2( $elm$json$Json$Encode$list, $elm$json$Json$Encode$string, args)) , _Utils_Tuple2('type', $elm$json$Json$Encode$string( tipe))])));};
var $elm$browser$Debugger$Metadata$encodeDict = F2( function(f,dict){ return ( $elm$json$Json$Encode$object( $elm$core$Dict$toList( A2( $elm$core$Dict$map, F2( function(key,value){ return ( f( value));}), dict))));});
var $elm$browser$Debugger$Metadata$encodeUnion = function(_v0){var args = _v0.args;var tags = _v0.tags; return ( $elm$json$Json$Encode$object( _List_fromArray([ _Utils_Tuple2('args', A2( $elm$json$Json$Encode$list, $elm$json$Json$Encode$string, args)) , _Utils_Tuple2('tags', A2( $elm$browser$Debugger$Metadata$encodeDict, $elm$json$Json$Encode$list( $elm$json$Json$Encode$string), tags))])));};
...
var $elm$browser$Debugger$Metadata$encodeVersions = function(_v0){var elm = _v0.elm; return ( $elm$json$Json$Encode$object( _List_fromArray([ _Utils_Tuple2('elm', $elm$json$Json$Encode$string( elm))])));};
var $elm$browser$Debugger$Metadata$encode = function(_v0){var versions = _v0.versions;var types = _v0.types; return ( $elm$json$Json$Encode$object( _List_fromArray([ _Utils_Tuple2('versions', $elm$browser$Debugger$Metadata$encodeVersions( versions)) , _Utils_Tuple2('types', $elm$browser$Debugger$Metadata$encodeTypes( types))])));};
var $elm$browser$Debugger$History$size = function(history){ return ( history.numMessages);};
var $elm$browser$Debugger$Main$download = F2( function(metadata,history){var historyLength = $elm$browser$Debugger$History$size( history); return ( A2( $elm$core$Task$perform, function(_v0){ return ( $elm$browser$Debugger$Main$NoOp);}, A2( _Debugger_download, historyLength, _Json_unwrap( $elm$json$Json$Encode$object( _List_fromArray([ _Utils_Tuple2('metadata', $elm$browser$Debugger$Metadata$encode( metadata)) , _Utils_Tuple2('history', $elm$browser$Debugger$History$encode( history))]))))));});
var $elm$browser$Debugger$Main$drag = F2( function(info,layout){if ( layout.$ ==='Horizontal' ){var status = layout.a;var y = layout.c; return ( A3( $elm$browser$Debugger$Main$Horizontal, status, info.x / info.width, y));} else{var status = layout.a;var x = layout.b; return ( A3( $elm$browser$Debugger$Main$Vertical, status, x, info.y / info.height));}});
var $elm$browser$Debugger$Main$getLatestModel = function(state){if ( state.$ ==='Running' ){var model = state.a; return ( model);} else{var model = state.c; return ( model);}};
var $elm$browser$Debugger$History$idForMessageIndex = function(index){ return ('msg-' + $elm$core$String$fromInt( index));};
var $elm$browser$Debugger$Main$cachedHistory = function(model){var _v0 = model.state;if ( _v0.$ ==='Running' ) return ( model.history); else{var history = _v0.e; return ( history);}};
var $elm$browser$Debugger$Expando$merge = F2( function(value,expando){ return ( A2( $elm$browser$Debugger$Expando$mergeHelp, expando, _Debugger_init( value)));});
var $elm$browser$Debugger$Main$jumpUpdate = F3( function(update,index,model){var history = $elm$browser$Debugger$Main$cachedHistory( model);var currentMsg = $elm$browser$Debugger$History$getRecentMsg( history);var currentModel = $elm$browser$Debugger$Main$getLatestModel( model.state);var _v0 = A3( $elm$browser$Debugger$History$get, update, index, history);var indexModel = _v0.a;var indexMsg = _v0.b; return ( _Utils_update( model,{state : A5( $elm$browser$Debugger$Main$Paused, index, indexModel, currentModel, currentMsg, history),expandoMsg : A2( $elm$browser$Debugger$Expando$merge, indexMsg, model.expandoMsg),expandoModel : A2( $elm$browser$Debugger$Expando$merge, indexModel, model.expandoModel)}));});
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$browser$Debugger$History$empty = function(model){ return ( A3( $elm$browser$Debugger$History$History, $elm$core$Array$empty, A3( $elm$browser$Debugger$History$RecentHistory, model, _List_Nil,0),0));};
...
var $elm$browser$Debugger$History$getInitialModel = function(_v0){var snapshots = _v0.snapshots;var recent = _v0.recent;var _v1 = A2( $elm$core$Array$get,0, snapshots);if ( _v1.$ ==='Just' ){var model = _v1.a.model; return ( model);} else return ( recent.model);};
var $elm$browser$Debugger$Expando$init = function(value){ return ( A2( $elm$browser$Debugger$Expando$initHelp,true, _Debugger_init( value)));};
var $elm$browser$Debugger$Overlay$none = $elm$browser$Debugger$Overlay$None;
var $elm$browser$Debugger$Main$loadNewHistory = F3( function(rawHistory,update,model){var pureUserUpdate = F2( function(msg,userModel){ return ( A2( update, msg, userModel).a);});var initialUserModel = $elm$browser$Debugger$History$getInitialModel( model.history);var decoder = A2( $elm$browser$Debugger$History$decoder, initialUserModel, pureUserUpdate);var _v0 = A2( $elm$json$Json$Decode$decodeValue, decoder, rawHistory);if ( _v0.$ ==='Err' ) return ( _Utils_Tuple2( _Utils_update( model,{overlay : $elm$browser$Debugger$Overlay$corruptImport}), $elm$core$Platform$Cmd$none)); else{var _v1 = _v0.a;var latestUserModel = _v1.a;var newHistory = _v1.b; return ( _Utils_Tuple2( _Utils_update( model,{state : $elm$browser$Debugger$Main$Running( latestUserModel),overlay : $elm$browser$Debugger$Overlay$none,history : newHistory,expandoMsg : $elm$browser$Debugger$Expando$init( $elm$browser$Debugger$History$getRecentMsg( newHistory)),expandoModel : $elm$browser$Debugger$Expando$init( latestUserModel)}), $elm$core$Platform$Cmd$none));}});
var $elm$core$Platform$Cmd$map = _Platform_map;
var $elm$browser$Debugger$Main$scroll = function(popout){ return ( A2( $elm$core$Task$perform, $elm$core$Basics$always( $elm$browser$Debugger$Main$NoOp), _Debugger_scroll( popout)));};
var $elm$browser$Debugger$Main$scrollTo = F2( function(id,popout){ return ( A2( $elm$core$Task$perform, $elm$core$Basics$always( $elm$browser$Debugger$Main$NoOp), A2( _Debugger_scrollTo, id, popout)));});
var $elm$browser$Debugger$Main$setDragStatus = F2( function(status,layout){if ( layout.$ ==='Horizontal' ){var x = layout.b;var y = layout.c; return ( A3( $elm$browser$Debugger$Main$Horizontal, status, x, y));} else{var x = layout.b;var y = layout.c; return ( A3( $elm$browser$Debugger$Main$Vertical, status, x, y));}});
var $elm$browser$Debugger$Main$swapLayout = function(layout){if ( layout.$ ==='Horizontal' ){var s = layout.a;var x = layout.b;var y = layout.c; return ( A3( $elm$browser$Debugger$Main$Vertical, s, x, y));} else{var s = layout.a;var x = layout.b;var y = layout.c; return ( A3( $elm$browser$Debugger$Main$Horizontal, s, x, y));}};
var $elm$browser$Debugger$Main$upload = function(popout){ return ( A2( $elm$core$Task$perform, $elm$browser$Debugger$Main$Upload, _Debugger_upload( popout)));};
var $elm$browser$Debugger$Overlay$badMetadata = $elm$browser$Debugger$Overlay$BadMetadata;
var $elm$browser$Debugger$Main$withGoodMetadata = F2( function(model,func){var _v0 = model.metadata;if ( _v0.$ ==='Ok' ){var metadata = _v0.a; return ( func( metadata));} else{var error = _v0.a; return ( _Utils_Tuple2( _Utils_update( model,{overlay : $elm$browser$Debugger$Overlay$badMetadata( error)}), $elm$core$Platform$Cmd$none));}});
var $elm$browser$Debugger$Main$wrapUpdate = F3( function(update,msg,model){wrapUpdate: while (true ){ switch( msg.$){ case 'NoOp' : return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none)); case 'UserMsg' :var userMsg = msg.a;var userModel = $elm$browser$Debugger$Main$getLatestModel( model.state);var newHistory = A3( $elm$browser$Debugger$History$add, userMsg, userModel, model.history);var _v1 = A2( update, userMsg, userModel);var newUserModel = _v1.a;var userCmds = _v1.b;var commands = A2( $elm$core$Platform$Cmd$map, $elm$browser$Debugger$Main$UserMsg, userCmds);var _v2 = model.state;if ( _v2.$ ==='Running' ) return ( _Utils_Tuple2( _Utils_update( model,{state : $elm$browser$Debugger$Main$Running( newUserModel),history : newHistory,expandoMsg : A2( $elm$browser$Debugger$Expando$merge, userMsg, model.expandoMsg),expandoModel : A2( $elm$browser$Debugger$Expando$merge, newUserModel, model.expandoModel)}), $elm$core$Platform$Cmd$batch( _List_fromArray([ commands , $elm$browser$Debugger$Main$scroll( model.popout)])))); else{var index = _v2.a;var indexModel = _v2.b;var history = _v2.e; return ( _Utils_Tuple2( _Utils_update( model,{state : A5( $elm$browser$Debugger$Main$Paused, index, indexModel, newUserModel, userMsg, history),history : newHistory}), commands));} case 'TweakExpandoMsg' :var eMsg = msg.a; return ( _Utils_Tuple2( _Utils_update( model,{expandoMsg : A2( $elm$browser$Debugger$Expando$update, eMsg, model.expandoMsg)}), $elm$core$Platform$Cmd$none)); case 'TweakExpandoModel' :var eMsg = msg.a; return ( _Utils_Tuple2( _Utils_update( model,{expandoModel : A2( $elm$browser$Debugger$Expando$update, eMsg, model.expandoModel)}), $elm$core$Platform$Cmd$none)); case 'Resume' :var _v3 = model.state;if ( _v3.$ ==='Running' ) return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none)); else{var userModel = _v3.c;var userMsg = _v3.d; return ( _Utils_Tuple2( _Utils_update( model,{state : $elm$browser$Debugger$Main$Running( userModel),expandoMsg : A2( $elm$browser$Debugger$Expando$merge, userMsg, model.expandoMsg),expandoModel : A2( $elm$browser$Debugger$Expando$merge, userModel, model.expandoModel)}), $elm$browser$Debugger$Main$scroll( model.popout)));} case 'Jump' :var index = msg.a; return ( _Utils_Tuple2( A3( $elm$browser$Debugger$Main$jumpUpdate, update, index, model), $elm$core$Platform$Cmd$none)); case 'SliderJump' :var index = msg.a; return ( _Utils_Tuple2( A3( $elm$browser$Debugger$Main$jumpUpdate, update, index, model), A2( $elm$browser$Debugger$Main$scrollTo, $elm$browser$Debugger$History$idForMessageIndex( index), model.popout))); case 'Open' : return ( _Utils_Tuple2( model, A2( $elm$core$Task$perform, $elm$core$Basics$always( $elm$browser$Debugger$Main$NoOp), _Debugger_open( model.popout)))); case 'Up' :var _v4 = model.state;if ( _v4.$ ==='Running' ) return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none)); else{var i = _v4.a;var history = _v4.e;var targetIndex = i +1;if ( _Utils_cmp( targetIndex, $elm$browser$Debugger$History$size( history)) <0 ){var $temp$model = model, $temp$msg = $elm$browser$Debugger$Main$SliderJump( targetIndex), $temp$update = update
;update = $temp$update;msg = $temp$msg;model = $temp$model; continue wrapUpdate;} else{var $temp$model = model, $temp$msg = $elm$browser$Debugger$Main$Resume, $temp$update = update
;update = $temp$update;msg = $temp$msg;model = $temp$model; continue wrapUpdate;}} case 'Down' :var _v5 = model.state;if ( _v5.$ ==='Running' ){var $temp$model = model, $temp$msg = $elm$browser$Debugger$Main$Jump( $elm$browser$Debugger$History$size( model.history) -1), $temp$update = update
;update = $temp$update;msg = $temp$msg;model = $temp$model; continue wrapUpdate;} else{var index = _v5.a;if ( index >0 ){var $temp$model = model, $temp$msg = $elm$browser$Debugger$Main$SliderJump( index -1), $temp$update = update
;update = $temp$update;msg = $temp$msg;model = $temp$model; continue wrapUpdate;} else{ return ( _Utils_Tuple2( model, $elm$core$Platform$Cmd$none));}} case 'Import' : return ( A2( $elm$browser$Debugger$Main$withGoodMetadata, model, function(_v6){ return ( _Utils_Tuple2( model, $elm$browser$Debugger$Main$upload( model.popout)));})); case 'Export' : return ( A2( $elm$browser$Debugger$Main$withGoodMetadata, model, function(metadata){ return ( _Utils_Tuple2( model, A2( $elm$browser$Debugger$Main$download, metadata, model.history)));})); case 'Upload' :var jsonString = msg.a; return ( A2( $elm$browser$Debugger$Main$withGoodMetadata, model, function(metadata){var _v7 = A2( $elm$browser$Debugger$Overlay$assessImport, metadata, jsonString);if ( _v7.$ ==='Err' ){var newOverlay = _v7.a; return ( _Utils_Tuple2( _Utils_update( model,{overlay : newOverlay}), $elm$core$Platform$Cmd$none));} else{var rawHistory = _v7.a; return ( A3( $elm$browser$Debugger$Main$loadNewHistory, rawHistory, update, model));}})); case 'OverlayMsg' :var overlayMsg = msg.a;var _v8 = A2( $elm$browser$Debugger$Overlay$close, overlayMsg, model.overlay);if ( _v8.$ ==='Nothing' ) return ( _Utils_Tuple2( _Utils_update( model,{overlay : $elm$browser$Debugger$Overlay$none}), $elm$core$Platform$Cmd$none)); else{var rawHistory = _v8.a; return ( A3( $elm$browser$Debugger$Main$loadNewHistory, rawHistory, update, model));} case 'SwapLayout' : return ( _Utils_Tuple2( _Utils_update( model,{layout : $elm$browser$Debugger$Main$swapLayout( model.layout)}), $elm$core$Platform$Cmd$none)); case 'DragStart' : return ( _Utils_Tuple2( _Utils_update( model,{layout : A2( $elm$browser$Debugger$Main$setDragStatus, $elm$browser$Debugger$Main$Moving, model.layout)}), $elm$core$Platform$Cmd$none)); case 'Drag' :var info = msg.a; return ( _Utils_Tuple2( _Utils_update( model,{layout : A2( $elm$browser$Debugger$Main$drag, info, model.layout)}), $elm$core$Platform$Cmd$none)); default : return ( _Utils_Tuple2( _Utils_update( model,{layout : A2( $elm$browser$Debugger$Main$setDragStatus, $elm$browser$Debugger$Main$Static, model.layout)}), $elm$core$Platform$Cmd$none));};}});
var $elm$html$Html$a = _VirtualDom_node('a');
var $elm$html$Html$abbr = _VirtualDom_node('abbr');
var $elm$core$Basics$abs = function(n){ return (( n <0)?(- n): n);};
var $elm$url$Url$Builder$toQueryPair = function(_v0){var key = _v0.a;var value = _v0.b; return ( key +('=' + value));};
var $elm$url$Url$Builder$toQuery = function(parameters){if (! parameters.b ) return ''; else return ('?' + A2( $elm$core$String$join,'&', A2( $elm$core$List$map, $elm$url$Url$Builder$toQueryPair, parameters)));};
var $elm$url$Url$Builder$absolute = F2( function(pathSegments,parameters){ return ('/' +( A2( $elm$core$String$join,'/', pathSegments) + $elm$url$Url$Builder$toQuery( parameters)));});
...
var $user$project$AudioFFI$addAudioWorkletModule = FFI.addAudioWorkletModule;
var $elm$browser$Debugger$Overlay$addCommas = function(items){if (! items.b ) return ''; else if (! items.b.b ){var item = items.a; return ( item);} else if (! items.b.b.b ){var item1 = items.a;var _v1 = items.b;var item2 = _v1.a; return ( item1 +(' and ' + item2));} else{var lastItem = items.a;var otherItems = items.b; return ( A2( $elm$core$String$join,', ', _Utils_ap( otherItems, _List_fromArray([' and ' + lastItem]))));}};
var $elm$url$Url$Parser$addToParametersHelp = F2( function(value,maybeList){if ( maybeList.$ ==='Nothing' ) return ( $elm$core$Maybe$Just( _List_fromArray([ value]))); else{var list = maybeList.a; return ( $elm$core$Maybe$Just( A2( $elm$core$List$cons, value, list)));}});
var $elm$url$Url$percentDecode = _Url_percentDecode;
var $elm$url$Url$Parser$addParam = F2( function(segment,dict){var _v0 = A2( $elm$core$String$split,'=', segment);if ( _v0.b && _v0.b.b &&! _v0.b.b.b ){var rawKey = _v0.a;var _v1 = _v0.b;var rawValue = _v1.a;var _v2 = $elm$url$Url$percentDecode( rawKey);if ( _v2.$ ==='Nothing' ) return ( dict); else{var key = _v2.a;var _v3 = $elm$url$Url$percentDecode( rawValue);if ( _v3.$ ==='Nothing' ) return ( dict); else{var value = _v3.a; return ( A3( $elm$core$Dict$update, key, $elm$url$Url$Parser$addToParametersHelp( value), dict));}}} else return ( dict);});
var $elm$url$Url$addPort = F2( function(maybePort,starter){if ( maybePort.$ ==='Nothing' ) return ( starter); else{var port_ = maybePort.a; return ( starter +(':' + $elm$core$String$fromInt( port_)));}});
var $elm$url$Url$addPrefixed = F3( function(prefix,maybeSegment,starter){if ( maybeSegment.$ ==='Nothing' ) return ( starter); else{var segment = maybeSegment.a; return ( _Utils_ap( starter, _Utils_ap( prefix, segment)));}});
...
var $elm$browser$Browser$Navigation$back = F2( function(key,n){ return ( A2( _Browser_go, key,- n));});
...
var $user$project$AudioFFI$cancelAndHoldAtTime = FFI.cancelAndHoldAtTime;
var $user$project$AudioFFI$cancelScheduledValues = FFI.cancelScheduledValues;
...
var $user$project$AudioFFI$cloneAudioBuffer = FFI.cloneAudioBuffer;
var $user$project$AudioFFI$closeAudioContext = FFI.closeAudioContext;
var $elm$html$Html$code = _VirtualDom_node('code');
var $elm$html$Html$col = _VirtualDom_node('col');
var $elm$html$Html$colgroup = _VirtualDom_node('colgroup');
var $elm$browser$Debugger$Metadata$hasProblem = F2( function(tipe,_v0){var problem = _v0.a;var token = _v0.b; return ( A2( $elm$core$String$contains, token, tipe)? $elm$core$Maybe$Just( problem): $elm$core$Maybe$Nothing);});
...
var $elm$browser$Debugger$Metadata$findProblems = function(tipe){ return ( A2( $elm$core$List$filterMap, $elm$browser$Debugger$Metadata$hasProblem( tipe), $elm$browser$Debugger$Metadata$problemTable));};
var $elm$browser$Debugger$Metadata$collectBadAliases = F3( function(name,_v0,list){var tipe = _v0.tipe;var _v1 = $elm$browser$Debugger$Metadata$findProblems( tipe);if (! _v1.b ) return ( list); else{var problems = _v1; return ( A2( $elm$core$List$cons, A2( $elm$browser$Debugger$Metadata$ProblemType, name, problems), list));}});
...
var $elm$browser$Debugger$History$viewSnapshot = F3( function(selectedIndex,index,_v0){var messages = _v0.messages; return ( A3( $elm$html$Html$Keyed$node,'div', _List_Nil, A3( $elm$core$Array$foldr, $elm$browser$Debugger$History$consMsg( selectedIndex), _Utils_Tuple2( index, _List_Nil), messages).b));});
var $elm$browser$Debugger$History$consSnapshot = F3( function(selectedIndex,snapshot,_v0){var index = _v0.a;var rest = _v0.b;var nextIndex = index + $elm$core$Array$length( snapshot.messages);var selectedIndexHelp =( _Utils_cmp( nextIndex, selectedIndex) >0 && _Utils_cmp( selectedIndex, index) >-1)? selectedIndex:-1; return ( _Utils_Tuple2( nextIndex, A2( $elm$core$List$cons, A4( $elm$html$Html$Lazy$lazy3, $elm$browser$Debugger$History$viewSnapshot, selectedIndexHelp, index, snapshot), rest)));});
var $user$project$Capability$consumeUserActivation = CapabilityFFI.consumeUserActivation;
...
var $user$project$AudioFFI$copyFromChannel = FFI.copyFromChannel;
var $user$project$AudioFFI$copyToChannel = FFI.copyToChannel;
var $elm$browser$Debugger$Main$isPaused = function(state){if ( state.$ ==='Running' ) return false; else return true;};
...
var $elm$browser$Debugger$Overlay$viewCode = function(name){ return ( A2( $elm$html$Html$code, _List_Nil, _List_fromArray([ $elm$html$Html$text( name)])));};
var $elm$browser$Debugger$Overlay$problemToString = function(problem){ switch( problem.$){ case 'Function' : return 'functions'; case 'Decoder' : return 'JSON decoders'; case 'Task' : return 'tasks'; case 'Process' : return 'processes'; case 'Socket' : return 'web sockets'; case 'Request' : return 'HTTP requests'; case 'Program' : return 'programs'; default : return 'virtual DOM values';}};
var $elm$browser$Debugger$Overlay$viewProblemType = function(_v0){var name = _v0.name;var problems = _v0.problems; return ( A2( $elm$html$Html$li, _List_Nil, _List_fromArray([ $elm$browser$Debugger$Overlay$viewCode( name) , $elm$html$Html$text(' can contain ' +( $elm$browser$Debugger$Overlay$addCommas( A2( $elm$core$List$map, $elm$browser$Debugger$Overlay$problemToString, problems)) +'.'))])));};
...
var $user$project$AudioFFI$createAudioBuffer = FFI.createAudioBuffer;
var $user$project$AudioFFI$createAudioWorkletNode = FFI.createAudioWorkletNode;
var $user$project$AudioFFI$createBiquadFilter = FFI.createBiquadFilter;
var $user$project$AudioFFI$createBufferFromSamples = FFI.createBufferFromSamples;
var $user$project$AudioFFI$createBufferSource = FFI.createBufferSource;
...
var $user$project$AudioFFI$createConstantSource = FFI.createConstantSource;
var $user$project$AudioFFI$createConvolver = FFI.createConvolver;
var $user$project$AudioFFI$createDelay = FFI.createDelay;
var $user$project$AudioFFI$createDynamicsCompressor = FFI.createDynamicsCompressor;
var $user$project$AudioFFI$createEmptyBuffer = FFI.createEmptyBuffer;
var $user$project$AudioFFI$createIIRFilter = FFI.createIIRFilter;
var $user$project$AudioFFI$createMediaElementSource = FFI.createMediaElementSource;
var $user$project$AudioFFI$createMediaStreamDestination = FFI.createMediaStreamDestination;
var $user$project$AudioFFI$createMediaStreamSource = FFI.createMediaStreamSource;
var $user$project$AudioFFI$createOfflineAudioContext = FFI.createOfflineAudioContext;
var $user$project$AudioFFI$createPanner = FFI.createPanner;
var $user$project$AudioFFI$createPeriodicWave = FFI.createPeriodicWave;
var $user$project$AudioFFI$createPeriodicWaveWithCoefficients = FFI.createPeriodicWaveWithCoefficients;
var $user$project$AudioFFI$createPeriodicWaveWithOptions = FFI.createPeriodicWaveWithOptions;
var $user$project$AudioFFI$createSilentBuffer = FFI.createSilentBuffer;
var $user$project$AudioFFI$createStereoPanner = FFI.createStereoPanner;
...
var $elm$url$Url$Builder$custom = F4( function(root,pathSegments,parameters,maybeFragment){var fragmentless = _Utils_ap( $elm$url$Url$Builder$rootToPrePath( root), _Utils_ap( A2( $elm$core$String$join,'/', pathSegments), $elm$url$Url$Builder$toQuery( parameters)));if ( maybeFragment.$ ==='Nothing' ) return ( fragmentless); else{var fragment = maybeFragment.a; return ( fragmentless +('#' + fragment));}});
var $elm$url$Url$Parser$custom = F2( function(tipe,stringToSomething){ return ( $elm$url$Url$Parser$Parser( function(_v0){var visited = _v0.visited;var unvisited = _v0.unvisited;var params = _v0.params;var frag = _v0.frag;var value = _v0.value;if (! unvisited.b ) return ( _List_Nil); else{var next = unvisited.a;var rest = unvisited.b;var _v2 = stringToSomething( next);if ( _v2.$ ==='Just' ){var nextValue = _v2.a; return ( _List_fromArray([ A5( $elm$url$Url$Parser$State, A2( $elm$core$List$cons, next, visited), rest, params, frag, value( nextValue))]));} else return ( _List_Nil);}}));});
var $elm$url$Url$Parser$Query$custom = F2( function(key,func){ return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( func( A2( $elm$core$Maybe$withDefault, _List_Nil, A2( $elm$core$Dict$get, key, dict))));}));});
...
var $elm$browser$Debugger$Metadata$decode = function(value){var _v0 = A2( $elm$json$Json$Decode$decodeValue, $elm$browser$Debugger$Metadata$decoder, value);if ( _v0.$ ==='Err' ) return ( $elm$core$Result$Err( A2( $elm$browser$Debugger$Metadata$Error,'The compiler is generating bad metadata. This is a compiler bug!', _List_Nil))); else{var metadata = _v0.a;var _v1 = $elm$browser$Debugger$Metadata$isPortable( metadata);if ( _v1.$ ==='Nothing' ) return ( $elm$core$Result$Ok( metadata)); else{var error = _v1.a; return ( $elm$core$Result$Err( error));}}};
var $user$project$AudioFFI$decodeAudioData = FFI.decodeAudioData;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$browser$Debugger$Main$decodeDimension = function(field){ return ( A2( $elm$json$Json$Decode$at, _List_fromArray(['currentTarget' ,'ownerDocument' ,'defaultView' , field]), $elm$json$Json$Decode$float));};
...
var $user$project$AudioFFI$disconnectNode = FFI.disconnectNode;
var $user$project$AudioFFI$disconnectNodeFromDestination = FFI.disconnectNodeFromDestination;
var $user$project$AudioFFI$disconnectNodeFromNodeChannel = FFI.disconnectNodeFromNodeChannel;
var $user$project$AudioFFI$disconnectNodeOutput = FFI.disconnectNodeOutput;
...
var $elm$url$Url$Parser$Query$enum = F2( function(key,dict){ return ( A2( $elm$url$Url$Parser$Query$custom, key, function(stringList){if ( stringList.b &&! stringList.b.b ){var str = stringList.a; return ( A2( $elm$core$Dict$get, str, dict));} else return ( $elm$core$Maybe$Nothing);}));});
var $elm$time$Time$every = F2( function(interval,tagger){ return ( $elm$time$Time$subscription( A2( $elm$time$Time$Every, interval, tagger)));});
var $user$project$AudioFFI$exponentialRampToValue = FFI.exponentialRampToValue;
var $user$project$AudioFFI$exponentialRampToValueAtTime = FFI.exponentialRampToValueAtTime;
...
var $elm$time$Time$flooredDiv = F2( function(numerator,denominator){ return ( $elm$core$Basics$floor( numerator / denominator));});
...
var $user$project$AudioFFI$getAnalyserFFTSize = FFI.getAnalyserFFTSize;
var $user$project$AudioFFI$getAnalyserFrequencyBinCount = FFI.getAnalyserFrequencyBinCount;
var $user$project$AudioFFI$getAnalyserMaxDecibels = FFI.getAnalyserMaxDecibels;
var $user$project$AudioFFI$getAnalyserMinDecibels = FFI.getAnalyserMinDecibels;
var $user$project$AudioFFI$getAnalyserSmoothingTimeConstant = FFI.getAnalyserSmoothingTimeConstant;
var $user$project$AudioFFI$getAudioListener = FFI.getAudioListener;
var $user$project$AudioFFI$getAudioParamAutomationRate = FFI.getAudioParamAutomationRate;
var $user$project$AudioFFI$getAudioParamDefaultValue = FFI.getAudioParamDefaultValue;
var $user$project$AudioFFI$getAudioParamMaxValue = FFI.getAudioParamMaxValue;
var $user$project$AudioFFI$getAudioParamMinValue = FFI.getAudioParamMinValue;
var $user$project$AudioFFI$getAudioParamValue = FFI.getAudioParamValue;
var $user$project$AudioFFI$getBiquadFilterDetuneParam = FFI.getBiquadFilterDetuneParam;
var $user$project$AudioFFI$getBiquadFilterFrequencyParam = FFI.getBiquadFilterFrequencyParam;
var $user$project$AudioFFI$getBiquadFilterGainParam = FFI.getBiquadFilterGainParam;
var $user$project$AudioFFI$getBiquadFilterQParam = FFI.getBiquadFilterQParam;
var $user$project$AudioFFI$getBiquadFilterType = FFI.getBiquadFilterType;
var $user$project$AudioFFI$getBufferAsArray = FFI.getBufferAsArray;
var $user$project$AudioFFI$getBufferChannels = FFI.getBufferChannels;
var $user$project$AudioFFI$getBufferDuration = FFI.getBufferDuration;
var $user$project$AudioFFI$getBufferLength = FFI.getBufferLength;
var $user$project$AudioFFI$getBufferPeak = FFI.getBufferPeak;
var $user$project$AudioFFI$getBufferRMS = FFI.getBufferRMS;
var $user$project$AudioFFI$getBufferSampleRate = FFI.getBufferSampleRate;
var $user$project$AudioFFI$getBufferSourceBuffer = FFI.getBufferSourceBuffer;
var $user$project$AudioFFI$getBufferSourceDetune = FFI.getBufferSourceDetune;
var $user$project$AudioFFI$getBufferSourceLoop = FFI.getBufferSourceLoop;
var $user$project$AudioFFI$getBufferSourceLoopEnd = FFI.getBufferSourceLoopEnd;
var $user$project$AudioFFI$getBufferSourceLoopStart = FFI.getBufferSourceLoopStart;
var $user$project$AudioFFI$getBufferSourcePlaybackRate = FFI.getBufferSourcePlaybackRate;
...
var $user$project$AudioFFI$getChannelData = FFI.getChannelData;
var $user$project$AudioFFI$getCompressorAttackParam = FFI.getCompressorAttackParam;
var $user$project$AudioFFI$getCompressorKneeParam = FFI.getCompressorKneeParam;
var $user$project$AudioFFI$getCompressorRatioParam = FFI.getCompressorRatioParam;
var $user$project$AudioFFI$getCompressorReduction = FFI.getCompressorReduction;
var $user$project$AudioFFI$getCompressorReleaseParam = FFI.getCompressorReleaseParam;
var $user$project$AudioFFI$getCompressorThresholdParam = FFI.getCompressorThresholdParam;
var $user$project$AudioFFI$getConstantSourceOffset = FFI.getConstantSourceOffset;
var $user$project$AudioFFI$getConstantSourceOffsetValue = FFI.getConstantSourceOffsetValue;
var $user$project$AudioFFI$getContextAudioListener = FFI.getContextAudioListener;
var $user$project$AudioFFI$getContextBaseLatency = FFI.getContextBaseLatency;
var $user$project$AudioFFI$getContextDestination = FFI.getContextDestination;
var $user$project$AudioFFI$getContextOutputLatency = FFI.getContextOutputLatency;
var $user$project$AudioFFI$getContextState = FFI.getContextState;
var $user$project$AudioFFI$getConvolverBuffer = FFI.getConvolverBuffer;
var $user$project$AudioFFI$getConvolverNormalize = FFI.getConvolverNormalize;
...
var $user$project$AudioFFI$getDelayDelayTimeParam = FFI.getDelayDelayTimeParam;
var $user$project$AudioFFI$getDelayMaxDelayTime = FFI.getDelayMaxDelayTime;
var $user$project$AudioFFI$getDetuneParam = FFI.getDetuneParam;
...
var $user$project$AudioFFI$getFrequencyParam = FFI.getFrequencyParam;
var $user$project$AudioFFI$getGainNodeGainParam = FFI.getGainNodeGainParam;
var $user$project$AudioFFI$getGainParam = FFI.getGainParam;
var $user$project$AudioFFI$getIIRFilterResponse = FFI.getIIRFilterResponse;
var $user$project$AudioFFI$getIIRFilterResponseAtFrequency = FFI.getIIRFilterResponseAtFrequency;
var $user$project$AudioFFI$getMediaElementSourceElement = FFI.getMediaElementSourceElement;
var $user$project$AudioFFI$getMediaStream = FFI.getMediaStream;
var $user$project$AudioFFI$getMediaStreamActive = FFI.getMediaStreamActive;
var $user$project$AudioFFI$getMediaStreamId = FFI.getMediaStreamId;
var $user$project$AudioFFI$getMediaStreamTracks = FFI.getMediaStreamTracks;
var $user$project$AudioFFI$getNodeChannelCount = FFI.getNodeChannelCount;
var $user$project$AudioFFI$getNodeChannelCountMode = FFI.getNodeChannelCountMode;
var $user$project$AudioFFI$getNodeChannelInterpretation = FFI.getNodeChannelInterpretation;
var $user$project$AudioFFI$getNodeContext = FFI.getNodeContext;
var $user$project$AudioFFI$getNodeNumberOfInputs = FFI.getNodeNumberOfInputs;
var $user$project$AudioFFI$getNodeNumberOfOutputs = FFI.getNodeNumberOfOutputs;
var $user$project$AudioFFI$getOfflineContextLength = FFI.getOfflineContextLength;
var $user$project$AudioFFI$getOfflineContextSampleRate = FFI.getOfflineContextSampleRate;
var $user$project$AudioFFI$getOscillatorDetuneParam = FFI.getOscillatorDetuneParam;
var $user$project$AudioFFI$getOscillatorFrequencyParam = FFI.getOscillatorFrequencyParam;
var $user$project$AudioFFI$getOscillatorType = FFI.getOscillatorType;
var $user$project$AudioFFI$getPannerConeInnerAngle = FFI.getPannerConeInnerAngle;
var $user$project$AudioFFI$getPannerConeOuterAngle = FFI.getPannerConeOuterAngle;
var $user$project$AudioFFI$getPannerConeOuterGain = FFI.getPannerConeOuterGain;
var $user$project$AudioFFI$getPannerDistanceModel = FFI.getPannerDistanceModel;
var $user$project$AudioFFI$getPannerMaxDistance = FFI.getPannerMaxDistance;
var $user$project$AudioFFI$getPannerOrientationX = FFI.getPannerOrientationX;
var $user$project$AudioFFI$getPannerOrientationY = FFI.getPannerOrientationY;
var $user$project$AudioFFI$getPannerOrientationZ = FFI.getPannerOrientationZ;
var $user$project$AudioFFI$getPannerPanningModel = FFI.getPannerPanningModel;
var $user$project$AudioFFI$getPannerPositionX = FFI.getPannerPositionX;
var $user$project$AudioFFI$getPannerPositionY = FFI.getPannerPositionY;
var $user$project$AudioFFI$getPannerPositionZ = FFI.getPannerPositionZ;
var $user$project$AudioFFI$getPannerRefDistance = FFI.getPannerRefDistance;
var $user$project$AudioFFI$getPannerRolloffFactor = FFI.getPannerRolloffFactor;
var $user$project$AudioFFI$getSampleRate = FFI.getSampleRate;
var $user$project$AudioFFI$getStereoPannerPan = FFI.getStereoPannerPan;
...
var $user$project$AudioFFI$getWaveShaperCurve = FFI.getWaveShaperCurve;
var $user$project$AudioFFI$getWaveShaperOversample = FFI.getWaveShaperOversample;
var $user$project$AudioFFI$getWorkletParameters = FFI.getWorkletParameters;
var $user$project$AudioFFI$getWorkletPort = FFI.getWorkletPort;
var $elm$time$Time$getZoneName = _Time_getZoneName( _Utils_Tuple0);
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$h6 = _VirtualDom_node('h6');
var $user$project$Capability$hasFeature = function(featurePath){ return ( CapabilityFFI.hasFeature( featurePath));};
...
var $elm$browser$Debugger$Main$icon = function(path){ return ( A4( $elm$virtual_dom$VirtualDom$nodeNS,'http://www.w3.org/2000/svg','svg', _List_fromArray([ A2( $elm$virtual_dom$VirtualDom$attribute,'viewBox','0 0 16 16') , A2( $elm$virtual_dom$VirtualDom$attribute,'xmlns','http://www.w3.org/2000/svg') , A2( $elm$virtual_dom$VirtualDom$attribute,'fill','currentColor') , A2( $elm$virtual_dom$VirtualDom$attribute,'width','16px') , A2( $elm$virtual_dom$VirtualDom$attribute,'height','16px')]), _List_fromArray([ A4( $elm$virtual_dom$VirtualDom$nodeNS,'http://www.w3.org/2000/svg','path', _List_fromArray([ A2( $elm$virtual_dom$VirtualDom$attribute,'d', path)]), _List_Nil)])));};
...
var $elm$url$Url$Builder$int = F2( function(key,value){ return ( A2( $elm$url$Url$Builder$QueryParameter, $elm$url$Url$percentEncode( key), $elm$core$String$fromInt( value)));});
var $elm$url$Url$Parser$int = A2( $elm$url$Url$Parser$custom,'NUMBER', $elm$core$String$toInt);
var $elm$url$Url$Parser$Query$int = function(key){ return ( A2( $elm$url$Url$Parser$Query$custom, key, function(stringList){if ( stringList.b &&! stringList.b.b ){var str = stringList.a; return ( $elm$core$String$toInt( str));} else return ( $elm$core$Maybe$Nothing);}));};
...
var $elm$browser$Debugger$Main$isPlaying = function(maybeIndex){if ( maybeIndex.$ ==='Nothing' ) return true; else return false;};
var $user$project$Capability$isUserActivationActive = CapabilityFFI.isUserActivationActive;
...
var $user$project$AudioFFI$linearRampToValue = FFI.linearRampToValue;
var $user$project$AudioFFI$linearRampToValueAtTime = FFI.linearRampToValueAtTime;
...
var $user$project$AudioFFI$makeDistortionCurve = FFI.makeDistortionCurve;
...
var $elm$url$Url$Parser$mapState = F2( function(func,_v0){var visited = _v0.visited;var unvisited = _v0.unvisited;var params = _v0.params;var frag = _v0.frag;var value = _v0.value; return ( A5( $elm$url$Url$Parser$State, visited, unvisited, params, frag, func( value)));});
var $elm$url$Url$Parser$map = F2( function(subValue,_v0){var parseArg = _v0.a; return ( $elm$url$Url$Parser$Parser( function(_v1){var visited = _v1.visited;var unvisited = _v1.unvisited;var params = _v1.params;var frag = _v1.frag;var value = _v1.value; return ( A2( $elm$core$List$map, $elm$url$Url$Parser$mapState( value), parseArg( A5( $elm$url$Url$Parser$State, visited, unvisited, params, frag, subValue))));}));});
var $elm$url$Url$Parser$Query$map = F2( function(func,_v0){var a = _v0.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( func( a( dict)));}));});
...
var $elm$url$Url$Parser$Query$map2 = F3( function(func,_v0,_v1){var a = _v0.a;var b = _v1.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A2( func, a( dict), b( dict)));}));});
...
var $elm$url$Url$Parser$Query$map3 = F4( function(func,_v0,_v1,_v2){var a = _v0.a;var b = _v1.a;var c = _v2.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A3( func, a( dict), b( dict), c( dict)));}));});
...
var $elm$url$Url$Parser$Query$map4 = F5( function(func,_v0,_v1,_v2,_v3){var a = _v0.a;var b = _v1.a;var c = _v2.a;var d = _v3.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A4( func, a( dict), b( dict), c( dict), d( dict)));}));});
...
var $elm$url$Url$Parser$Query$map5 = F6( function(func,_v0,_v1,_v2,_v3,_v4){var a = _v0.a;var b = _v1.a;var c = _v2.a;var d = _v3.a;var e = _v4.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A5( func, a( dict), b( dict), c( dict), d( dict), e( dict)));}));});
var $elm$json$Json$Decode$map6 = _Json_map6;
var $elm$url$Url$Parser$Query$map6 = F7( function(func,_v0,_v1,_v2,_v3,_v4,_v5){var a = _v0.a;var b = _v1.a;var c = _v2.a;var d = _v3.a;var e = _v4.a;var f = _v5.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A6( func, a( dict), b( dict), c( dict), d( dict), e( dict), f( dict)));}));});
var $elm$json$Json$Decode$map7 = _Json_map7;
var $elm$url$Url$Parser$Query$map7 = F8( function(func,_v0,_v1,_v2,_v3,_v4,_v5,_v6){var a = _v0.a;var b = _v1.a;var c = _v2.a;var d = _v3.a;var e = _v4.a;var f = _v5.a;var g = _v6.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A7( func, a( dict), b( dict), c( dict), d( dict), e( dict), f( dict), g( dict)));}));});
var $elm$json$Json$Decode$map8 = _Json_map8;
var $elm$url$Url$Parser$Query$map8 = F9( function(func,_v0,_v1,_v2,_v3,_v4,_v5,_v6,_v7){var a = _v0.a;var b = _v1.a;var c = _v2.a;var d = _v3.a;var e = _v4.a;var f = _v5.a;var g = _v6.a;var h = _v7.a; return ( $elm$url$Url$Parser$Internal$Parser( function(dict){ return ( A8( func, a( dict), b( dict), c( dict), d( dict), e( dict), f( dict), g( dict), h( dict)));}));});
...
var $user$project$AudioFFI$normalizeAudioBuffer = FFI.normalizeAudioBuffer;
...
var $elm$browser$Browser$Events$on = F3( function(node,name,decoder){ return ( $elm$browser$Browser$Events$subscription( A3( $elm$browser$Browser$Events$MySub, node, name, decoder)));});
var $elm$browser$Browser$AnimationManager$onAnimationFrame = function(tagger){ return ( $elm$browser$Browser$AnimationManager$subscription( $elm$browser$Browser$AnimationManager$Time( tagger)));};
var $elm$browser$Browser$Events$onAnimationFrame = $elm$browser$Browser$AnimationManager$onAnimationFrame;
var $elm$browser$Browser$AnimationManager$onAnimationFrameDelta = function(tagger){ return ( $elm$browser$Browser$AnimationManager$subscription( $elm$browser$Browser$AnimationManager$Delta( tagger)));};
...
var $elm$browser$Browser$Events$withHidden = F2( function(func,isHidden){ return ( func( isHidden? $elm$browser$Browser$Events$Hidden: $elm$browser$Browser$Events$Visible));});
var $elm$browser$Browser$Events$onVisibilityChange = function(func){var info = _Browser_visibilityInfo( _Utils_Tuple0); return ( A3( $elm$browser$Browser$Events$on, $elm$browser$Browser$Events$Document, info.change, A2( $elm$json$Json$Decode$map, $elm$browser$Browser$Events$withHidden( func), A2( $elm$json$Json$Decode$field,'target', A2( $elm$json$Json$Decode$field, info.hidden, $elm$json$Json$Decode$bool)))));};
var $elm$url$Url$Parser$oneOf = function(parsers){ return ( $elm$url$Url$Parser$Parser( function(state){ return ( A2( $elm$core$List$concatMap, function(_v0){var parser = _v0.a; return ( parser( state));}, parsers));}));};
...
var $elm$url$Url$Parser$preparePath = function(path){var _v0 = A2( $elm$core$String$split,'/', path);if ( _v0.b && _v0.a ==='' ){var segments = _v0.b; return ( $elm$url$Url$Parser$removeFinalEmpty( segments));} else{var segments = _v0; return ( $elm$url$Url$Parser$removeFinalEmpty( segments));}};
var $elm$url$Url$Parser$prepareQuery = function(maybeQuery){if ( maybeQuery.$ ==='Nothing' ) return ( $elm$core$Dict$empty); else{var qry = maybeQuery.a; return ( A3( $elm$core$List$foldr, $elm$url$Url$Parser$addParam, $elm$core$Dict$empty, A2( $elm$core$String$split,'&', qry)));}};
var $elm$url$Url$Parser$parse = F2( function(_v0,url){var parser = _v0.a; return ( $elm$url$Url$Parser$getFirstMatch( parser( A5( $elm$url$Url$Parser$State, _List_Nil, $elm$url$Url$Parser$preparePath( url.path), $elm$url$Url$Parser$prepareQuery( url.query), url.fragment, $elm$core$Basics$identity))));});
...
var $elm$browser$Debugger$Main$toDragListeners = function(layout){var _v0 = $elm$browser$Debugger$Main$getDragStatus( layout);if ( _v0.$ ==='Static' ) return ( _List_Nil); else return ( _List_fromArray([ $elm$browser$Debugger$Main$onMouseMove , $elm$html$Html$Events$onMouseUp( $elm$browser$Debugger$Main$DragEnd)]));};
var $elm$browser$Debugger$Main$toFlexDirection = function(layout){if ( layout.$ ==='Horizontal' ) return 'row'; else return 'column-reverse';};
var $elm$browser$Debugger$Main$toPercent = function(fraction){ return ( $elm$core$String$fromFloat(100 * fraction) +'%');};
var $elm$browser$Debugger$Main$viewDragZone = function(layout){if ( layout.$ ==='Horizontal' ){var x = layout.b; return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'position','absolute') , A2( $elm$html$Html$Attributes$style,'top','0') , A2( $elm$html$Html$Attributes$style,'left', $elm$browser$Debugger$Main$toPercent( x)) , A2( $elm$html$Html$Attributes$style,'margin-left','-5px') , A2( $elm$html$Html$Attributes$style,'width','10px') , A2( $elm$html$Html$Attributes$style,'height','100%') , A2( $elm$html$Html$Attributes$style,'cursor','col-resize') , $elm$html$Html$Events$onMouseDown( $elm$browser$Debugger$Main$DragStart)]), _List_Nil));} else{var y = layout.c; return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'position','absolute') , A2( $elm$html$Html$Attributes$style,'top', $elm$browser$Debugger$Main$toPercent( y)) , A2( $elm$html$Html$Attributes$style,'left','0') , A2( $elm$html$Html$Attributes$style,'margin-top','-5px') , A2( $elm$html$Html$Attributes$style,'width','100%') , A2( $elm$html$Html$Attributes$style,'height','10px') , A2( $elm$html$Html$Attributes$style,'cursor','row-resize') , $elm$html$Html$Events$onMouseDown( $elm$browser$Debugger$Main$DragStart)]), _List_Nil));}};
var $elm$browser$Debugger$Main$toExpandoPercents = function(layout){if ( layout.$ ==='Horizontal' ){var x = layout.b; return ( _Utils_Tuple2( $elm$browser$Debugger$Main$toPercent(1 - x),'100%'));} else{var y = layout.c; return ( _Utils_Tuple2('100%', $elm$browser$Debugger$Main$toPercent( y)));}};
var $elm$browser$Debugger$Main$toMouseBlocker = function(layout){var _v0 = $elm$browser$Debugger$Main$getDragStatus( layout);if ( _v0.$ ==='Static' ) return 'auto'; else return 'none';};
var $elm$browser$Debugger$Main$viewExpando = F3( function(expandoMsg,expandoModel,layout){var block = $elm$browser$Debugger$Main$toMouseBlocker( layout);var _v0 = $elm$browser$Debugger$Main$toExpandoPercents( layout);var w = _v0.a;var h = _v0.b; return ( A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'display','block') , A2( $elm$html$Html$Attributes$style,'width','calc(' +( w +' - 4em)')) , A2( $elm$html$Html$Attributes$style,'height','calc(' +( h +' - 4em)')) , A2( $elm$html$Html$Attributes$style,'padding','2em') , A2( $elm$html$Html$Attributes$style,'margin','0') , A2( $elm$html$Html$Attributes$style,'overflow','auto') , A2( $elm$html$Html$Attributes$style,'pointer-events', block) , A2( $elm$html$Html$Attributes$style,'-webkit-user-select', block) , A2( $elm$html$Html$Attributes$style,'-moz-user-select', block) , A2( $elm$html$Html$Attributes$style,'-ms-user-select', block) , A2( $elm$html$Html$Attributes$style,'user-select', block)]), _List_fromArray([ A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'color','#ccc') , A2( $elm$html$Html$Attributes$style,'padding','0 0 1em 0')]), _List_fromArray([ $elm$html$Html$text('-- MESSAGE')])) , A2( $elm$html$Html$map, $elm$browser$Debugger$Main$TweakExpandoMsg, A2( $elm$browser$Debugger$Expando$view, $elm$core$Maybe$Nothing, expandoMsg)) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'color','#ccc') , A2( $elm$html$Html$Attributes$style,'padding','1em 0')]), _List_fromArray([ $elm$html$Html$text('-- MODEL')])) , A2( $elm$html$Html$map, $elm$browser$Debugger$Main$TweakExpandoModel, A2( $elm$browser$Debugger$Expando$view, $elm$core$Maybe$Nothing, expandoModel))])));});
var $elm$browser$Debugger$Main$toHistoryPercents = function(layout){if ( layout.$ ==='Horizontal' ){var x = layout.b; return ( _Utils_Tuple2( $elm$browser$Debugger$Main$toPercent( x),'100%'));} else{var y = layout.c; return ( _Utils_Tuple2('100%', $elm$browser$Debugger$Main$toPercent(1 - y)));}};
var $elm$browser$Debugger$History$showMoreButton = function(numMessages){var nextIndex = numMessages -1 - $elm$browser$Debugger$History$maxSnapshotSize *2;var labelText ='View more messages'; return ( A2( $elm$html$Html$div, _List_fromArray([ $elm$html$Html$Attributes$class('elm-debugger-entry') , $elm$html$Html$Events$onClick( nextIndex)]), _List_fromArray([ A2( $elm$html$Html$span, _List_fromArray([ $elm$html$Html$Attributes$title( labelText) , $elm$html$Html$Attributes$class('elm-debugger-entry-content')]), _List_fromArray([ $elm$html$Html$text( labelText)])) , A2( $elm$html$Html$span, _List_fromArray([ $elm$html$Html$Attributes$class('elm-debugger-entry-index')]), _List_Nil)])));};
...
var $elm$browser$Debugger$History$viewAllSnapshots = F3( function(selectedIndex,startIndex,snapshots){ return ( A2( $elm$html$Html$div, _List_Nil, A3( $elm$core$Array$foldl, $elm$browser$Debugger$History$consSnapshot( selectedIndex), _Utils_Tuple2( startIndex, _List_Nil), snapshots).b));});
...
var $elm$url$Url$Parser$query = function(_v0){var queryParser = _v0.a; return ( $elm$url$Url$Parser$Parser( function(_v1){var visited = _v1.visited;var unvisited = _v1.unvisited;var params = _v1.params;var frag = _v1.frag;var value = _v1.value; return ( _List_fromArray([ A5( $elm$url$Url$Parser$State, visited, unvisited, params, frag, value( queryParser( params)))]));}));};
var $elm$url$Url$Parser$slash = F2( function(_v0,_v1){var parseBefore = _v0.a;var parseAfter = _v1.a; return ( $elm$url$Url$Parser$Parser( function(state){ return ( A2( $elm$core$List$concatMap, parseAfter, parseBefore( state)));}));});
var $elm$url$Url$Parser$questionMark = F2( function(parser,queryParser){ return ( A2( $elm$url$Url$Parser$slash, parser, $elm$url$Url$Parser$query( queryParser)));});
var $elm$core$Basics$radians = function(angleInRadians){ return ( angleInRadians);};
var $user$project$AudioFFI$rampGainExponential = FFI.rampGainExponential;
var $user$project$AudioFFI$rampGainLinear = FFI.rampGainLinear;
var $elm$html$Html$Attributes$readonly = $elm$html$Html$Attributes$boolProperty('readOnly');
var $elm$html$Html$Attributes$rel = _VirtualDom_attribute('rel');
var $elm$url$Url$Builder$relative = F2( function(pathSegments,parameters){ return ( _Utils_ap( A2( $elm$core$String$join,'/', pathSegments), $elm$url$Url$Builder$toQuery( parameters)));});
...
var $user$project$AudioFFI$resumeAudioContext = FFI.resumeAudioContext;
var $user$project$AudioFFI$resumeOfflineContext = FFI.resumeOfflineContext;
var $elm$core$String$reverse = _String_reverse;
var $user$project$AudioFFI$reverseAudioBuffer = FFI.reverseAudioBuffer;
...
var $elm$url$Url$Parser$s = function(str){ return ( $elm$url$Url$Parser$Parser( function(_v0){var visited = _v0.visited;var unvisited = _v0.unvisited;var params = _v0.params;var frag = _v0.frag;var value = _v0.value;if (! unvisited.b ) return ( _List_Nil); else{var next = unvisited.a;var rest = unvisited.b; return ( _Utils_eq( next, str)? _List_fromArray([ A5( $elm$url$Url$Parser$State, A2( $elm$core$List$cons, next, visited), rest, params, frag, value)]): _List_Nil);}}));};
var $elm$html$Html$samp = _VirtualDom_node('samp');
var $elm$browser$Browser$sandbox = function(impl){ return ( _Browser_element({view : impl.view,update : F2( function(msg,model){ return ( _Utils_Tuple2( A2( impl.update, msg, model), $elm$core$Platform$Cmd$none));}),subscriptions : function(_v1){ return ( $elm$core$Platform$Sub$none);},init : function(_v0){ return ( _Utils_Tuple2( impl.init, $elm$core$Platform$Cmd$none));}}));};
...
var $user$project$AudioFFI$setAnalyserMaxDecibels = FFI.setAnalyserMaxDecibels;
var $user$project$AudioFFI$setAnalyserMinDecibels = FFI.setAnalyserMinDecibels;
var $user$project$AudioFFI$setAnalyserSmoothing = FFI.setAnalyserSmoothing;
var $user$project$AudioFFI$setAnalyserSmoothingTimeConstant = FFI.setAnalyserSmoothingTimeConstant;
var $user$project$AudioFFI$setAudioParamAutomationRate = FFI.setAudioParamAutomationRate;
var $user$project$AudioFFI$setAudioParamValue = FFI.setAudioParamValue;
var $user$project$AudioFFI$setBiquadFilterTypeDirect = FFI.setBiquadFilterTypeDirect;
var $user$project$AudioFFI$setBufferSourceBuffer = FFI.setBufferSourceBuffer;
var $user$project$AudioFFI$setBufferSourceDetune = FFI.setBufferSourceDetune;
var $user$project$AudioFFI$setBufferSourceLoop = FFI.setBufferSourceLoop;
var $user$project$AudioFFI$setBufferSourceLoopDirect = FFI.setBufferSourceLoopDirect;
var $user$project$AudioFFI$setBufferSourceLoopEnd = FFI.setBufferSourceLoopEnd;
var $user$project$AudioFFI$setBufferSourceLoopStart = FFI.setBufferSourceLoopStart;
var $user$project$AudioFFI$setBufferSourcePlaybackRate = FFI.setBufferSourcePlaybackRate;
var $user$project$AudioFFI$setCompressorAttack = FFI.setCompressorAttack;
var $user$project$AudioFFI$setCompressorAttackDirect = FFI.setCompressorAttackDirect;
var $user$project$AudioFFI$setCompressorKnee = FFI.setCompressorKnee;
var $user$project$AudioFFI$setCompressorRatio = FFI.setCompressorRatio;
var $user$project$AudioFFI$setCompressorRelease = FFI.setCompressorRelease;
var $user$project$AudioFFI$setCompressorReleaseDirect = FFI.setCompressorReleaseDirect;
var $user$project$AudioFFI$setCompressorThreshold = FFI.setCompressorThreshold;
...
var $user$project$AudioFFI$setConvolverNormalize = FFI.setConvolverNormalize;
var $user$project$AudioFFI$setDelayTime = FFI.setDelayTime;
var $user$project$AudioFFI$setDistanceModel = FFI.setDistanceModel;
var $user$project$AudioFFI$setFilterFrequency = FFI.setFilterFrequency;
var $user$project$AudioFFI$setFilterGain = FFI.setFilterGain;
var $user$project$AudioFFI$setFilterQ = FFI.setFilterQ;
...
var $user$project$AudioFFI$setNodeChannelCount = FFI.setNodeChannelCount;
var $user$project$AudioFFI$setNodeChannelCountMode = FFI.setNodeChannelCountMode;
var $user$project$AudioFFI$setNodeChannelInterpretation = FFI.setNodeChannelInterpretation;
...
var $user$project$AudioFFI$setOscillatorPeriodicWave = FFI.setOscillatorPeriodicWave;
var $user$project$AudioFFI$setOscillatorType = FFI.setOscillatorType;
var $user$project$AudioFFI$setPan = FFI.setPan;
var $user$project$AudioFFI$setPannerOrientation = FFI.setPannerOrientation;
var $user$project$AudioFFI$setPannerOrientationDirect = FFI.setPannerOrientationDirect;
...
var $user$project$AudioFFI$setParamValueAtTime = FFI.setParamValueAtTime;
...
var $user$project$AudioFFI$setTargetAtTime = FFI.setTargetAtTime;
var $user$project$AudioFFI$setValueAtTime = FFI.setValueAtTime;
var $user$project$AudioFFI$setValueCurveAtTime = FFI.setValueCurveAtTime;
var $elm$browser$Browser$Dom$setViewport = _Browser_setViewport;
var $elm$browser$Browser$Dom$setViewportOf = _Browser_setViewportOf;
var $user$project$AudioFFI$setWaveShaperCurve = FFI.setWaveShaperCurve;
var $user$project$AudioFFI$setWaveShaperOversample = FFI.setWaveShaperOversample;
...
var $user$project$AudioFFI$startBufferSource = FFI.startBufferSource;
var $user$project$AudioFFI$startConstantSource = FFI.startConstantSource;
var $user$project$AudioFFI$startOfflineRendering = FFI.startOfflineRendering;
var $user$project$AudioFFI$startOfflineRenderingAsync = FFI.startOfflineRenderingAsync;
var $user$project$AudioFFI$stopBufferSource = FFI.stopBufferSource;
var $user$project$AudioFFI$stopConstantSource = FFI.stopConstantSource;
var $elm$url$Url$Builder$string = F2( function(key,value){ return ( A2( $elm$url$Url$Builder$QueryParameter, $elm$url$Url$percentEncode( key), $elm$url$Url$percentEncode( value)));});
var $elm$url$Url$Parser$string = A2( $elm$url$Url$Parser$custom,'STRING', $elm$core$Maybe$Just);
var $elm$url$Url$Parser$Query$string = function(key){ return ( A2( $elm$url$Url$Parser$Query$custom, key, function(stringList){if ( stringList.b &&! stringList.b.b ){var str = stringList.a; return ( $elm$core$Maybe$Just( str));} else return ( $elm$core$Maybe$Nothing);}));};
...
var $user$project$AudioFFI$suspendAudioContext = FFI.suspendAudioContext;
var $user$project$AudioFFI$suspendOfflineContext = FFI.suspendOfflineContext;
...
var $elm$time$Time$toAdjustedMinutes = F2( function(_v0,time){var defaultOffset = _v0.a;var eras = _v0.b; return ( A3( $elm$time$Time$toAdjustedMinutesHelp, defaultOffset, A2( $elm$time$Time$flooredDiv, $elm$time$Time$posixToMillis( time),60000), eras));});
var $elm$browser$Debugger$Overlay$toBlockerType = F2( function(isPaused,state){ switch( state.$){ case 'None' : return ( isPaused? $elm$browser$Debugger$Overlay$BlockAll: $elm$browser$Debugger$Overlay$BlockNone); case 'BadMetadata' : return ( $elm$browser$Debugger$Overlay$BlockMost); case 'BadImport' : return ( $elm$browser$Debugger$Overlay$BlockMost); default : return ( $elm$browser$Debugger$Overlay$BlockMost);}});
var $elm$browser$Debugger$Main$toBlockerType = function(model){ return ( A2( $elm$browser$Debugger$Overlay$toBlockerType, $elm$browser$Debugger$Main$isPaused( model.state), model.overlay));};
var $elm$time$Time$toCivil = function(minutes){var rawDay = A2( $elm$time$Time$flooredDiv, minutes,60 *24) +719468;var era =( rawDay >=0)? rawDay: rawDay -146096 /146097 |0;var dayOfEra = rawDay - era *146097;var yearOfEra = dayOfEra - dayOfEra /1460 |0 + dayOfEra /36524 |0 - dayOfEra /146096 |0 /365 |0;var dayOfYear = dayOfEra -(365 * yearOfEra + yearOfEra /4 |0 - yearOfEra /100 |0);var mp =5 * dayOfYear +2 /153 |0;var month = mp +( mp <10)?3:-9;var year = yearOfEra + era *400; return ({year : year +( month <=2)?1:0,month : month,day : dayOfYear -153 * mp +2 /5 |0 +1});};
var $elm$time$Time$toDay = F2( function(zone,time){ return ( $elm$time$Time$toCivil( A2( $elm$time$Time$toAdjustedMinutes, zone, time)).day);});
var $elm$time$Time$toHour = F2( function(zone,time){ return ( A2( $elm$core$Basics$modBy,24, A2( $elm$time$Time$flooredDiv, A2( $elm$time$Time$toAdjustedMinutes, zone, time),60)));});
...
var $elm$time$Time$toMillis = F2( function(_v0,time){ return ( A2( $elm$core$Basics$modBy,1000, $elm$time$Time$posixToMillis( time)));});
var $elm$time$Time$toMinute = F2( function(zone,time){ return ( A2( $elm$core$Basics$modBy,60, A2( $elm$time$Time$toAdjustedMinutes, zone, time)));});
var $elm$time$Time$toMonth = F2( function(zone,time){var _v0 = $elm$time$Time$toCivil( A2( $elm$time$Time$toAdjustedMinutes, zone, time)).month; switch( _v0){ case 1 : return ( $elm$time$Time$Jan); case 2 : return ( $elm$time$Time$Feb); case 3 : return ( $elm$time$Time$Mar); case 4 : return ( $elm$time$Time$Apr); case 5 : return ( $elm$time$Time$May); case 6 : return ( $elm$time$Time$Jun); case 7 : return ( $elm$time$Time$Jul); case 8 : return ( $elm$time$Time$Aug); case 9 : return ( $elm$time$Time$Sep); case 10 : return ( $elm$time$Time$Oct); case 11 : return ( $elm$time$Time$Nov); default : return ( $elm$time$Time$Dec);}});
...
var $elm$time$Time$toSecond = F2( function(_v0,time){ return ( A2( $elm$core$Basics$modBy,60, A2( $elm$time$Time$flooredDiv, $elm$time$Time$posixToMillis( time),1000)));});
var $elm$core$Debug$toString = _Debug_toString;
var $elm$url$Url$toString = function(url){var http = function(){var _v0 = url.protocol;if ( _v0.$ ==='Http' ) return 'http://'; else return 'https://';}(); return ( A3( $elm$url$Url$addPrefixed,'#', url.fragment, A3( $elm$url$Url$addPrefixed,'?', url.query, _Utils_ap( A2( $elm$url$Url$addPort, url.port_, _Utils_ap( http, url.host)), url.path))));};
var $elm$core$Char$toUpper = _Char_toUpper;
var $elm$core$String$toUpper = _String_toUpper;
var $elm$time$Time$toWeekday = F2( function(zone,time){var _v0 = A2( $elm$core$Basics$modBy,7, A2( $elm$time$Time$flooredDiv, A2( $elm$time$Time$toAdjustedMinutes, zone, time),60 *24)); switch( _v0){ case 0 : return ( $elm$time$Time$Thu); case 1 : return ( $elm$time$Time$Fri); case 2 : return ( $elm$time$Time$Sat); case 3 : return ( $elm$time$Time$Sun); case 4 : return ( $elm$time$Time$Mon); case 5 : return ( $elm$time$Time$Tue); default : return ( $elm$time$Time$Wed);}});
var $elm$time$Time$toYear = F2( function(zone,time){ return ( $elm$time$Time$toCivil( A2( $elm$time$Time$toAdjustedMinutes, zone, time)).year);});
var $elm$core$Debug$todo = _Debug_todo;
var $elm$url$Url$Parser$top = $elm$url$Url$Parser$Parser( function(state){ return ( _List_fromArray([ state]));});
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $elm$html$Html$track = _VirtualDom_node('track');
var $elm$core$String$trim = _String_trim;
var $elm$core$String$trimLeft = _String_trimLeft;
var $elm$core$String$trimRight = _String_trimRight;
var $user$project$AudioFFI$trimSilence = FFI.trimSilence;
...
var $elm$browser$Debugger$Main$wrapInit = F4( function(metadata,popout,init,flags){var _v0 = init( flags);var userModel = _v0.a;var userCommands = _v0.b; return ( _Utils_Tuple2({state : $elm$browser$Debugger$Main$Running( userModel),popout : popout,overlay : $elm$browser$Debugger$Overlay$none,metadata : $elm$browser$Debugger$Metadata$decode( metadata),layout : A3( $elm$browser$Debugger$Main$Horizontal, $elm$browser$Debugger$Main$Static,0.3,0.5),history : $elm$browser$Debugger$History$empty( userModel),expandoMsg : $elm$browser$Debugger$Expando$init( _Utils_Tuple0),expandoModel : $elm$browser$Debugger$Expando$init( userModel)}, A2( $elm$core$Platform$Cmd$map, $elm$browser$Debugger$Main$UserMsg, userCommands)));});
var $elm$browser$Debugger$Main$wrapSubs = F2( function(subscriptions,model){ return ( A2( $elm$core$Platform$Sub$map, $elm$browser$Debugger$Main$UserMsg, subscriptions( $elm$browser$Debugger$Main$getLatestModel( model.state))));});
