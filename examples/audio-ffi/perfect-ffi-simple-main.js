...
var $author$project$PerfectFFIAudioDemoSimpleMain$main = A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð PERFECT FFI MODULE DEMO with Complex Types\\')]));
_Platform_export({'PerfectFFIAudioDemoSimpleMain':{'init': _VirtualDom_init( $author$project$PerfectFFIAudioDemoSimpleMain$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));