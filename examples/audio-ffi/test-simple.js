...
var $user$project$TestSimple$main = $elm$html$Html$text('Test');
...
_Platform_export({'TestSimple':{'init': _VirtualDom_init( $user$project$TestSimple$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
