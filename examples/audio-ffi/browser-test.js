...
var $author$project$BrowserTestFFI$init ={userActivation : $elm$core$Maybe$Nothing,logs : _List_fromArray(['ð FFI Browser Test Ready']),audioSupport : $elm$core$Maybe$Nothing};
var $author$project$BrowserTestFFI$CheckAudioSupport ={$ :'CheckAudioSupport'};
var $author$project$BrowserTestFFI$CheckUserActivation ={$ :'CheckUserActivation'};
...
var $author$project$BrowserTestFFI$testButtonStyle = A2( $elm$html$Html$Attributes$style,'all','padding: 10px 15px; margin: 5px; background-color: #007cba; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 14px;');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$BrowserTestFFI$view = function(model){return A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'font-family','Arial, sans-serif')]), _List_fromArray([ A2( $elm$html$Html$h1, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð§ª FFI Browser Test')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â FFI Module loaded successfully with complex types\\')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ðµ Test Controls')])) , A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $author$project$BrowserTestFFI$CheckAudioSupport) , $author$project$BrowserTestFFI$testButtonStyle]), _List_fromArray([ $elm$html$Html$text('ð Test Audio Support')])) , A2( $elm$html$Html$button, _List_fromArray([ $elm$html$Html$Events$onClick( $author$project$BrowserTestFFI$CheckUserActivation) , $author$project$BrowserTestFFI$testButtonStyle]), _List_fromArray([ $elm$html$Html$text('ð Test User Activation')]))])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Test Logs')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background-color','#f8f9fa') , A2( $elm$html$Html$Attributes$style,'padding','15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px')]), A2( $elm$core$List$map, function(log){return A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text( log)]));}, $elm$core$List$reverse( model.logs)))]))]));};
var $author$project$BrowserTestFFI$main = $author$project$BrowserTestFFI$view( $author$project$BrowserTestFFI$init);
_Platform_export({'BrowserTestFFI':{'init': _VirtualDom_init( $author$project$BrowserTestFFI$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));