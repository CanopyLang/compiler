...
var $user$project$AnalyserTest$analyserConfigTests = A2( $user$project$Test$describe,'analyser configuration', _List_fromArray([ A2( $user$project$Test$describe,'setAnalyserFFTSize', _List_fromArray([ A2( $user$project$Test$test,'sets FFT size to 2048', function(_v0){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v1 = A2( $user$project$AudioFFI$setAnalyserFFTSize, analyser,2048); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets FFT size to 256', function(_v2){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v3 = A2( $user$project$AudioFFI$setAnalyserFFTSize, analyser,256); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets FFT size to 4096', function(_v4){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v5 = A2( $user$project$AudioFFI$setAnalyserFFTSize, analyser,4096); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setAnalyserMinDecibels', _List_fromArray([ A2( $user$project$Test$test,'sets min decibels', function(_v6){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v7 = A2( $user$project$AudioFFI$setAnalyserMinDecibels, analyser,-100.0);if ( _v7.$ ==='Ok' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setAnalyserMaxDecibels', _List_fromArray([ A2( $user$project$Test$test,'sets max decibels', function(_v8){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v9 = A2( $user$project$AudioFFI$setAnalyserMaxDecibels, analyser,-30.0);if ( _v9.$ ==='Ok' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setAnalyserSmoothingTimeConstant', _List_fromArray([ A2( $user$project$Test$test,'sets smoothing to 0.8', function(_v10){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v11 = A2( $user$project$AudioFFI$setAnalyserSmoothingTimeConstant, analyser,0.8);if ( _v11.$ ==='Ok' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setAnalyserSmoothing', _List_fromArray([ A2( $user$project$Test$test,'sets smoothing value', function(_v12){ return ( $user$project$AnalyserTest$withRawContext( function(ctx){var analyser = $user$project$AudioFFI$createAnalyser( ctx);var _v13 = A2( $user$project$AudioFFI$setAnalyserSmoothing, analyser,0.5); return ( $user$project$Expect$pass);}));})]))]));
...
var $user$project$BufferTest$bufferPropertyTests = A2( $user$project$Test$describe,'buffer properties', _List_fromArray([ A2( $user$project$Test$describe,'getBufferLength', _List_fromArray([ A2( $user$project$Test$test,'returns correct sample count', function(_v0){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createAudioBuffer, ctx,2,44100,44100.0);var length = $user$project$AudioFFI$getBufferLength( buffer); return ( A2( $user$project$Expect$equal,44100, length));}));})])) , A2( $user$project$Test$describe,'getBufferDuration', _List_fromArray([ A2( $user$project$Test$test,'returns duration in seconds', function(_v1){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createAudioBuffer, ctx,2,44100,44100.0);var duration = $user$project$AudioFFI$getBufferDuration( buffer); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),1.0, duration));}));})])) , A2( $user$project$Test$describe,'getBufferSampleRate', _List_fromArray([ A2( $user$project$Test$test,'returns correct sample rate', function(_v2){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createAudioBuffer, ctx,2,44100,44100.0);var sampleRate = $user$project$AudioFFI$getBufferSampleRate( buffer); return ( A2( $user$project$Expect$equal,44100.0, sampleRate));}));})])) , A2( $user$project$Test$describe,'getBufferChannels', _List_fromArray([ A2( $user$project$Test$test,'returns correct channel count', function(_v3){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createAudioBuffer, ctx,2,44100,44100.0);var channels = $user$project$AudioFFI$getBufferChannels( buffer); return ( A2( $user$project$Expect$equal,2, channels));}));})])) , A2( $user$project$Test$describe,'getBufferPeak', _List_fromArray([ A2( $user$project$Test$test,'returns peak amplitude', function(_v4){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createSilentBuffer, ctx,44100,2,1.0);var peak = $user$project$AudioFFI$getBufferPeak( buffer); return ( A2( $user$project$Expect$true,'peak should be non-negative', peak >=0.0));}));})])) , A2( $user$project$Test$describe,'getBufferRMS', _List_fromArray([ A2( $user$project$Test$test,'returns RMS value', function(_v5){ return ( $user$project$BufferTest$withRawContext( function(ctx){var buffer = A4( $user$project$AudioFFI$createSilentBuffer, ctx,44100,2,1.0);var rms = $user$project$AudioFFI$getBufferRMS( buffer); return ( A2( $user$project$Expect$true,'RMS should be non-negative', rms >=0.0));}));})]))]));
...
var $user$project$BufferTest$bufferSourcePropertyTests = A2( $user$project$Test$describe,'buffer source properties', _List_fromArray([ A2( $user$project$Test$describe,'getBufferSourceLoop', _List_fromArray([ A2( $user$project$Test$test,'returns loop state', function(_v0){ return ( $user$project$BufferTest$withRawContext( function(ctx){var source = $user$project$AudioFFI$createBufferSource( ctx);var loop = $user$project$AudioFFI$getBufferSourceLoop( source);var _v1 = A2( $user$project$AudioFFI$setBufferSourceLoop, source,true); return ( A2( $user$project$Expect$equal,true, loop));}));})])) , A2( $user$project$Test$describe,'loop start/end', _List_fromArray([ A2( $user$project$Test$test,'sets and gets loop start', function(_v2){ return ( $user$project$BufferTest$withRawContext( function(ctx){var source = $user$project$AudioFFI$createBufferSource( ctx);var start = $user$project$AudioFFI$getBufferSourceLoopStart( source);var _v3 = A2( $user$project$AudioFFI$setBufferSourceLoopStart, source,0.5); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),0.5, start));}));}) , A2( $user$project$Test$test,'sets and gets loop end', function(_v4){ return ( $user$project$BufferTest$withRawContext( function(ctx){var source = $user$project$AudioFFI$createBufferSource( ctx);var end = $user$project$AudioFFI$getBufferSourceLoopEnd( source);var _v5 = A2( $user$project$AudioFFI$setBufferSourceLoopEnd, source,2.0); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),2.0, end));}));})])) , A2( $user$project$Test$describe,'playback rate and detune', _List_fromArray([ A2( $user$project$Test$test,'gets playback rate param', function(_v6){ return ( $user$project$BufferTest$withRawContext( function(ctx){var source = $user$project$AudioFFI$createBufferSource( ctx);var param = $user$project$AudioFFI$getBufferSourcePlaybackRate( source); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'gets detune param', function(_v7){ return ( $user$project$BufferTest$withRawContext( function(ctx){var source = $user$project$AudioFFI$createBufferSource( ctx);var param = $user$project$AudioFFI$getBufferSourceDetune( source); return ( $user$project$Expect$pass);}));})]))]));
...
var $user$project$ConnectionTest$nativeCoerce = function(_v0){ return ( _Debug_todo('ConnectionTest',{end :{column :15,line :332},start :{column :5,line :332}})('Native coercion needed'));};
var $user$project$ConnectionTest$unsafeCoerce = $user$project$ConnectionTest$nativeCoerce;
var $user$project$ConnectionTest$toAudioNode = function(gain){ return ( $user$project$ConnectionTest$unsafeCoerce( gain));};
...
var $user$project$EffectsTest$convolverTests = A2( $user$project$Test$describe,'Convolver Node', _List_fromArray([ A2( $user$project$Test$describe,'createConvolver', _List_fromArray([ A2( $user$project$Test$test,'creates convolver node', function(_v0){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var convolver = $user$project$AudioFFI$createConvolver( ctx); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setConvolverBuffer', _List_fromArray([ A2( $user$project$Test$test,'sets impulse response buffer', function(_v1){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var convolver = $user$project$AudioFFI$createConvolver( ctx);var buffer = A4( $user$project$AudioFFI$createEmptyBuffer, ctx,2,1.0,44100);var _v2 = A2( $user$project$AudioFFI$setConvolverBuffer, convolver, buffer);if ( _v2.$ ==='Ok' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setConvolverNormalize', _List_fromArray([ A2( $user$project$Test$test,'enables normalization', function(_v3){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var convolver = $user$project$AudioFFI$createConvolver( ctx);var _v4 = A2( $user$project$AudioFFI$setConvolverNormalize, convolver,true); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'disables normalization', function(_v5){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var convolver = $user$project$AudioFFI$createConvolver( ctx);var _v6 = A2( $user$project$AudioFFI$setConvolverNormalize, convolver,false); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getConvolverNormalize', _List_fromArray([ A2( $user$project$Test$test,'returns normalize state', function(_v7){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var convolver = $user$project$AudioFFI$createConvolver( ctx);var normalize = $user$project$AudioFFI$getConvolverNormalize( convolver);var _v8 = A2( $user$project$AudioFFI$setConvolverNormalize, convolver,true); return ( A2( $user$project$Expect$equal,true, normalize));}));})]))]));
...
var $user$project$EffectsTest$waveShaperTests = A2( $user$project$Test$describe,'Wave Shaper', _List_fromArray([ A2( $user$project$Test$describe,'createWaveShaper', _List_fromArray([ A2( $user$project$Test$test,'creates wave shaper node', function(_v0){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setWaveShaperCurve', _List_fromArray([ A2( $user$project$Test$test,'sets distortion curve', function(_v1){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx);var curve = _List_fromArray([-1.0 ,-0.5 ,0.0 ,0.5 ,1.0]);var _v2 = A2( $user$project$AudioFFI$setWaveShaperCurve, shaper, curve);if ( _v2.$ ==='Ok' ) return ( $user$project$Expect$pass); else return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'setWaveShaperOversample', _List_fromArray([ A2( $user$project$Test$test,'sets oversample to none', function(_v3){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx);var _v4 = A2( $user$project$AudioFFI$setWaveShaperOversample, shaper,'none'); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets oversample to 2x', function(_v5){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx);var _v6 = A2( $user$project$AudioFFI$setWaveShaperOversample, shaper,'2x'); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets oversample to 4x', function(_v7){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx);var _v8 = A2( $user$project$AudioFFI$setWaveShaperOversample, shaper,'4x'); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getWaveShaperOversample', _List_fromArray([ A2( $user$project$Test$test,'returns oversample mode', function(_v9){ return ( $user$project$EffectsTest$withRawContext( function(ctx){var shaper = $user$project$AudioFFI$createWaveShaper( ctx);var oversample = $user$project$AudioFFI$getWaveShaperOversample( shaper);var _v10 = A2( $user$project$AudioFFI$setWaveShaperOversample, shaper,'2x'); return ( A2( $user$project$Expect$equal,'2x', oversample));}));})])) , A2( $user$project$Test$describe,'makeDistortionCurve', _List_fromArray([ A2( $user$project$Test$test,'generates distortion curve', function(_v11){var curve = A2( $user$project$AudioFFI$makeDistortionCurve,50.0,256); return ( A2( $user$project$Expect$true,'curve should have samples', $elm$core$List$length( curve) >0));})]))]));
...
var $user$project$SpatialTest$pannerConeTests = A2( $user$project$Test$describe,'panner cone settings', _List_fromArray([ A2( $user$project$Test$describe,'setConeInnerAngle', _List_fromArray([ A2( $user$project$Test$test,'sets inner angle to 360', function(_v0){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v1 = A2( $user$project$AudioFFI$setConeInnerAngle, panner,360.0); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets inner angle to 90', function(_v2){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v3 = A2( $user$project$AudioFFI$setConeInnerAngle, panner,90.0); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerConeInnerAngle', _List_fromArray([ A2( $user$project$Test$test,'returns inner angle', function(_v4){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var angle = $user$project$AudioFFI$getPannerConeInnerAngle( panner);var _v5 = A2( $user$project$AudioFFI$setConeInnerAngle, panner,180.0); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),180.0, angle));}));})])) , A2( $user$project$Test$describe,'setConeOuterAngle', _List_fromArray([ A2( $user$project$Test$test,'sets outer angle', function(_v6){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v7 = A2( $user$project$AudioFFI$setConeOuterAngle, panner,360.0); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerConeOuterAngle', _List_fromArray([ A2( $user$project$Test$test,'returns outer angle', function(_v8){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var angle = $user$project$AudioFFI$getPannerConeOuterAngle( panner);var _v9 = A2( $user$project$AudioFFI$setConeOuterAngle, panner,270.0); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),270.0, angle));}));})])) , A2( $user$project$Test$describe,'setConeOuterGain', _List_fromArray([ A2( $user$project$Test$test,'sets outer gain', function(_v10){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v11 = A2( $user$project$AudioFFI$setConeOuterGain, panner,0.5); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerConeOuterGain', _List_fromArray([ A2( $user$project$Test$test,'returns outer gain', function(_v12){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var gain = $user$project$AudioFFI$getPannerConeOuterGain( panner);var _v13 = A2( $user$project$AudioFFI$setConeOuterGain, panner,0.25); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),0.25, gain));}));})]))]));
...
var $user$project$SpatialTest$pannerDistanceTests = A2( $user$project$Test$describe,'panner distance settings', _List_fromArray([ A2( $user$project$Test$describe,'setRefDistance', _List_fromArray([ A2( $user$project$Test$test,'sets reference distance', function(_v0){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v1 = A2( $user$project$AudioFFI$setRefDistance, panner,1.0); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerRefDistance', _List_fromArray([ A2( $user$project$Test$test,'returns reference distance', function(_v2){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var refDist = $user$project$AudioFFI$getPannerRefDistance( panner);var _v3 = A2( $user$project$AudioFFI$setRefDistance, panner,2.0); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),2.0, refDist));}));})])) , A2( $user$project$Test$describe,'setMaxDistance', _List_fromArray([ A2( $user$project$Test$test,'sets max distance', function(_v4){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v5 = A2( $user$project$AudioFFI$setMaxDistance, panner,10000.0); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerMaxDistance', _List_fromArray([ A2( $user$project$Test$test,'returns max distance', function(_v6){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var maxDist = $user$project$AudioFFI$getPannerMaxDistance( panner);var _v7 = A2( $user$project$AudioFFI$setMaxDistance, panner,1000.0); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),1000.0, maxDist));}));})])) , A2( $user$project$Test$describe,'setRolloffFactor', _List_fromArray([ A2( $user$project$Test$test,'sets rolloff factor', function(_v8){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v9 = A2( $user$project$AudioFFI$setRolloffFactor, panner,1.0); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerRolloffFactor', _List_fromArray([ A2( $user$project$Test$test,'returns rolloff factor', function(_v10){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var rolloff = $user$project$AudioFFI$getPannerRolloffFactor( panner);var _v11 = A2( $user$project$AudioFFI$setRolloffFactor, panner,0.5); return ( A3( $user$project$Expect$within, $user$project$Expect$Absolute(0.01),0.5, rolloff));}));})]))]));
...
var $user$project$SpatialTest$pannerModelTests = A2( $user$project$Test$describe,'panner models', _List_fromArray([ A2( $user$project$Test$describe,'setPanningModel', _List_fromArray([ A2( $user$project$Test$test,'sets equalpower panning', function(_v0){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v1 = A2( $user$project$AudioFFI$setPanningModel, panner,'equalpower'); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets HRTF panning', function(_v2){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v3 = A2( $user$project$AudioFFI$setPanningModel, panner,'HRTF'); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerPanningModel', _List_fromArray([ A2( $user$project$Test$test,'returns panning model', function(_v4){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var model = $user$project$AudioFFI$getPannerPanningModel( panner);var _v5 = A2( $user$project$AudioFFI$setPanningModel, panner,'equalpower'); return ( A2( $user$project$Expect$equal,'equalpower', model));}));})])) , A2( $user$project$Test$describe,'setDistanceModel', _List_fromArray([ A2( $user$project$Test$test,'sets linear distance', function(_v6){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v7 = A2( $user$project$AudioFFI$setDistanceModel, panner,'linear'); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets inverse distance', function(_v8){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v9 = A2( $user$project$AudioFFI$setDistanceModel, panner,'inverse'); return ( $user$project$Expect$pass);}));}) , A2( $user$project$Test$test,'sets exponential distance', function(_v10){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var _v11 = A2( $user$project$AudioFFI$setDistanceModel, panner,'exponential'); return ( $user$project$Expect$pass);}));})])) , A2( $user$project$Test$describe,'getPannerDistanceModel', _List_fromArray([ A2( $user$project$Test$test,'returns distance model', function(_v12){ return ( $user$project$SpatialTest$withRawContext( function(ctx){var panner = $user$project$AudioFFI$createPanner( ctx);var model = $user$project$AudioFFI$getPannerDistanceModel( panner);var _v13 = A2( $user$project$AudioFFI$setDistanceModel, panner,'linear'); return ( A2( $user$project$Expect$equal,'linear', model));}));})]))]));
...
var $user$project$TestMain$main = function(){var allSuites = _List_fromArray([ $user$project$FilterTest$suite , $user$project$BufferTest$suite , $user$project$ConnectionTest$suite , $user$project$AudioContextTest$suite , $user$project$AnalyserTest$suite , $user$project$OscillatorTest$suite , $user$project$SimplifiedTest$suite , $user$project$EffectsTest$suite , $user$project$SpatialTest$suite , $user$project$GainTest$suite , $user$project$AudioParamTest$suite]);var report = $user$project$Test$runTests( allSuites); return ( A2( $elm$html$Html$pre, _List_Nil, _List_fromArray([ $elm$html$Html$text( report)])));}();
...
_Platform_export({'AnalyserTest':{'init': _VirtualDom_init( $user$project$AnalyserTest$main)(0)(0)},'TestMain':{'init': _VirtualDom_init( $user$project$TestMain$main)(0)(0)},'SpatialTest':{'init': _VirtualDom_init( $user$project$SpatialTest$main)(0)(0)},'SimplifiedTest':{'init': _VirtualDom_init( $user$project$SimplifiedTest$main)(0)(0)},'OscillatorTest':{'init': _VirtualDom_init( $user$project$OscillatorTest$main)(0)(0)},'GainTest':{'init': _VirtualDom_init( $user$project$GainTest$main)(0)(0)},'FilterTest':{'init': _VirtualDom_init( $user$project$FilterTest$main)(0)(0)},'EffectsTest':{'init': _VirtualDom_init( $user$project$EffectsTest$main)(0)(0)},'ConnectionTest':{'init': _VirtualDom_init( $user$project$ConnectionTest$main)(0)(0)},'BufferTest':{'init': _VirtualDom_init( $user$project$BufferTest$main)(0)(0)},'AudioParamTest':{'init': _VirtualDom_init( $user$project$AudioParamTest$main)(0)(0)},'AudioContextTest':{'init': _VirtualDom_init( $user$project$AudioContextTest$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
