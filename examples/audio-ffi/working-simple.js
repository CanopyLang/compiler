...
var $author$project$PerfectFFIAudioDemoWorkingSimple$main = A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð WORKING FFI MODULE - No FFI functions used yet\\')]));
_Platform_export({'PerfectFFIAudioDemoWorkingSimple':{'init': _VirtualDom_init( $author$project$PerfectFFIAudioDemoWorkingSimple$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));