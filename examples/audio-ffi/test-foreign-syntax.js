...
// Bindings for external/simple.js
SimpleFFI = SimpleFFI || {};
$author$project$SimpleFFI$getActivation = getActivation;
SimpleFFI.getActivation = getActivation;
$author$project$SimpleFFI$getMessage = getMessage;
SimpleFFI.getMessage = getMessage;
...
var $author$project$TestForeignSyntax$main = A2( $elm$html$Html$div, _List_Nil, _List_fromArray([ $elm$html$Html$text('Testing foreign import syntax')]));
_Platform_export({'TestForeignSyntax':{'init': _VirtualDom_init( $author$project$TestForeignSyntax$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));