 ...
 * @canopy-type UserActivated -> AudioResult Capability.CapabilityError (Initialized AudioContext)
 */
 ...
 * @canopy-type Initialized AudioContext -> AudioResult Capability.CapabilityError (Initialized AudioContext)
 */
 ...
 * @canopy-type AudioContext -> AudioResult Capability.CapabilityError AudioContext
 */
 ...
 * @canopy-type AudioContext -> AudioResult Capability.CapabilityError Basics.Int
 */
 ...
 * @canopy-type Initialized AudioContext -> Float -> String -> AudioResult Capability.CapabilityError OscillatorNode
 */
 ...
 * @canopy-type OscillatorNode -> Float -> AudioResult Capability.CapabilityError Basics.Int
 */
 ...
 * @canopy-type AudioBufferSourceNode -> Float -> AudioResult Capability.CapabilityError Basics.Int
 */
 ...
 * @name createGainNode
 * @canopy-type Initialized AudioContext -> Float -> AudioResult Capability.CapabilityError GainNode
 */
 ...
 * @name setGain
 * @canopy-type GainNode -> Float -> Float -> AudioResult Capability.CapabilityError Basics.Int
 */
 ...
 * @name connectNodes
 * @canopy-type OscillatorNode -> GainNode -> AudioResult Capability.CapabilityError Basics.Int
 */
 ...
 * @canopy-type GainNode -> Initialized AudioContext -> AudioResult Capability.CapabilityError Basics.Int
 */
...
var AudioFFI = AudioFFI || {};
var $author$project$AudioFFI$createAudioContext = createAudioContext;
AudioFFI.createAudioContext = createAudioContext;
var $author$project$AudioFFI$getCurrentTime = getCurrentTime;
AudioFFI.getCurrentTime = getCurrentTime;
var $author$project$AudioFFI$resumeAudioContext = resumeAudioContext;
AudioFFI.resumeAudioContext = resumeAudioContext;
var $author$project$AudioFFI$suspendAudioContext = suspendAudioContext;
AudioFFI.suspendAudioContext = suspendAudioContext;
var $author$project$AudioFFI$closeAudioContext = closeAudioContext;
AudioFFI.closeAudioContext = closeAudioContext;
var $author$project$AudioFFI$getSampleRate = getSampleRate;
AudioFFI.getSampleRate = getSampleRate;
var $author$project$AudioFFI$getContextState = getContextState;
AudioFFI.getContextState = getContextState;
var $author$project$AudioFFI$createOscillator = F3(createOscillator);
AudioFFI.createOscillator = F3(createOscillator);
var $author$project$AudioFFI$startOscillator = F2(startOscillator);
AudioFFI.startOscillator = F2(startOscillator);
var $author$project$AudioFFI$stopOscillator = F2(stopOscillator);
AudioFFI.stopOscillator = F2(stopOscillator);
var $author$project$AudioFFI$setOscillatorFrequency = F3(setOscillatorFrequency);
AudioFFI.setOscillatorFrequency = F3(setOscillatorFrequency);
var $author$project$AudioFFI$setOscillatorDetune = F3(setOscillatorDetune);
AudioFFI.setOscillatorDetune = F3(setOscillatorDetune);
var $author$project$AudioFFI$createBufferSource = createBufferSource;
AudioFFI.createBufferSource = createBufferSource;
var $author$project$AudioFFI$startBufferSource = F2(startBufferSource);
AudioFFI.startBufferSource = F2(startBufferSource);
var $author$project$AudioFFI$stopBufferSource = F2(stopBufferSource);
AudioFFI.stopBufferSource = F2(stopBufferSource);
var $author$project$AudioFFI$createGainNode = F2(createGainNode);
AudioFFI.createGainNode = F2(createGainNode);
var $author$project$AudioFFI$setGain = F3(setGain);
AudioFFI.setGain = F3(setGain);
var $author$project$AudioFFI$rampGainLinear = F3(rampGainLinear);
AudioFFI.rampGainLinear = F3(rampGainLinear);
var $author$project$AudioFFI$rampGainExponential = F3(rampGainExponential);
AudioFFI.rampGainExponential = F3(rampGainExponential);
var $author$project$AudioFFI$createBiquadFilter = F2(createBiquadFilter);
AudioFFI.createBiquadFilter = F2(createBiquadFilter);
var $author$project$AudioFFI$setFilterFrequency = F3(setFilterFrequency);
AudioFFI.setFilterFrequency = F3(setFilterFrequency);
var $author$project$AudioFFI$setFilterQ = F3(setFilterQ);
AudioFFI.setFilterQ = F3(setFilterQ);
var $author$project$AudioFFI$setFilterGain = F3(setFilterGain);
AudioFFI.setFilterGain = F3(setFilterGain);
var $author$project$AudioFFI$createDelay = F2(createDelay);
AudioFFI.createDelay = F2(createDelay);
var $author$project$AudioFFI$setDelayTime = F3(setDelayTime);
AudioFFI.setDelayTime = F3(setDelayTime);
var $author$project$AudioFFI$createConvolver = createConvolver;
AudioFFI.createConvolver = createConvolver;
var $author$project$AudioFFI$createDynamicsCompressor = createDynamicsCompressor;
AudioFFI.createDynamicsCompressor = createDynamicsCompressor;
var $author$project$AudioFFI$setCompressorThreshold = F3(setCompressorThreshold);
AudioFFI.setCompressorThreshold = F3(setCompressorThreshold);
var $author$project$AudioFFI$setCompressorKnee = F3(setCompressorKnee);
AudioFFI.setCompressorKnee = F3(setCompressorKnee);
var $author$project$AudioFFI$setCompressorRatio = F3(setCompressorRatio);
AudioFFI.setCompressorRatio = F3(setCompressorRatio);
var $author$project$AudioFFI$setCompressorAttack = F3(setCompressorAttack);
AudioFFI.setCompressorAttack = F3(setCompressorAttack);
var $author$project$AudioFFI$setCompressorRelease = F3(setCompressorRelease);
AudioFFI.setCompressorRelease = F3(setCompressorRelease);
var $author$project$AudioFFI$createWaveShaper = createWaveShaper;
AudioFFI.createWaveShaper = createWaveShaper;
var $author$project$AudioFFI$createStereoPanner = createStereoPanner;
AudioFFI.createStereoPanner = createStereoPanner;
var $author$project$AudioFFI$setPan = F3(setPan);
AudioFFI.setPan = F3(setPan);
var $author$project$AudioFFI$createAnalyser = createAnalyser;
AudioFFI.createAnalyser = createAnalyser;
var $author$project$AudioFFI$setAnalyserFFTSize = F2(setAnalyserFFTSize);
AudioFFI.setAnalyserFFTSize = F2(setAnalyserFFTSize);
var $author$project$AudioFFI$setAnalyserSmoothing = F2(setAnalyserSmoothing);
AudioFFI.setAnalyserSmoothing = F2(setAnalyserSmoothing);
var $author$project$AudioFFI$getFrequencyBinCount = getFrequencyBinCount;
AudioFFI.getFrequencyBinCount = getFrequencyBinCount;
var $author$project$AudioFFI$connectNodes = F2(connectNodes);
AudioFFI.connectNodes = F2(connectNodes);
var $author$project$AudioFFI$connectToDestination = F2(connectToDestination);
AudioFFI.connectToDestination = F2(connectToDestination);
var $author$project$AudioFFI$disconnectNode = disconnectNode;
AudioFFI.disconnectNode = disconnectNode;
var $author$project$AudioFFI$simpleTest = simpleTest;
AudioFFI.simpleTest = simpleTest;
var $author$project$AudioFFI$simpleTest = simpleTest;
AudioFFI.simpleTest = simpleTest;
var $author$project$AudioFFI$createPanner = createPanner;
AudioFFI.createPanner = createPanner;
var $author$project$AudioFFI$setPannerPosition = F4(setPannerPosition);
AudioFFI.setPannerPosition = F4(setPannerPosition);
var $author$project$AudioFFI$setPannerOrientation = F4(setPannerOrientation);
AudioFFI.setPannerOrientation = F4(setPannerOrientation);
var $author$project$AudioFFI$setPanningModel = F2(setPanningModel);
AudioFFI.setPanningModel = F2(setPanningModel);
var $author$project$AudioFFI$setDistanceModel = F2(setDistanceModel);
AudioFFI.setDistanceModel = F2(setDistanceModel);
var $author$project$AudioFFI$setRefDistance = F2(setRefDistance);
AudioFFI.setRefDistance = F2(setRefDistance);
var $author$project$AudioFFI$setMaxDistance = F2(setMaxDistance);
AudioFFI.setMaxDistance = F2(setMaxDistance);
var $author$project$AudioFFI$setRolloffFactor = F2(setRolloffFactor);
AudioFFI.setRolloffFactor = F2(setRolloffFactor);
var $author$project$AudioFFI$setConeInnerAngle = F2(setConeInnerAngle);
AudioFFI.setConeInnerAngle = F2(setConeInnerAngle);
var $author$project$AudioFFI$setConeOuterAngle = F2(setConeOuterAngle);
AudioFFI.setConeOuterAngle = F2(setConeOuterAngle);
var $author$project$AudioFFI$setConeOuterGain = F2(setConeOuterGain);
AudioFFI.setConeOuterGain = F2(setConeOuterGain);
var $author$project$AudioFFI$getAudioListener = getAudioListener;
AudioFFI.getAudioListener = getAudioListener;
var $author$project$AudioFFI$setListenerPosition = F4(setListenerPosition);
AudioFFI.setListenerPosition = F4(setListenerPosition);
var $author$project$AudioFFI$setListenerForward = F4(setListenerForward);
AudioFFI.setListenerForward = F4(setListenerForward);
var $author$project$AudioFFI$setListenerUp = F4(setListenerUp);
AudioFFI.setListenerUp = F4(setListenerUp);
var $author$project$AudioFFI$createChannelSplitter = F2(createChannelSplitter);
AudioFFI.createChannelSplitter = F2(createChannelSplitter);
var $author$project$AudioFFI$createChannelMerger = F2(createChannelMerger);
AudioFFI.createChannelMerger = F2(createChannelMerger);
var $author$project$AudioFFI$createAudioBuffer = F4(createAudioBuffer);
AudioFFI.createAudioBuffer = F4(createAudioBuffer);
var $author$project$AudioFFI$getBufferLength = getBufferLength;
AudioFFI.getBufferLength = getBufferLength;
var $author$project$AudioFFI$getBufferDuration = getBufferDuration;
AudioFFI.getBufferDuration = getBufferDuration;
var $author$project$AudioFFI$getBufferSampleRate = getBufferSampleRate;
AudioFFI.getBufferSampleRate = getBufferSampleRate;
var $author$project$AudioFFI$getBufferChannels = getBufferChannels;
AudioFFI.getBufferChannels = getBufferChannels;
var $author$project$AudioFFI$createPeriodicWave = createPeriodicWave;
AudioFFI.createPeriodicWave = createPeriodicWave;
var $author$project$AudioFFI$createOfflineAudioContext = F3(createOfflineAudioContext);
AudioFFI.createOfflineAudioContext = F3(createOfflineAudioContext);
var $author$project$AudioFFI$startOfflineRendering = startOfflineRendering;
AudioFFI.startOfflineRendering = startOfflineRendering;
var $author$project$AudioFFI$getGainParam = getGainParam;
AudioFFI.getGainParam = getGainParam;
var $author$project$AudioFFI$getFrequencyParam = getFrequencyParam;
AudioFFI.getFrequencyParam = getFrequencyParam;
var $author$project$AudioFFI$getDetuneParam = getDetuneParam;
AudioFFI.getDetuneParam = getDetuneParam;
var $author$project$AudioFFI$setParamValueAtTime = F3(setParamValueAtTime);
AudioFFI.setParamValueAtTime = F3(setParamValueAtTime);
var $author$project$AudioFFI$linearRampToValue = F3(linearRampToValue);
AudioFFI.linearRampToValue = F3(linearRampToValue);
var $author$project$AudioFFI$exponentialRampToValue = F3(exponentialRampToValue);
AudioFFI.exponentialRampToValue = F3(exponentialRampToValue);
var $author$project$AudioFFI$setTargetAtTime = F4(setTargetAtTime);
AudioFFI.setTargetAtTime = F4(setTargetAtTime);
var $author$project$AudioFFI$cancelScheduledValues = F2(cancelScheduledValues);
AudioFFI.cancelScheduledValues = F2(cancelScheduledValues);
var $author$project$AudioFFI$cancelAndHoldAtTime = F2(cancelAndHoldAtTime);
AudioFFI.cancelAndHoldAtTime = F2(cancelAndHoldAtTime);
var $author$project$AudioFFI$getByteTimeDomainData = getByteTimeDomainData;
AudioFFI.getByteTimeDomainData = getByteTimeDomainData;
var $author$project$AudioFFI$getByteFrequencyData = getByteFrequencyData;
AudioFFI.getByteFrequencyData = getByteFrequencyData;
var $author$project$AudioFFI$getFloatTimeDomainData = getFloatTimeDomainData;
AudioFFI.getFloatTimeDomainData = getFloatTimeDomainData;
var $author$project$AudioFFI$getFloatFrequencyData = getFloatFrequencyData;
AudioFFI.getFloatFrequencyData = getFloatFrequencyData;
var $author$project$AudioFFI$setBufferSourceBuffer = F2(setBufferSourceBuffer);
AudioFFI.setBufferSourceBuffer = F2(setBufferSourceBuffer);
var $author$project$AudioFFI$setBufferSourceLoop = F2(setBufferSourceLoop);
AudioFFI.setBufferSourceLoop = F2(setBufferSourceLoop);
var $author$project$AudioFFI$setBufferSourceLoopStart = F2(setBufferSourceLoopStart);
AudioFFI.setBufferSourceLoopStart = F2(setBufferSourceLoopStart);
var $author$project$AudioFFI$setBufferSourceLoopEnd = F2(setBufferSourceLoopEnd);
AudioFFI.setBufferSourceLoopEnd = F2(setBufferSourceLoopEnd);
var $author$project$AudioFFI$setBufferSourcePlaybackRate = F3(setBufferSourcePlaybackRate);
AudioFFI.setBufferSourcePlaybackRate = F3(setBufferSourcePlaybackRate);
var $author$project$AudioFFI$setBufferSourceDetune = F3(setBufferSourceDetune);
AudioFFI.setBufferSourceDetune = F3(setBufferSourceDetune);
var $author$project$AudioFFI$createAudioContextSimplified = createAudioContextSimplified;
AudioFFI.createAudioContextSimplified = createAudioContextSimplified;
var $author$project$AudioFFI$playToneSimplified = F2(playToneSimplified);
AudioFFI.playToneSimplified = F2(playToneSimplified);
var $author$project$AudioFFI$stopAudioSimplified = stopAudioSimplified;
AudioFFI.stopAudioSimplified = stopAudioSimplified;
var $author$project$AudioFFI$updateFrequency = updateFrequency;
AudioFFI.updateFrequency = updateFrequency;
var $author$project$AudioFFI$updateVolume = updateVolume;
AudioFFI.updateVolume = updateVolume;
var $author$project$AudioFFI$updateWaveform = updateWaveform;
AudioFFI.updateWaveform = updateWaveform;
...
var $user$project$TestDirectFFI$main = $elm$html$Html$text( AudioFFI.checkWebAudioSupport);
...
_Platform_export({'TestDirectFFI':{'init': _VirtualDom_init( $user$project$TestDirectFFI$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
