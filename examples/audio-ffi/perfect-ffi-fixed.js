...
// From external/complete-audio.js
/**
...
// Bindings for external/complete-audio.js
var AudioFFI = AudioFFI || {};
$author$project$AudioFFI$detectWebAudioSupport = detectWebAudioSupport;
AudioFFI.detectWebAudioSupport = detectWebAudioSupport;
$author$project$AudioFFI$isUserActivationAvailable = isUserActivationAvailable;
AudioFFI.isUserActivationAvailable = isUserActivationAvailable;
$author$project$AudioFFI$isUserActivationActive = isUserActivationActive;
AudioFFI.isUserActivationActive = isUserActivationActive;
$author$project$AudioFFI$consumeUserActivation = consumeUserActivation;
AudioFFI.consumeUserActivation = consumeUserActivation;
$author$project$AudioFFI$requestAudioPermission = requestAudioPermission;
AudioFFI.requestAudioPermission = requestAudioPermission;
$author$project$AudioFFI$createAudioContext = createAudioContext;
AudioFFI.createAudioContext = createAudioContext;
$author$project$AudioFFI$getAudioContext = getAudioContext;
AudioFFI.getAudioContext = getAudioContext;
$author$project$AudioFFI$createOscillator = createOscillator;
AudioFFI.createOscillator = createOscillator;
$author$project$AudioFFI$getOscillator = getOscillator;
AudioFFI.getOscillator = getOscillator;
$author$project$AudioFFI$playTone = F3(playTone);
AudioFFI.playTone = F3(playTone);
$author$project$AudioFFI$stopTone = F2(stopTone);
AudioFFI.stopTone = F2(stopTone);
...
var $author$project$PerfectFFIAudioDemoFixed$init ={userActivation : $elm$core$Maybe$Nothing,status :'ðµ Perfect FFI Module Demo - Ready\\',permission : $elm$core$Maybe$Nothing,oscillator : $elm$core$Maybe$Nothing,logs : _List_fromArray(['â FFI Module successfully loaded with complex types']),audioContext : $elm$core$Maybe$Nothing};
...
var $author$project$PerfectFFIAudioDemoFixed$view = function(model){return A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'padding','20px') , A2( $elm$html$Html$Attributes$style,'font-family','Arial, sans-serif')]), _List_fromArray([ A2( $elm$html$Html$h1, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð PERFECT FFI MODULE DEMO')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â This demonstrates the OPTIMAL FFI solution with complex types\\')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0') , A2( $elm$html$Html$Attributes$style,'padding','15px') , A2( $elm$html$Html$Attributes$style,'background-color','#e8f5e8') , A2( $elm$html$Html$Attributes$style,'border-radius','10px')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð FFI Module Architecture')])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','10px 0')]), _List_fromArray([ A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â¢ Types defined BEFORE foreign imports (impossible with old system)')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â¢ Foreign imports can reference complex Canopy types')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â¢ Flexible ordering: types â foreign imports â implementation')])) , A2( $elm$html$Html$p, _List_Nil, _List_fromArray([ $elm$html$Html$text('â¢ Full type safety maintained throughout')]))]))])) , A2( $elm$html$Html$div, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'margin','20px 0')]), _List_fromArray([ A2( $elm$html$Html$h2, _List_Nil, _List_fromArray([ $elm$html$Html$text('ð Activity Logs')])) , A2( $elm$html$Html$pre, _List_fromArray([ A2( $elm$html$Html$Attributes$style,'background-color','#f8f9fa') , A2( $elm$html$Html$Attributes$style,'padding','15px') , A2( $elm$html$Html$Attributes$style,'border-radius','5px') , A2( $elm$html$Html$Attributes$style,'border','1px solid #dee2e6') , A2( $elm$html$Html$Attributes$style,'max-height','300px') , A2( $elm$html$Html$Attributes$style,'overflow-y','auto')]), _List_fromArray([ $elm$html$Html$text( A2( $elm$core$String$join,'\\n', $elm$core$List$reverse( model.logs)))]))]))]));};
var $author$project$PerfectFFIAudioDemoFixed$main = $author$project$PerfectFFIAudioDemoFixed$view( $author$project$PerfectFFIAudioDemoFixed$init);
_Platform_export({'PerfectFFIAudioDemoFixed':{'init': _VirtualDom_init( $author$project$PerfectFFIAudioDemoFixed$main)(0)(0)}});scope['Canopy'] = scope['Elm'];
}(this));