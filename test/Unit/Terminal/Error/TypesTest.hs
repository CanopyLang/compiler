...
tests :: TestTree
tests = testGroup "Terminal.Error.Types Tests"
...
testExpectationLenses = testGroup "Expectation Lens Tests"
...
testArgErrorRanking = testGroup "ArgError Ranking Tests"
  ...
  , testCase "ranking order is consistent" $ do
      ...
      assertBool "ArgBad ranks higher than ArgMissing" 
        (argErrorRank badError < argErrorRank missingError)
      assertBool "ArgMissing ranks higher than ArgExtras"
...
testTopErrorSelection = testGroup "Top Error Selection Tests"
...
testErrorTypeEquality = testGroup "Error Type Equality Tests"
...
testErrorTypeShow = testGroup "Error Type Show Tests"
