...
tests :: TestTree
tests = Test.testGroup "Init.Environment Tests"
...
environmentSetupTests = Test.testGroup "Environment Setup Tests"
...
solverValidationTests = Test.testGroup "Solver Integration Tests"
...
dependencyResolutionTests = Test.testGroup "Dependency Resolution Tests"
...
validationTests = Test.testGroup "Validation Tests" 
