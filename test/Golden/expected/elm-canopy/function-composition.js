...
var $author$project$Main$addOne = function (x) {
	return x + 1;
};
...
var $author$project$Main$timeTwo = function (x) {
	return x * 2;
};
var $author$project$Main$main = $elm$html$Html$text(
	$elm$core$String$fromInt(
		A3($author$project$Main$compose, $author$project$Main$addOne, $author$project$Main$timeTwo, 5)));
