...
var $author$project$Main$getAge = function (person) {
	return person.E;
};
var $author$project$Main$getName = function (person) {
	return person.G;
};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$main = function () {
	var person = {E: 25, G: 'Bob'};
	return $elm$html$Html$text(
		$author$project$Main$getName(person) + (' ' + $elm$core$String$fromInt(
			$author$project$Main$getAge(person))));
}();
