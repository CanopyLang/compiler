  ...
  testGroup
    ...
    [ testCase "artifacts contain expected module after compilation" $ do
      ...
      testCase "types lens laws" $ do
        ...
        assertEqual
          "types lens get-set law"
          newTypes
          (updated ^. Compile.artifactsTypes),
    ...
    [ testCase "compile determinism: same input produces same result" $ do
        ...
        case (result1, result2) of
          ...
          (Right art1, Right art2) ->
            assertEqual
              "successful compilation should be deterministic"
              (art1 ^. Compile.artifactsTypes)
              (art2 ^. Compile.artifactsTypes)
