...
tests :: TestTree
tests = testGroup "Terminal.Chomp Integration Tests"
...
testCompleteParsingWorkflows = testGroup "Complete Parsing Workflows"
...
testErrorRecoveryScenarios = testGroup "Error Recovery Scenarios"
...
testSuggestionGeneration = testGroup "Suggestion Generation"
...
testComplexArgumentPatterns = testGroup "Complex Argument Patterns"
...
testFlagAndArgumentIntegration = testGroup "Flag and Argument Integration"
...
testRealWorldScenarios = testGroup "Real-World Scenarios"
...
stringParser singular description = Parser
  { _singular = singular
  , _plural = singular ++ "s"
...
createIntParser minVal maxVal = Parser
  { _singular = "number"
  , _plural = "numbers"
...
fileParserWithExtensions extensions = Parser
  { _singular = "file"
  , _plural = "files"
...
createEnumParser options = Parser
  { _singular = "option"
  , _plural = "options"
