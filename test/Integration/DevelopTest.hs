...
endToEndWorkflowTests =
  Test.testGroup
    ...
    [ Test.testCase "complete development server initialization" $
        ( do
      ...
      Test.testCase "workflow handles edge cases gracefully" $
        ( do
      ...
      Test.testCase "workflow integrates with project detection" $
        ( do
