...
import Diff.Types (Env, Task, envCache, envManager, envMaybeRoot, envRegistry)
-- Http import removed as it's unused in this module
...
validateVersion name (Registry.KnownVersions latest previous) version =
...
loadProjectDetails root =
  Task.eio Exit.DiffBadDetails loadAction
  where
