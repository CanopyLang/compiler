...
reactor =
  let summary =
   ...
   in Terminal.Command "reactor" (Common summary) details example noArgs reactorFlags Develop.run
...
publish =
  let details =
   ...
   in Terminal.Command "publish" Uncommon details example publishArgs noFlags Publish.run
